...
<template>
  <nav class="ded-breadcrumb-container" :class="{ [ props.className ]: !!props.className }">
    <ol class="ded-breadcrumb">
      <li v-for="(item, index) in truncatedBreadcrumbs" :key="index" class="ded-breadcrumb-item">
        <template v-if="item.label === '...'">
          <div class="ded-rest">
            <div class="ded-rest-label" @click="handleClick">
              ...
            </div>
            <teleport to="body">
              <div
              ...
              >
                <ul class="ded-rest-dropdown-menu">
                  <li v-for="(item, index) of restBreadcrumbs" :key="index" class="ded-drop-item">
        ...
        <template v-else>
          <BreadcrumbItem
            :label="item.label"
            :href="item.href"
            :is-current-page="index === truncatedBreadcrumbs.length - 1"
          />
        </template>
      </li>
    </ol>
