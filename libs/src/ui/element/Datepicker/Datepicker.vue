    ...
    <template v-if="range">
      <div ref="dateRange">
        <div style="display: flex; gap: 8px">
          <!-- 時間區間 - 開始 -->
          <div style="width: 100%">
            <label v-if="props.rangeStartLabel" class="input-label">{{
              props.rangeStartLabel
            }}</label>
            <div :class="['input-group', `component-${size}`]">
              ...
              <input
                type="text"
                name="start"
                :placeholder="props.rangeStartPlaceholder"
              />
            </div>
          </div>
          ...
          <!-- 時間區間 - 結束 -->
          <div style="width: 100%">
            <label v-if="props.rangeEndLabel" class="input-label">{{
              props.rangeEndLabel
            }}</label>
            <div :class="['input-group', `component-${size}`]">
              <Icon :class="`icon-${size}`" name="calendar"></Icon>
              <input
                type="text"
                name="end"
                :placeholder="props.rangeEndPlaceholder"
              />
            </div>
          </div>
        </div>
