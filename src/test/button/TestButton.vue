...
<template>
  <Button
    ...
    radius="${radius.value}"${disabledAttr}
    @click="handleClick"
  >
    ${buttonText.value}
  </Button>
...
<template>
  <div class="test-button-container">
    ...
    <div class="button-controls">
      <p class="settings-title">當前按鈕設定:</p>
      <div class="settings-grid">
        ...
        <div class="setting-item">
          <span class="setting-label">寬度類型:</span>
          <strong class="setting-value">{{ width }}</strong>
        </div>
        <div class="setting-item">
          <span class="setting-label">邊框寬度:</span>
          <strong class="setting-value">{{ borderWidth }}</strong>
        </div>
        <div class="setting-item">
      ...
      <div class="control-groups">
        ...
        <!-- 尺寸控制組 -->
        <div class="control-group">
          <h4 class="group-title">尺寸設定</h4>
          <div class="control-buttons">
            <button @click="toggleWidth" class="control-button secondary">
              切換寬度
            </button>
            <button @click="increaseRadius" class="control-button secondary">
              增加圓角
            </button>
            <button @click="decreaseRadius" class="control-button secondary">
              減少圓角
            </button>
          </div>
        </div>
        ...
        <div class="control-group">
          ...
          <div class="control-buttons">
            ...
            <button
              @click="buttonRef?.buttonRef?.focus()"
              class="control-button accent"
            >
              聚焦按鈕
            </button>
            <button
              @click="
                buttonText = buttonText === 'Button' ? '點擊我' : 'Button'
              "
              class="control-button accent"
            >
              切換文字
