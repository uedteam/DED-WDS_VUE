...
const codeExample = computed(() => {
  const dataSourceStr = JSON.stringify(dataSource.value, null, 2);
...
const dataSource = ref(${dataSourceStr});
const selectedValues = ref(${JSON.stringify(selectedValues.value)});
` +
    scriptEnd +
    `
...
<template>
  <div class="test-checkbox-container">
    ...
    <div class="checkbox-controls">
      <p class="settings-title">當前 Checkbox 設定:</p>
      <div class="settings-grid">
        <div class="setting-item">
          <span class="setting-label">排列方向:</span>
          <strong class="setting-value">{{ direction }}</strong>
        </div>
        <div class="setting-item">
        ...
        <div class="setting-item">
          <span class="setting-label">選擇值:</span>
          <strong class="setting-value">{{ selectedValues }}</strong>
        </div>
      </div>
      ...
      <div class="control-groups">
        <div class="control-group">
          ...
          <div class="control-buttons">
            <button @click="toggleDirection" class="control-button primary">
              切換排列方向
            </button>
        ...
        <div class="control-group">
          ...
          <div class="control-buttons">
            <button
              @click="className = className === '' ? 'custom-class' : ''"
            ...
            <button
              @click="selectedValues = dataSource.map((item) => item.value)"
              class="control-button secondary"
            >
              全選
            </button>
