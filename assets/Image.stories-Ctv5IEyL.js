import{_ as o}from"./Image-DQb6v3bJ.js";import"./vue.esm-bundler-BHaSr8M7.js";import"./index-Bb4qSo10.js";const v={title:"Design System/Image*",component:o,tags:["autodocs"],argTypes:{src:{description:"圖片來源",control:{type:"text"}},alt:{description:"圖片替代文字",control:{type:"text"}},objectFit:{description:"調整圖片適合其容器",control:{type:"select"},options:["cover","contain","fill","none"],table:{type:{summary:"cover | contain | fill | none"}}},ratio:{description:"調整圖片比例",control:{type:"select"},options:["11","43","54","169"],table:{defaultValue:{summary:"11"},type:{summary:"11 | 43 | 54 | 169"}}},className:{description:"客製化樣式",control:{type:"text"}}},parameters:{docs:{title:"圖片",description:{component:"圖片組件的呈現及說明。"}}}},s={name:"預設項目",args:{src:"https://picsum.photos/300/300",alt:"User Photo",objectFit:"cover",ratio:"11",className:""},render:e=>({components:{Image:o},setup(){return{args:e}},template:`
