import{_ as l}from"./Input-DyCjVgf5.js";import"./vue.esm-bundler-CeRU4-k3.js";import"./Icon-rDwD1VSn.js";function D(a){return`{
        error: '${a.error||""}',
...
`).trim()}}}}},t={name:"輸入類型",args:{hasClear:!0,placeholder:"Placeholder",size:"medium",maxLimit:0,hint:{error:"",description:"Prompt message"},isDisabled:!1,className:"",modelValue:""},render:a=>({components:{Input:l},setup(){return{args:a}},template:`
        ...
        `}),parameters:{controls:{exclude:["label","type","prefix","input","clearDatePicker"]},docs:{source:{transform:(a,r)=>{const{args:e}=r,s=D(e.hint);return["<script setup>",'import { ref } from "vue";','import { Input } from "@ded-wds-vue/ui";','const modelValue = ref("");',"<\/script>","","<template>","  <Input",'    label="Number"','    type="number"',`    ${e.hasClear!==void 0?`:hasClear="${e.hasClear}"`:""}`,`    ${e.placeholder?`placeholder="${e.placeholder}"`:""}`,'    prefix="SvgSearch"',`    ${e.size?`size="${e.size}"`:""}`,`    ${e.maxLimit?`maxLimit="${e.maxLimit}"`:""}`,`    ${s?`:hint="${s}"`:""}`,`    ${e.isDisabled!==void 0?`:isDisabled="${e.isDisabled}"`:""}`,`    ${e.className?`className="${e.className}"`:""}`,'    v-model="modelValue"',"  />","  <Input",'    label="Text"','    type="text"',`    ${e.hasClear!==void 0?`:hasClear="${e.hasClear}"`:""}`,`    ${e.placeholder?`placeholder="${e.placeholder}"`:""}`,'    prefix="SvgAccount"',`    ${e.size?`size="${e.size}"`:""}`,`    ${e.maxLimit?`maxLimit="${e.maxLimit}"`:""}`,`    ${s?`:hint="${s}"`:""}`,`    ${e.isDisabled!==void 0?`:isDisabled="${e.isDisabled}"`:""}`,`    ${e.className?`className="${e.className}"`:""}`,'    v-model="modelValue"',"  />","  <Input",'    label="Password"','    type="password"',`    ${e.hasClear!==void 0?`:hasClear="${e.hasClear}"`:""}`,`    ${e.placeholder?`placeholder="${e.placeholder}"`:""}`,'    prefix="SvgLock"',`    ${e.size?`size="${e.size}"`:""}`,`    ${e.maxLimit?`maxLimit="${e.maxLimit}"`:""}`,`    ${s?`:hint="${s}"`:""}`,`    ${e.isDisabled!==void 0?`:isDisabled="${e.isDisabled}"`:""}`,`    ${e.className?`className="${e.className}"`:""}`,'    v-model="modelValue"',"  />","  <Input",'    label="Email"','    type="email"',`    ${e.hasClear!==void 0?`:hasClear="${e.hasClear}"`:""}`,`    ${e.placeholder?`placeholder="${e.placeholder}"`:""}`,'    prefix="SvgMail"',`    ${e.size?`size="${e.size}"`:""}`,`    ${e.maxLimit?`maxLimit="${e.maxLimit}"`:""}`,`    ${s?`:hint="${s}"`:""}`,`    ${e.isDisabled!==void 0?`:isDisabled="${e.isDisabled}"`:""}`,`    ${e.className?`className="${e.className}"`:""}`,'    v-model="modelValue"',"  />","</template>"].filter(Boolean).join(`
    ...
    docs: {
      source: {
        transform: (src, storyContext) => {
          ...
          return [\`<script setup>\`, 'import { ref } from "vue";', \`import { Input } from "@ded-wds-vue/ui";\`, 'const modelValue = ref("");', \`<\/script>\`, '', '<template>', '  <Input', \`    \${args.label ? \`label="\${args.label}"\` : ""}\`, \`    \${args.type ? \`type="\${args.type}"\` : ""}\`, \`    \${args.hasClear !== undefined ? \`:hasClear="\${args.hasClear}"\` : ""}\`, \`    \${args.placeholder ? \`placeholder="\${args.placeholder}"\` : ""}\`, \`    \${args.prefix ? \`prefix="\${args.prefix}"\` : ""}\`, \`    \${args.size ? \`size="\${args.size}"\` : ""}\`, \`    \${args.maxLimit ? \`maxLimit="\${args.maxLimit}"\` : ""}\`, \`    :hint="{ error: '', description: 'Prompt message' }"\`, \`    \${args.isDisabled !== undefined ? \`:isDisabled="\${args.isDisabled}"\` : ""}\`, \`    \${args.className ? \`className="\${args.className}"\` : ""}\`, \`    v-model="modelValue"\`, '  />', '  <Input', \`    \${args.label ? \`label="\${args.label}"\` : ""}\`, \`    \${args.type ? \`type="\${args.type}"\` : ""}\`, \`    \${args.hasClear !== undefined ? \`:hasClear="\${args.hasClear}"\` : ""}\`, \`    \${args.placeholder ? \`placeholder="\${args.placeholder}"\` : ""}\`, \`    \${args.prefix ? \`prefix="\${args.prefix}"\` : ""}\`, \`    \${args.size ? \`size="\${args.size}"\` : ""}\`, \`    \${args.maxLimit ? \`maxLimit="\${args.maxLimit}"\` : ""}\`, \`    :hint="{ error: 'Error message', description: '' }"\`, \`    \${args.isDisabled !== undefined ? \`:isDisabled="\${args.isDisabled}"\` : ""}\`, \`    \${args.className ? \`className="\${args.className}"\` : ""}\`, \`    v-model="modelValue"\`, '  />', '</template>'].filter(Boolean).join('\\n').trim();
        }
      }
    }
  }
}`,...(x=(h=n.parameters)==null?void 0:h.docs)==null?void 0:x.source}}};var b,f,y;m.parameters={...m.parameters,docs:{...(b=m.parameters)==null?void 0:b.docs,source:{originalSource:'{\n  name: "輸入框狀態",\n  args: {\n    label: \'Account\',\n    type: \'text\',\n    hasClear: true,\n    placeholder: \'Placeholder\',\n    prefix: \'SvgAccount\',\n    size: \'medium\',\n    maxLimit: 0,\n    isDisabled: false,\n    className: \'\',\n    modelValue: \'\'\n  },\n  render: args => ({\n    components: {\n      Input\n    },\n    setup() {\n      return {\n        args\n      };\n    },\n    template: `\n            <div style="display: flex; flex-direction: column; gap:8px">\n                <Input\n                    :label="args.label"\n                    :type="args.type"\n                    :hasClear="args.hasClear"\n                    :placeholder="args.placeholder"\n                    :prefix="args.prefix"\n                    :size="args.size"\n                    :maxLimit="args.maxLimit"\n                    :hint="{ error: \'\', description: \'Prompt message\' }"\n                    :isDisabled="args.isDisabled"\n                    :className="args.className"\n                    v-model="args.modelValue"\n                />\n                <Input\n                    :label="args.label"\n                    :type="args.type"\n                    :hasClear="args.hasClear"\n                    :placeholder="args.placeholder"\n                    :prefix="args.prefix"\n                    :size="args.size"\n                    :maxLimit="args.maxLimit"\n                    :hint="{ error: \'Error message\', description: \'\' }"\n                    :isDisabled="args.isDisabled"\n                    :className="args.className"\n                    v-model="args.modelValue"\n                />\n                <Input\n                    :label="args.label"\n                    :type="args.type"\n                    :hasClear="args.hasClear"\n                    :placeholder="args.placeholder"\n                    :prefix="args.prefix"\n                    :size="args.size"\n                    :maxLimit="args.maxLimit"\n                    :hint="{ error: \'\', description: \'Prompt message\' }"\n                    :isDisabled="true"\n                    :className="args.className"\n                    v-model="args.modelValue"\n                />\n            </div>\n        `\n  }),\n  // 控制 controls 中能控制的參數\n  parameters: {\n    controls: {\n      exclude: [\'hint\', \'input\', \'clearDatePicker\', \'isDisabled\']\n    },\n    docs: {\n      source: {\n        transform: (src, storyContext) => {\n          const {\n            args\n          } = storyContext;\n          return [`<script setup>`, \'import { ref } from "vue";\', `import { Input } from "@ded-wds-vue/ui";`, \'const modelValue = ref("");\', `<\/script>`, \'\', \'<template>\', \'  <Input\', `    ${args.label ? `label="${args.label}"` : ""}`, `    ${args.type ? `type="${args.type}"` : ""}`, `    ${args.hasClear !== undefined ? `:hasClear="${args.hasClear}"` : ""}`, `    ${args.placeholder ? `placeholder="${args.placeholder}"` : ""}`, `    ${args.prefix ? `prefix="${args.prefix}"` : ""}`, `    ${args.size ? `size="${args.size}"` : ""}`, `    ${args.maxLimit ? `maxLimit="${args.maxLimit}"` : ""}`, `    :hint="{ error: \'\', description: \'Prompt message\' }"`, `    ${args.isDisabled !== undefined ? `:isDisabled="${args.isDisabled}"` : ""}`, `    ${args.className ? `className="${args.className}"` : ""}`, `    v-model="modelValue"`, \'  />\', \'\', \'  <Input\', `    ${args.label ? `label="${args.label}"` : ""}`, `    ${args.type ? `type="${args.type}"` : ""}`, `    ${args.hasClear !== undefined ? `:hasClear="${args.hasClear}"` : ""}`, `    ${args.placeholder ? `placeholder="${args.placeholder}"` : ""}`, `    ${args.prefix ? `prefix="${args.prefix}"` : ""}`, `    ${args.size ? `size="${args.size}"` : ""}`, `    ${args.maxLimit ? `maxLimit="${args.maxLimit}"` : ""}`, `    :hint="{ error: \'Error message\', description: \'\' }"`, `    ${args.isDisabled !== undefined ? `:isDisabled="${args.isDisabled}"` : ""}`, `    ${args.className ? `className="${args.className}"` : ""}`, `    v-model="modelValue"`, \'  />\', \'\', \'  <Input\', `    ${args.label ? `label="${args.label}"` : ""}`, `    ${args.type ? `type="${args.type}"` : ""}`, `    ${args.hasClear !== undefined ? `:hasClear="${args.hasClear}"` : ""}`, `    ${args.placeholder ? `placeholder="${args.placeholder}"` : ""}`, `    ${args.prefix ? `prefix="${args.prefix}"` : ""}`, `    ${args.size ? `size="${args.size}"` : ""}`, `    ${args.maxLimit ? `maxLimit="${args.maxLimit}"` : ""}`, `    :hint="{ error: \'\', description: \'Prompt message\' }"`, `    :isDisabled="true"`, `    ${args.className ? `className="${args.className}"` : ""}`, `    v-model="modelValue"`, \'  />\', \'</template>\'].filter(Boolean).join(\'\\n\').trim();\n        }\n      }\n    }\n  }\n}',...(y=(f=m.parameters)==null?void 0:f.docs)==null?void 0:y.source}}};const v=["InputDefault","InputTypesStory","InputHintTypeStory","InputStatusStory"];export{i as InputDefault,n as InputHintTypeStory,m as InputStatusStory,t as InputTypesStory,v as __namedExportsOrder,z as default};
