import{h as L,w as p,c as D,a as h,n as g,t as T,K as $,o as N}from"./vue.esm-bundler-C8tbd0VY.js";const o={__name:"Toggle",props:{themeColor:{type:String,default:"primary",validator:s=>["primary","secondary","neutral","info","success","warning","error"].includes(s)},checkLabel:{type:String,default:"on"},unCheckLabel:{type:String,default:"off"},isChecked:{type:Boolean,default:!1},isDisabled:{type:Boolean,default:!1},className:{type:String,default:""}},emits:["toggleIsChecked"],setup(s,{emit:c}){const e=c,l=s,a=L(l.isChecked);p(()=>l.isChecked,i=>{a.value=i});const m=()=>{a.value=!a.value,e("toggleIsChecked")};return(i,f)=>(N(),D("div",{class:g({"ded-toggle":!0,[`ded-toggle-${l.themeColor}`]:l.themeColor,"ded-toggle-on":a.value,"ded-toggle-off":!a.value,[l.className]:!!l.className}),onClick:$(m,["prevent"])},[h("div",{class:g(["ded-toggle-thumb",{"ded-toggle-thumb-on":a.value,"ded-toggle-thumb-off":!a.value}])},null,2),h("label",{class:g(["ded-toggle-label",{"ded-toggle-label-on":a.value,"ded-toggle-label-off":!a.value}])},T(a.value===!0?l.checkLabel:l.unCheckLabel),3)],2))}};o.__docgenInfo={exportName:"default",displayName:"Toggle",description:"",tags:{},props:[{name:"themeColor",type:{name:"string"},defaultValue:{func:!1,value:'"primary"'},values:["primary","secondary","neutral","info","success","warning","error"]},{name:"checkLabel",type:{name:"string"},defaultValue:{func:!1,value:'"on"'}},{name:"unCheckLabel",type:{name:"string"},defaultValue:{func:!1,value:'"off"'}},{name:"isChecked",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"isDisabled",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"className",type:{name:"string"},defaultValue:{func:!1,value:'""'}}],events:[{name:"toggleIsChecked"}],sourceFiles:["D:/98_測試/up/DED-WDS_VUE/libs/src/ui/element/Toggle/Toggle.vue"]};const v={title:"Component/Toggle",component:o,tags:["autodocs"],argTypes:{themeColor:{description:"主題顏色",control:{type:"select"},options:["primary","secondary","neutral","info","success","warning","error"],table:{type:{summary:"primary | secondary | neutral | info | success | warning | error"}}},checkLabel:{description:"開啟文字",control:{type:"text"}},unCheckLabel:{description:"關閉文字",control:{type:"text"}},isChecked:{description:"是否開啟",control:{type:"boolean"}},isDisabled:{description:"是否禁用",control:{type:"boolean"}},className:{description:"客製化樣式",control:{type:"text"}}},parameters:{docs:{title:"Toggle",description:{component:"Toggle 組件的呈現及說明。"}}}},n={name:"預設項目",args:{themeColor:"success",checkLabel:"on",unCheckLabel:"off",isChecked:!0,isDisabled:!1,className:""},render:s=>({components:{Toggle:o},setup(){return{args:s}},template:`<div style="display:flex; gap: 16px">
                <Toggle
            ...
            `}),parameters:{controls:{exclude:["toggleIsChecked"]},docs:{source:{transform:(s,c)=>{const{args:e}=c;return["<Toggle",`  themeColor="${e.themeColor}"`,`  checkLabel="${e.checkLabel}"`,`  unCheckLabel="${e.unCheckLabel}"`,`  :isChecked="${e.isChecked}"`,`  :isDisabled="${e.isDisabled}"`,`  className="${e.className}"`,"></Toggle>"].join(`
`).trim()}}}}},r={name:"主題色彩",args:{checkLabel:"on",unCheckLabel:"off",isChecked:!0,isDisabled:!1,className:""},render:s=>({components:{Toggle:o},setup(){return{args:s}},template:`<div style="display:flex; gap: 16px">
                <Toggle
                    themeColor="primary"
                    :checkLabel="args.checkLabel"
                    :unCheckLabel="args.unCheckLabel"
...
}`,...(b=(d=n.parameters)==null?void 0:d.docs)==null?void 0:b.source}}};var k,C,u;r.parameters={...r.parameters,docs:{...(k=r.parameters)==null?void 0:k.docs,source:{originalSource:`{
  name: '主題色彩',
  args: {
    checkLabel: 'on',
    unCheckLabel: 'off',
...
}`,...(u=(C=r.parameters)==null?void 0:C.docs)==null?void 0:u.source}}};const x=["ToggleDefault","ToggleColor"];export{r as ToggleColor,n as ToggleDefault,x as __namedExportsOrder,v as default};
