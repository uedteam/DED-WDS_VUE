import{m as L,g as x,O as R,P as U,c as r,q as I,L as $,F as b,o as a,j as T,a as m,b as g,e as y,d as A,n as k,f as q,t as N,l as _,T as G,h as J}from"./vue.esm-bundler-CC1hEtM-.js";import{_ as C}from"./Button-CjD1vpee.js";import{_ as l}from"./Icon-C3V5hff5.js";import{_ as S}from"./Title-CT72LlHb.js";const s=R({"top-right":[],"top-left":[],"top-center":[],"bottom-right":[],"bottom-left":[],"bottom-center":[]}),K=x(()=>Object.keys(s)),c=new Map,w=new Map;function Q(e){if(w.has(e))return w.get(e);const o=document.createElement("div");return o.id=`toast-container-${e}`,o.classList.add("ded-toast-container",`ded-toast-${e}`),document.body.appendChild(o),w.set(e,o),o}function F(e,o){if(!s[o])return;c.has(e)&&(clearTimeout(c.get(e)),c.delete(e));const t=s[o].findIndex(i=>i.id===e);t!==-1&&s[o].splice(t,1)}function X(e){const o=`toast-${crypto.randomUUID()}`,t=e.position||"top-right";Array.isArray(s[t])||(s[t]=R([])),Q(t);const i={...e,id:o,action:e.action||null};if(s[t].push(i),e.duration&&e.duration>0){const u=setTimeout(()=>{F(o,t)},e.duration);c.set(o,u)}}function Y(){c.forEach(e=>clearTimeout(e)),c.clear(),Object.keys(s).forEach(e=>{s[e].splice(0,s[e].length)})}function H(){const e=L("useToast",null);if(e)return e;const o={add:X,remove:F,clear:Y,toasts:s,positions:K};return U("useToast",o),o}const Z={class:"ded-toast-header"},tt={key:0,class:"ded-toast-header-action"},et={key:1},ot={class:"ded-description"},d={__name:"Toast",props:{className:{type:String,default:""}},setup(e){const o=e,{toasts:t,remove:i,positions:u}=H();return(B,nt)=>(a(!0),r(b,null,I($(u),f=>(a(),r("div",{key:f},[(a(!0),r(b,null,I($(t)[f],n=>(a(),r("div",{key:n.id},[(a(),T(G,{to:`#toast-container-${n.position}`},[m("div",{class:k(["ded-toast",[`ded-toast-border-${n.themeColor}`,o.className]])},[g(C,{class:"ded-close-button",variant:"text","theme-color":"neutral",onClick:st=>$(i)(n.id,f)},{default:y(()=>[g(l,{name:"SvgClose",size:"20"})]),_:2},1032,["onClick"]),m("div",Z,[m("div",{class:k(["ded-toast-header-message",[`ded-toast-header-message-${n.themeColor}`]])},[g(l,{name:n.prefix,size:"20"},null,8,["name"]),g(S,{"theme-color":n.themeColor,level:5},{default:y(()=>[q(N(n.title),1)]),_:2},1032,["theme-color"])],2),n.action?(a(),r("div",tt,[typeof n.action=="object"?(a(),T(_(n.action),{key:0})):typeof n.action=="function"?(a(),r("div",et,[(a(),T(_(n.action())))])):A("",!0)])):A("",!0)]),m("p",ot,N(n.content),1)],2)],8,["to"]))]))),128))]))),128))}};d.__docgenInfo={exportName:"default",displayName:"Toast",description:"",tags:{},props:[{name:"className",type:{name:"string"},defaultValue:{func:!1,value:'""'}}],sourceFiles:["/home/runner/work/DED-WDS_VUE/DED-WDS_VUE/libs/src/ui/element/Toast/Toast.vue"]};const dt={components:{Icon:l,Toast:d},title:"Component/Toast",component:d,tags:["autodocs"],argTypes:{themeColor:{description:"主題顏色",control:{type:"select"},options:["primary","secondary","neutral","info","success","warning","error"],table:{type:{summary:"primary | secondary | neutral | info | success | warning | error"},defaultValue:{summary:"primary"},category:"PROPS"}},position:{description:"位置",control:{type:"select"},options:["top-right","top-left","top-center","bottom-right","bottom-left","bottom-center"],table:{type:{summary:"top-right | top-left | top-center | bottom-right | bottom-left | bottom-center"},defaultValue:{summary:"top-right"},category:"PROPS"}},title:{description:"內容",control:{type:"text"},table:{category:"PROPS"}},content:{description:"說明文字",control:{type:"text"},table:{defaultValue:{summary:"Content"},category:"PROPS"}},prefix:{description:"前綴元素",control:{type:"select",labels:{"":"none",SvgInfoCircle:"SvgInfoCircle",SvgSuccessCircle:"SvgSuccessCircle",SvgWarningTri:"SvgWarningTri",SvgErrorCircle:"SvgErrorCircle",SvgDisableCircle:"SvgDisableCircle"}},options:["","SvgInfoCircle","SvgSuccessCircle","SvgWarningTri","SvgErrorCircle","SvgDisableCircle"],table:{defaultValue:{summary:""},category:"PROPS"}},duration:{description:"持續時間",control:{type:"range",min:500,max:5e3,step:100},table:{defaultValue:{summary:1e3},category:"PROPS"}},action:{description:"操作",control:{type:"text"},table:{type:{summary:"Vue Component"},category:"SLOTS"}},className:{description:"客製化樣式",control:{type:"text"},table:{category:"PROPS"}}},parameters:{docs:{title:"Toast",description:{component:"通知訊息組件的呈現及說明。"}}}},p={name:"預設項目",args:{themeColor:"success",position:"top-right",title:"Notification Title",content:"Content",prefix:"SvgSuccessCircle",duration:1e3,action:'() => h ("div", {onClick: () => window.alert("action")}, "Action")',className:""},render:e=>({components:{Toast:d,Button:C,Title:S,Icon:l},setup(){const o=()=>{window.alert("Close")},t=x(()=>`ded-toast-border-${e.themeColor}`),i=x(()=>`ded-toast-header-message-${e.themeColor}`);return{args:e,onClose:o,toastBorderClass:t,toastHeaderMsgThemeClass:i,onAction:()=>{window.alert("Action")}}},template:`
...
`).trim()}}}}},v={name:"訊息類型",args:{position:"top-right",title:"Notification Title",content:"Content",duration:5e3,action:'() => h ("div", {onClick: () => window.alert("action")}, "Action")',className:""},render:e=>({components:{Toast:d,Button:C,Title:S,Icon:l},setup(){return{args:e,onClose:()=>{window.alert("Close")},onAction:()=>{window.alert("Action")}}},template:`
...
`).trim()}}}}};var D,z,E;p.parameters={...p.parameters,docs:{...(D=p.parameters)==null?void 0:D.docs,source:{originalSource:`{
  name: "預設項目",
  args: {
    themeColor: "success",
    position: "top-right",
