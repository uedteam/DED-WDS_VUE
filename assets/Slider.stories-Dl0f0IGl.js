import{_ as a}from"./Slider-DcAT52TJ.js";import{r as m}from"./vue.esm-bundler-BE8rPDeG.js";const c={title:"Design System/Slider",component:a,tags:["autodocs"],argTypes:{themeColor:{description:"主題顏色",control:{type:"select"},options:["primary","secondary","tertiary","success","warning","error","info"]},min:{description:"最小值",control:{type:"number"}},max:{description:"最大值",control:{type:"number"}},step:{description:"步進值",control:{type:"number"}},initValue:{description:"初始值",control:{type:"number"}},unit:{description:"單位",control:{type:"text"}},isDisabled:{description:"是否禁用",control:{type:"boolean"}},className:{description:"客製化樣式",control:{type:"text"}}},parameters:{docs:{title:"Slider",description:{component:"Slider組件的呈現及說明。"}}}},e={name:"預設項目",args:{themeColor:"primary",min:0,max:100,step:1,initValue:"50",unit:"℃",isDisabled:!1,className:""},render:n=>({components:{Slider:a},setup(){const i=m(20);return{args:n,sliderValue:i}},template:`
        ...
        `}),parameters:{controls:{}}},s={name:"主題色彩",args:{min:0,max:100,step:1,initValue:"50",unit:"℃",isDisabled:!1},render:n=>({components:{Slider:a},setup(){const i=m(20);return{args:n,sliderValue:i}},template:`
