...
`).trim()}}}}},y={name:"顯示資訊",args:{totalItems:100,currentPage:1,itemsPerPageOptions:[10,20,50],defaultItemsPerPage:10,isShowPageInfo:!0,className:""},render:i=>({components:{Pagination:b},setup(){return{args:i,handlePageChange:M("onPageChange")}},template:`
            <Pagination
                :totalItems="args.totalItems"
                :currentPage="args.currentPage"
                :itemsPerPageOptions="args.itemsPerPageOptions"
...
}`,...(E=(A=N.parameters)==null?void 0:A.docs)==null?void 0:E.source}}};var F,j,B;y.parameters={...y.parameters,docs:{...(F=y.parameters)==null?void 0:F.docs,source:{originalSource:`{
  name: "顯示資訊",
  args: {
    totalItems: 100,
    currentPage: 1,
...
}`,...(B=(j=y.parameters)==null?void 0:j.docs)==null?void 0:B.source}}};const ge=["PaginationDefault","PaginationDetail"];export{N as PaginationDefault,y as PaginationDetail,ge as __namedExportsOrder,ie as default};
