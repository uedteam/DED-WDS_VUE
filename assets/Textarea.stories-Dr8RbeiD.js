import{p as z,u as A,g as L,c as t,d as b,a as x,n as i,t as m,x as F,G as U,s as M,F as c,j as D,l as T,f as v,o as l,h as o}from"./vue.esm-bundler-CbCZpGld.js";import{_ as N}from"./Icon-DPZA6u3a.js";import{_ as f}from"./StatusIndicator-D-k-GenL.js";const O=["maxlength","placeholder"],d=Object.assign({inheritAttrs:!1},{__name:"Textarea",props:z({label:{type:String},placeholder:{type:String,default:"Placeholder"},limit:{type:Number,default:30},hint:{type:Object,default:()=>({error:"",description:""})},isDisabled:{type:Boolean,default:!1},className:{type:String,default:""}},{modelValue:{},modelModifiers:{}}),emits:["update:modelValue"],setup(r){const a=r,s=`${crypto.randomUUID()}-textarea`,n=A(r,"modelValue"),h=L(()=>a.hint.error?"error":a.hint.description?"desc":"");return(k,$)=>(l(),t("div",{class:i(["ded-textarea-container",{[a.className]:!!a.className}])},[a.label?(l(),t("label",{key:0,class:i(["ded-textarea-label",[{"ded-textarea-disable":a.isDisabled}]]),for:s},m(a.label),3)):b("",!0),x("div",{class:i(["ded-textarea-group",[{"ded-textarea-disable":a.isDisabled},h.value?`ded-textarea-border-${h.value}`:""]])},[F(x("textarea",M({id:s,"onUpdate:modelValue":$[0]||($[0]=j=>n.value=j),class:["ded-textarea",[{"ded-textarea-disable":a.isDisabled}]],maxlength:a.limit>0?a.limit:void 0,placeholder:a.placeholder},k.$attrs),null,16,O),[[U,n.value]]),n.value.length>0&&a.limit!==0?(l(),t("small",{key:0,class:i(["ded-textarea-hint-count",[{"ded-textarea-disable":a.isDisabled}]])},m(n.value.length>0?`${n.value.length} / ${a.limit}`:""),3)):b("",!0)],2),x("small",{class:i(["ded-textarea-hint",[{"ded-textarea-disable":a.isDisabled},`ded-textarea-hint-${h.value}`]])},[a.hint.error?(l(),t(c,{key:0},[typeof a.hint.error=="function"?(l(),D(T(a.hint.error),{key:0})):(l(),t(c,{key:1},[v(m(a.hint.error),1)],64))],64)):a.hint.description?(l(),t(c,{key:1},[typeof a.hint.description=="function"?(l(),D(T(a.hint.description),{key:0})):(l(),t(c,{key:1},[v(m(a.hint.description),1)],64))],64)):b("",!0)],2)],2))}});d.__docgenInfo={exportName:"default",displayName:"Textarea",description:"",tags:{},props:[{name:"label",type:{name:"string"}},{name:"placeholder",type:{name:"string"},defaultValue:{func:!1,value:'"Placeholder"'}},{name:"limit",type:{name:"number"},defaultValue:{func:!1,value:"30"}},{name:"hint",type:{name:"object"},defaultValue:{func:!1,value:`{
  error: "",
  description: ""
}`}},{name:"isDisabled",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"className",type:{name:"string"},defaultValue:{func:!1,value:'""'}}],sourceFiles:["/home/runner/work/DED-WDS_VUE/DED-WDS_VUE/libs/src/ui/element/Textarea/Textarea.vue"]};function B(r){return`{
        error: '${r.error||""}',
...
}`,...(I=(E=p.parameters)==null?void 0:E.docs)==null?void 0:I.source}}};var P,_,w;g.parameters={...g.parameters,docs:{...(P=g.parameters)==null?void 0:P.docs,source:{originalSource:`{
  name: "輸入框狀態",
  args: {
    label: "Label",
    placeholder: "Placeholder",
...
}`,...(w=(_=g.parameters)==null?void 0:_.docs)==null?void 0:w.source}}};const J=["TextareaDefault","TextareaLimit","TextareaStatus"];export{u as TextareaDefault,p as TextareaLimit,g as TextareaStatus,J as __namedExportsOrder,H as default};
