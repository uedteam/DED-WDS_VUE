...
`).trim()}}}}},r={name:"主題色彩",args:{level:3,className:"",default:"Title"},render:l=>({components:{Title:n},setup(){return{args:l}},template:`
        ...
        `}),parameters:{controls:{exclude:["themeColor"]},docs:{source:{transform:(l,a)=>{const{args:e}=a;return["<script setup>",'import { Title } from "@ded-wds-vue/ui";',"<\/script>","","<template>","  <Title",'    themeColor="primary"',`    ${e.level!==void 0?`:level="${e.level}"`:""}`,`    ${e.className?`className="${e.className}"`:""}`,"  >",`    ${e.default||""}`,"  </Title>","  <Title",'    themeColor="secondary"',`    ${e.level!==void 0?`:level="${e.level}"`:""}`,`    ${e.className?`className="${e.className}"`:""}`,"  >",`    ${e.default||""}`,"  </Title>","  <Title",'    themeColor="neutral"',`    ${e.level!==void 0?`:level="${e.level}"`:""}`,`    ${e.className?`className="${e.className}"`:""}`,"  >",`    ${e.default||""}`,"  </Title>","  <Title",'    themeColor="info"',`    ${e.level!==void 0?`:level="${e.level}"`:""}`,`    ${e.className?`className="${e.className}"`:""}`,"  >",`    ${e.default||""}`,"  </Title>","  <Title",'    themeColor="success"',`    ${e.level!==void 0?`:level="${e.level}"`:""}`,`    ${e.className?`className="${e.className}"`:""}`,"  >",`    ${e.default||""}`,"  </Title>","  <Title",'    themeColor="warning"',`    ${e.level!==void 0?`:level="${e.level}"`:""}`,`    ${e.className?`className="${e.className}"`:""}`,"  >",`    ${e.default||""}`,"  </Title>","  <Title",'    themeColor="error"',`    ${e.level!==void 0?`:level="${e.level}"`:""}`,`    ${e.className?`className="${e.className}"`:""}`,"  >",`    ${e.default||""}`,"  </Title>","</template>"].filter(Boolean).join(`
