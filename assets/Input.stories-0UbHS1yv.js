import{_ as l}from"./Input-CXagrWQd.js";import"./vue.esm-bundler-ChZ6yN_a.js";import"./Icon-CGw-UuIM.js";import"./iframe-Ba_qZpvn.js";import"../sb-preview/runtime.js";function g(a){return`{
        error: '${a.error||""}',
        description: '${a.description||""}'
    }`}const x={title:"Design System/Input",component:l,tags:["autodocs"],argTypes:{label:{description:"標題",control:{type:"text"}},type:{description:"輸入類型",control:{type:"select"},options:["number","text","password","email"],table:{type:{summary:"number | text | password | email "}}},placeholder:{description:"輸入提示",control:{type:"text"}},prefix:{description:"前置元素",control:{type:"select",labels:{"":"None",home:"home",folder:"folder",lock:"lock","arrow-forward":"arrow-forward","finger-print":"finger-print",account_circle:"account_circle"}},options:["","home","folder","lock","arrow-forward","finger-print","account_circle"]},size:{description:"輸入框尺寸",control:{type:"select"},options:["small","medium","large"],table:{type:{summary:"small | medium | large "}}},initValue:{description:"初始值",control:{type:"text"}},hint:{description:"提示訊息",control:{type:"object"},table:{type:{summary:"{ error: string; description: string; }"}}},isDisabled:{description:"是否禁用",control:{type:"boolean"}},className:{description:"客製化樣式",control:{type:"text"}}},parameters:{docs:{title:"Input",description:{component:"Input 組件的呈現及說明。。"}}}},s={name:"預設項目",args:{label:"Label",type:"text",placeholder:"Placeholder...",prefix:"account_circle",size:"medium",initValue:"",hint:{error:"",description:"Prompt message"},isDisabled:!1,className:""},render:a=>({components:{Input:l},setup(){return{args:a}},template:`
            <Input
                :label="args.label"
                :type="args.type"
...
}`,...(c=(u=r.parameters)==null?void 0:u.docs)==null?void 0:c.source}}};const y=["InputDefault","InputStatus"];export{s as InputDefault,r as InputStatus,y as __namedExportsOrder,x as default};
