import{a as c,r as l,n as d,o as f}from"./vue.esm-bundler-_3atnb9w.js";const a={__name:"index",props:{className:{type:String,default:""}},setup(t){const n=t;return(e,u)=>(f(),c("div",{class:d({"ded-layout":!0,[n.className]:!!n.className})},[l(e.$slots,"default")],2))}};a.__docgenInfo={exportName:"default",displayName:"Layout",description:"",tags:{},props:[{name:"className",type:{name:"string"},defaultValue:{func:!1,value:'""'}}],slots:[{name:"default"}],sourceFiles:["D:/98_測試/up/DED-WDS_VUE/libs/src/ui/layout/Layout/index.vue"]};const s={__name:"Header",props:{className:{type:String,default:""}},setup(t){const n=t;return(e,u)=>(f(),c("header",{class:d({"ded-header":!0,[n.className]:!!n.className})},[l(e.$slots,"default")],2))}};s.__docgenInfo={exportName:"default",displayName:"Header",description:"",tags:{},props:[{name:"className",type:{name:"string"},defaultValue:{func:!1,value:'""'}}],slots:[{name:"default"}],sourceFiles:["D:/98_測試/up/DED-WDS_VUE/libs/src/ui/layout/Layout/Header.vue"]};const r={__name:"Content",props:{className:{type:String,default:""}},setup(t){const n=t;return(e,u)=>(f(),c("main",{class:d({"ded-content":!0,[n.className]:!!n.className})},[l(e.$slots,"default")],2))}};r.__docgenInfo={exportName:"default",displayName:"Content",description:"",tags:{},props:[{name:"className",type:{name:"string"},defaultValue:{func:!1,value:'""'}}],slots:[{name:"default"}],sourceFiles:["D:/98_測試/up/DED-WDS_VUE/libs/src/ui/layout/Layout/Content.vue"]};const o={__name:"Footer",props:{className:{type:String,default:""}},setup(t){const n=t;return(e,u)=>(f(),c("footer",{class:d({"ded-footer":!0,[n.className]:!!n.className})},[l(e.$slots,"default")],2))}};o.__docgenInfo={exportName:"default",displayName:"Footer",description:"",tags:{},props:[{name:"className",type:{name:"string"},defaultValue:{func:!1,value:'""'}}],slots:[{name:"default"}],sourceFiles:["D:/98_測試/up/DED-WDS_VUE/libs/src/ui/layout/Layout/Footer.vue"]};const i={__name:"Side",props:{className:{type:String,default:""}},setup(t){const n=t;return(e,u)=>(f(),c("aside",{class:d({"ded-side":!0,[n.className]:!!n.className})},[l(e.$slots,"default")],2))}};i.__docgenInfo={exportName:"default",displayName:"Side",description:"",tags:{},props:[{name:"className",type:{name:"string"},defaultValue:{func:!1,value:'""'}}],slots:[{name:"default"}],sourceFiles:["D:/98_測試/up/DED-WDS_VUE/libs/src/ui/layout/Layout/Side.vue"]};const R={components:{Layout:a,Header:s,Content:r,Side:i,Footer:o},title:"Design System/Layout",tags:["autodocs"],argTypes:{className:{description:"客製化樣式",control:{type:"text"}}},parameters:{docs:{title:"Layout",description:{component:"Layout 組件的呈現及說明。"}}}},m={name:"預設項目",args:{className:""},render:t=>({components:{Layout:a,Header:s,Content:r,Side:i,Footer:o},setup(){return{args:t}},template:`
...
`).trim()}}}},g={name:"三段式佈局",args:{className:""},render:t=>({components:{Layout:a,Header:s,Content:r,Side:i,Footer:o},setup(){return{args:t}},template:`
            <Layout :className="args.className">
...
`).trim()}}}}},y={name:"左側欄三段式佈局",args:{className:""},render:t=>({components:{Layout:a,Header:s,Content:r,Side:i,Footer:o},setup(){return{args:t}},template:`
            <Layout :className="args.className">
                <Header :className="args.className" >
                    <div style="
                        width: 100%;
...
`).trim()}}}}},h={name:"右側欄三段式佈局",args:{className:""},render:t=>({components:{Layout:a,Header:s,Content:r,Side:i,Footer:o},setup(){return{args:t}},template:`
            <Layout :className="args.className">
                <Header :className="args.className" >
                    <div style="
                        width: 100%;
...
`).trim()}}}}},N={name:"左側欄固定佈局",args:{className:""},render:t=>({components:{Layout:a,Header:s,Content:r,Side:i,Footer:o},setup(){return{args:t}},template:`
            <Layout :className="args.className">
                <Side :className="args.className" >
                    <div style="
                            width: 100%;
...
`).trim()}}}}},p={name:"標準左側佈局",args:{className:""},render:t=>({components:{Layout:a,Header:s,Content:r,Side:i,Footer:o},setup(){return{args:t}},template:`
            <Layout :className="args.className">
                <Header :className="args.className" >
                    <div style="
                        width: 100%;
...
`).trim()}}}}},v={name:"官網佈局",args:{className:""},render:t=>({components:{Layout:a,Header:s,Content:r,Side:i,Footer:o},setup(){return{args:t}},template:`
            <Layout :className="args.className">
                <Header :className="args.className" >
                    <div style="
                        width: 100%;
...
`).trim()}}}}};var x,C,L;m.parameters={...m.parameters,docs:{...(x=m.parameters)==null?void 0:x.docs,source:{originalSource:`{
  name: '預設項目',
  args: {
    className: ''
  },
...
}`,...(L=(C=m.parameters)==null?void 0:C.docs)==null?void 0:L.source}}};var S,F,j;g.parameters={...g.parameters,docs:{...(S=g.parameters)==null?void 0:S.docs,source:{originalSource:`{
  name: '三段式佈局',
  args: {
    className: ''
  },
...
}`,...(j=(F=g.parameters)==null?void 0:F.docs)==null?void 0:j.source}}};var b,w,k;y.parameters={...y.parameters,docs:{...(b=y.parameters)==null?void 0:b.docs,source:{originalSource:`{
  name: '左側欄三段式佈局',
  args: {
    className: ''
  },
...
}`,...(k=(w=y.parameters)==null?void 0:w.docs)==null?void 0:k.source}}};var H,$,D;h.parameters={...h.parameters,docs:{...(H=h.parameters)==null?void 0:H.docs,source:{originalSource:`{
  name: '右側欄三段式佈局',
  args: {
    className: ''
  },
...
}`,...(D=($=h.parameters)==null?void 0:$.docs)==null?void 0:D.source}}};var _,E,A;N.parameters={...N.parameters,docs:{...(_=N.parameters)==null?void 0:_.docs,source:{originalSource:`{
  name: '左側欄固定佈局',
  args: {
    className: ''
  },
...
}`,...(A=(E=N.parameters)==null?void 0:E.docs)==null?void 0:A.source}}};var B,V,I;p.parameters={...p.parameters,docs:{...(B=p.parameters)==null?void 0:B.docs,source:{originalSource:`{
  name: '標準左側佈局',
  args: {
    className: ''
  },
...
}`,...(I=(V=p.parameters)==null?void 0:V.docs)==null?void 0:I.source}}};var U,W,O;v.parameters={...v.parameters,docs:{...(U=v.parameters)==null?void 0:U.docs,source:{originalSource:`{
  name: '官網佈局',
  args: {
    className: ''
  },
...
}`,...(O=(W=v.parameters)==null?void 0:W.docs)==null?void 0:O.source}}};const z=["LayoutDefaultStory","LayoutThirdStory","LayoutLeftDrawerStory","LayoutRightDrawerStory","LayoutLeftFixedStory","LayoutLeftStory","LayoutOfficialStory"];export{m as LayoutDefaultStory,y as LayoutLeftDrawerStory,N as LayoutLeftFixedStory,p as LayoutLeftStory,v as LayoutOfficialStory,h as LayoutRightDrawerStory,g as LayoutThirdStory,z as __namedExportsOrder,R as default};
