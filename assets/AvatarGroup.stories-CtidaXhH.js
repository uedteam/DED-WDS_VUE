import{c as v,e as b,a as n,F as S,k as f,b as c,n as m,l as C,t as h,j as A,D as E,f as y,o as t,g as L}from"./vue.esm-bundler-Dy0-1sXb.js";import{_}from"./Avatar-GlhffAS2.js";import{_ as V}from"./List-BCG8_eB9.js";import"./Image-KmhcDqSN.js";import"./index-Bb4qSo10.js";import"./Icon-CmRF7X1d.js";import"./iframe-BIepwXO7.js";import"../sb-preview/runtime.js";const z={key:0,class:"rest-container"},j={class:"text-medium"},B={key:0,class:"rest-container-menu"},F={style:{"margin-right":"auto"}},g={__name:"AvatarGroup",props:{dataSource:{type:Array,default:()=>[]},limit:{type:Number,default:1},className:{type:String,default:""}},setup(r){const a=r,o=v(()=>{const s=a.dataSource.length-a.limit;return s>=99?99:s}),l=(s,u)=>{const e=s.slice(0,u),d=s.slice(u);return{currList:e,restList:d}},D=v(()=>l(a.dataSource,a.limit).currList),N=v(()=>l(a.dataSource,a.limit).restList),p=b(!1),k=()=>{p.value=!p.value};return(s,u)=>(t(),n("div",{class:m({"avatar-group":!0,[a.className]:!!a.className})},[(t(!0),n(S,null,f(D.value,(e,d)=>(t(),L(_,{key:d,src:e.src,alt:"alt text",username:e.userName},null,8,["src","username"]))),128)),N.value.length>0?(t(),n("div",z,[c("div",j,[c("button",{class:m(["avatar-container",a.size?`avatar-container-${a.size}`:"avatar-container-medium"]),onClick:u[0]||(u[0]=C(e=>k(),["prevent"])),style:{cursor:"pointer"}},[c("span",{class:m(["avatar",a.shape?`avatar-${a.shape}`:"avatar-circle"])},[c("span",{class:m(["avatar-text",a.size?`text-${a.size}`:"text-medium"])},h(`+${o.value}`),3)],2)],2)]),p.value?(t(),n("div",B,[A(V,null,{default:E(()=>[(t(!0),n(S,null,f(N.value,e=>(t(),n("li",{class:"menu-item",key:e.userName},[A(_,{size:"xsmall",src:e.src,alt:"alt text",username:e.userName},null,8,["src","username"]),c("div",F,h(e.userName),1)]))),128))]),_:1})])):y("",!0)])):y("",!0)],2))}};g.__docgenInfo={exportName:"default",displayName:"AvatarGroup",description:"",tags:{},props:[{name:"dataSource",type:{name:"array"},defaultValue:{func:!1,value:"[]"}},{name:"limit",type:{name:"number"},defaultValue:{func:!1,value:"1"}},{name:"className",type:{name:"string"},defaultValue:{func:!1,value:"''"}}],sourceFiles:["D:/98_測試/up/DED-WDS_VUE/libs/src/ui/element/AvatarGroup/AvatarGroup.vue"]};function M(r){return`[
    ${r.map(a=>`{
        userName: '${a.userName}',
        src: '${a.imageSrc}',
    }`).join(`,
