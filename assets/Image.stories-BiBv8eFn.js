import{_ as o}from"./Image-ClUrw8Er.js";import"./vue.esm-bundler-g0-RGFhA.js";const I={title:"Component/Image",component:o,tags:["autodocs"],argTypes:{src:{description:"圖片來源",control:{type:"text"}},alt:{description:"圖片替代文字",control:{type:"text"}},ratio:{description:"圖片比例",control:{type:"select"},options:["11","43","54","169"],table:{type:{summary:"1x1 | 4x3 | 5x4 | 16x9"}}},objectFit:{description:"圖片填滿方式",control:{type:"select"},options:["cover","contain","fill","none"],table:{type:{summary:"cover | contain | fill | none"}}},className:{description:"客製化樣式",control:{type:"text"}}},parameters:{docs:{title:"圖片",description:{component:"圖片組件的呈現及說明。"}}}},s={name:"預設項目",args:{src:"https://picsum.photos/300/300",alt:"placeholder",ratio:"1x1",objectFit:"cover",className:""},render:a=>({components:{Image:o},setup(){return{args:a}},template:`
