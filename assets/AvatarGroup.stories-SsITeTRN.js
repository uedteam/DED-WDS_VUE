import{c as N,r as y,h as D,k as B,a as o,F as x,A as _,n as c,b as m,t as w,C as V,d as S,B as L,p as M,e as $,D as j,T as F,o as s}from"./vue.esm-bundler-7m8tONXv.js";import{_ as G}from"./Avatar-izVyhKbQ.js";import{_ as W}from"./List-3jIaY4y3.js";import"./Image-Cv0KVQN9.js";import"./index-Bb4qSo10.js";import"./Icon-Brgto6mM.js";import"./iframe-VDKxfFGG.js";import"../sb-preview/runtime.js";const O={class:"ded-list-item-text"},P={"data-v-2ddf7f21":"",class:"ded-list-item-label"},A={__name:"AvatarGroup",props:{dataSource:{type:Array,required:!0},size:{type:String,default:"medium",validator:n=>["xsmall","small","medium","large"].includes(n)},limit:{type:Number,default:1},className:{type:String,default:""}},setup(n){const e=n,i=N(()=>{const a=e.dataSource.length-e.limit;return a>=99?99:a}),p=(a,u)=>{const r=a.slice(0,u),f=a.slice(u);return{currList:r,restList:f}},k=N(()=>p(e.dataSource,e.limit).currList),v=N(()=>p(e.dataSource,e.limit).restList),l=y(!1),z=y(null),g=y({top:"0px",left:"0px"}),t=()=>{var u;const a=(u=z.value)==null?void 0:u.getBoundingClientRect();a&&(g.value={top:`${a.bottom+window.scrollY+8}px`,left:`${a.left+window.scrollX}px`})},C=()=>{l.value=!l.value,l.value?(t(),window.addEventListener("resize",t),window.addEventListener("scroll",t,!0)):(window.removeEventListener("resize",t),window.removeEventListener("scroll",t,!0))};return D(()=>{l.value&&(window.addEventListener("resize",t),window.addEventListener("scroll",t,!0))}),B(()=>{window.removeEventListener("resize",t),window.removeEventListener("scroll",t,!0)}),(a,u)=>(s(),o("div",{class:c({"ded-avatar-group":!0,[e.className]:!!e.className})},[(s(!0),o(x,null,_(k.value,(r,f)=>(s(),L(G,{key:f,size:e.size,src:r.src,alt:"alt text",userName:r.userName},null,8,["size","src","userName"]))),128)),v.value.length>0?(s(),o("div",{key:0,class:"rest-container",ref_key:"restContainerRef",ref:z},[v.value.length>0?(s(),o("div",{key:0,class:c(["ded-avatar-container",e.size?`ded-avatar-container-${e.size}`:"ded-avatar-container-medium"])},[m("button",{class:c(["ded-avatar",e.shape?`ded-avatar-${e.shape}`:"ded-avatar-circle"]),onClick:V(C,["prevent"]),style:{cursor:"pointer"}},[m("span",{class:c(["ded-avatar-text",e.size?`text-${e.size}`:"text-medium"])},w(`+${i.value}`),3)],2)],2)):S("",!0),(s(),L(F,{to:"body"},[l.value?(s(),o("div",{key:0,class:"ded-dropdown-menu",style:M({position:"absolute",top:g.value.top,left:g.value.left,zIndex:9999})},[$(W,{hasOutline:!0},{default:j(()=>[(s(!0),o(x,null,_(v.value,r=>(s(),o("li",{class:"ded-list-item",key:r.userName,style:{"border-bottom":"none"}},[m("div",O,[$(G,{size:"xsmall",src:r.src,alt:"alt text",userName:r.userName},null,8,["src","userName"]),m("div",P,w(r.userName),1)])]))),128))]),_:1})],4)):S("",!0)]))],512)):S("",!0)],2))}};A.__docgenInfo={exportName:"default",displayName:"AvatarGroup",description:"",tags:{},props:[{name:"dataSource",type:{name:"array"},required:!0},{name:"size",type:{name:"string"},defaultValue:{func:!1,value:'"medium"'},values:["xsmall","small","medium","large"]},{name:"limit",type:{name:"number"},defaultValue:{func:!1,value:"1"}},{name:"className",type:{name:"string"},defaultValue:{func:!1,value:'""'}}],sourceFiles:["/Users/auouser/Desktop/Work_Space/DED-WDS_VUE/libs/src/ui/element/AvatarGroup/AvatarGroup.vue"]};function R(n){return`[
        ${n.map(e=>`{
            userName: "${e.userName}",
            src: "${e.src}",
        }`).join(`,
