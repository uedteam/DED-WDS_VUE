import{p as g,u as b,v,c as o,x as y,a as n,J as D,t as m,F as V,q as x,n as c,b as $,o as i}from"./vue.esm-bundler-CbCZpGld.js";import{_ as h}from"./Icon-DutXaB3l.js";const N=["disabled"],_={value:"",disabled:"",selected:""},O=["value"],d={__name:"Select",props:g({dataSource:{type:Array,required:!0},placeholder:{type:String,default:"Select"},suffix:{type:String},isDisabled:{type:Boolean,default:!1},className:{type:String,default:""}},{modelValue:{},modelModifiers:{}}),emits:["update:modelValue"],setup(s){const e=s,a=b(s,"modelValue"),l=v(a);return(w,u)=>(i(),o("div",{class:c(["ded-select-container",{[e.className]:!!e.className}])},[y(n("select",{"onUpdate:modelValue":u[0]||(u[0]=t=>l.value=t),class:c(["ded-select",{"ded-select-disabled":e.isDisabled}]),disabled:e.isDisabled},[n("option",_,m(e.placeholder),1),(i(!0),o(V,null,x(e.dataSource,t=>(i(),o("option",{key:t.value,value:t.value},m(t.label),9,O))),128))],10,N),[[D,l.value]]),n("div",{class:c(["ded-select-icon",{"ded-select-icon-disabled":e.isDisabled}])},[$(h,{name:e.suffix,size:"18"},null,8,["name"])],2)],2))}};d.__docgenInfo={exportName:"default",displayName:"Select",description:"",tags:{},props:[{name:"dataSource",type:{name:"array"},required:!0},{name:"placeholder",type:{name:"string"},defaultValue:{func:!1,value:'"Select"'}},{name:"suffix",type:{name:"string"}},{name:"isDisabled",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"className",type:{name:"string"},defaultValue:{func:!1,value:'""'}}],sourceFiles:["/Users/auouser/Desktop/Work_Space/DED-WDS_VUE/libs/src/ui/element/Select/Select.vue"]};function A(s){return`[
    ${s.map(e=>`{
        label: '${e.label}',
        value: '${e.value}',
    }`).join(`,
...
}`,...(S=(f=r.parameters)==null?void 0:f.docs)==null?void 0:S.source}}};const k=["SelectDefault"];export{r as SelectDefault,k as __namedExportsOrder,j as default};
