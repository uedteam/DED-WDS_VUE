import{_ as n}from"./Input-pAIIosQR.js";import"./vue.esm-bundler-qCK_iSPY.js";import"./Icon-BjVA2wzQ.js";import"./iframe-BVAqVFki.js";import"../sb-preview/runtime.js";function b(a){return`{
        error: '${a.error||""}',
        description: '${a.description||""}'
            ...
            />
            `}),parameters:{controls:{exclude:["input","clearDatePicker"]},docs:{source:{transform:(a,s)=>{const{args:e}=s,x=b(e.hint);return["<Input",`  label="${e.label}"`,`  type="${e.type}"`,`  hasClear="${e.hasClear}"`,`  placeholder="${e.placeholder}"`,`  prefix="${e.prefix}"`,`  size="${e.size}"`,`  maxLimit="${e.maxLimit}"`,`  :hint="${x}"`,`  :isDisabled="${e.isDisabled}"`,`  className="${e.className}"`,'  v-model="modelValue"',"/>"].join(`
`).trim()}}}}},l={name:"輸入類型",args:{hasClear:!0,placeholder:"Placeholder",size:"medium",maxLimit:0,hint:{error:"",description:"Prompt message"},isDisabled:!1,className:"",modelValue:""},render:a=>({components:{Input:n},setup(){return{args:a}},template:`
