import{m as S,u as C,g as P,c as n,n as s,t as c,e as u,a as g,l as E,B as _,o as i}from"./vue.esm-bundler-qCK_iSPY.js";const M=["maxlength","placeholder"],t={__name:"Textarea",props:S({label:{type:String},placeholder:{type:String,default:"Placeholder"},limit:{type:Number,default:30},hint:{type:Object,default:()=>({error:"",description:""})},isDisabled:{type:Boolean,default:!1},className:{type:String,default:""}},{modelValue:{},modelModifiers:{}}),emits:["update:modelValue"],setup(a){const l=C(a,"modelValue"),e=a,r=P(()=>e.hint.error.length>0?"error":e.hint.description.length>0?"desc":"");return(j,p)=>(i(),n("div",{class:s({"ded-textarea-container":!0,[e.className]:!!e.className})},[e.label?(i(),n("label",{key:0,class:s(["ded-textarea-label",{"ded-textarea-disable":e.isDisabled}]),for:"id"},c(e.label),3)):u("",!0),g("div",{class:s(["ded-textarea-group",{"ded-textarea-disable":e.isDisabled},e.hint.error.length>0&&`ded-textarea-border-${r.value}`])},[E(g("textarea",{id:"id",class:s(["ded-textarea",{"ded-textarea-disable":e.isDisabled}]),maxlength:e.limit>0?e.limit:void 0,placeholder:e.placeholder,"onUpdate:modelValue":p[0]||(p[0]=v=>l.value=v)},null,10,M),[[_,l.value]]),l.value.length>0&&e.limit!==0?(i(),n("small",{key:0,class:s(["ded-textarea-hint-count",{"ded-textarea-disable":e.isDisabled}])},c(l.value.length>0?`${l.value.length} / ${e.limit}`:""),3)):u("",!0)],2),e.hint.error.length>0||e.hint.description.length>0?(i(),n("small",{key:1,class:s(["ded-textarea-hint",{"ded-textarea-disable":e.isDisabled},`ded-textarea-hint-${r.value}`])},c(e.hint.error.length>0?e.hint.error:e.hint.description),3)):u("",!0)],2))}};t.__docgenInfo={exportName:"default",displayName:"Textarea",description:"",tags:{},props:[{name:"label",type:{name:"string"}},{name:"placeholder",type:{name:"string"},defaultValue:{func:!1,value:'"Placeholder"'}},{name:"limit",type:{name:"number"},defaultValue:{func:!1,value:"30"}},{name:"hint",type:{name:"object"},defaultValue:{func:!1,value:`{
    ...
    description: ""
        ...
        description: '${a.description||""}'
            ...
            ></Textarea>
        `}),parameters:{controls:{},docs:{source:{transform:(a,l)=>{const{args:e}=l,r=y(e.hint);return["<Textarea",`  label="${e.label}"`,`  placeholder="${e.placeholder}"`,`  :limit="${e.limit}"`,`  :hint="${r}"`,`  :isDisabled="${e.isDisabled}"`,`  className="${e.className}"`,'  v-model="modelValue"',"></Textarea>"].join(`
...
}`,...(x=(h=o.parameters)==null?void 0:h.docs)==null?void 0:x.source}}};var D,T,f;d.parameters={...d.parameters,docs:{...(D=d.parameters)==null?void 0:D.docs,source:{originalSource:`{
  name: "字數限制",
  args: {
    label: "Label",
    placeholder: "Placeholder",
...
}`,...(f=(T=d.parameters)==null?void 0:T.docs)==null?void 0:f.source}}};var $,N,V;m.parameters={...m.parameters,docs:{...($=m.parameters)==null?void 0:$.docs,source:{originalSource:`{
  name: "輸入框狀態",
  args: {
    label: "Label",
    placeholder: "Placeholder",
