import{_ as i}from"./Image-v-dZlYpA.js";import"./vue.esm-bundler-BaxPAcbg.js";import"./index-Bb4qSo10.js";const I={title:"Design System/Image*",component:i,tags:["autodocs"],argTypes:{src:{description:"圖片來源",control:{type:"text"}},alt:{description:"圖片替代文字",control:{type:"text"}},objectFit:{description:"調整圖片適合其容器",control:{type:"select"},options:["cover","contain","fill","none"]},ratio:{description:"調整圖片比例",table:{defaultValue:{summary:"1/1"}},control:{type:"select"},options:["1/1","4/3","5/4","16/9"],mapping:{"1/1":"11","4/3":"43","5/4":"54","16/9":"169"}}},parameters:{docs:{title:"圖片",description:{component:"圖片組件的呈現及說明。"}}}},o={name:"預設項目",args:{src:"https://picsum.photos/300/300",alt:"User Photo",objectFit:"cover",ratio:"11"},render:e=>({components:{Image:i},setup(){return{args:e}},template:`
