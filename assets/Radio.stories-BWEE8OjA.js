import{p as B,u as E,c as S,F as h,q as j,n as i,o as f,x as F,a as v,K as k,s as I,t as M}from"./vue.esm-bundler-CC1hEtM-.js";const U=["for"],q=["id","value","name"],n=Object.assign({inheritAttrs:!1},{__name:"Radio",props:B({dataSource:{type:Array,required:!0},direction:{type:String,default:"row",validator:o=>["row","column"].includes(o)},size:{type:String,default:"medium",validator:o=>["small","medium","large"].includes(o)},className:{type:String,default:""}},{modelValue:{},modelModifiers:{}}),emits:["update:modelValue"],setup(o){const a=o,e=crypto.randomUUID(),s=p=>`${e}-radio-${p}`,t=E(o,"modelValue");return(p,R)=>(f(),S("div",{class:i(["ded-radio-container",{[`ded-radio-container-${a.direction}`]:a.direction,[a.className]:!!a.className}])},[(f(!0),S(h,null,j(a.dataSource,(r,g)=>(f(),S("label",{key:g,class:i(["ded-radio",{"ded-radio-input-disabled":r.isDisabled,[`ded-text-${a.size}`]:a.size}]),for:s(g)},[F(v("input",I({ref_for:!0},p.$attrs,{id:s(g),"onUpdate:modelValue":R[0]||(R[0]=A=>t.value=A),class:"ded-radio-input",type:"radio",value:r.value,name:r.name}),null,16,q),[[k,t.value]]),v("div",{class:i(["ded-radio-icon",{[`ded-icon-${a.size}`]:a.size,"ded-radio-icon-disabled":r.isDisabled,"ded-radio-checked":t.value===r.value,"ded-radio-unchecked":t.value!==r.value}])},null,2),v("span",{class:i(["ded-radio-text",r.isDisabled?"ded-radio-text-disabled":""])},M(r.label),3)],10,U))),128))],2))}});n.__docgenInfo={exportName:"default",displayName:"Radio",description:"",tags:{},props:[{name:"dataSource",type:{name:"array"},required:!0},{name:"direction",type:{name:"string"},defaultValue:{func:!1,value:'"row"'},values:["row","column"]},{name:"size",type:{name:"string"},defaultValue:{func:!1,value:'"medium"'},values:["small","medium","large"]},{name:"className",type:{name:"string"},defaultValue:{func:!1,value:'""'}}],sourceFiles:["D:/98_測試/up/DED-WDS_VUE/libs/src/ui/element/Radio/Radio.vue"]};function m(o){return`    ${o.map(a=>`{
        label: "${a.label}",
        value: "${a.value}",
...
`).trim()}}}}};var b,N,$;d.parameters={...d.parameters,docs:{...(b=d.parameters)==null?void 0:b.docs,source:{originalSource:`{
  name: "預設項目",
  args: {
    // themeColor: 'primary',
    dataSource: [{
...
}`,...($=(N=d.parameters)==null?void 0:N.docs)==null?void 0:$.source}}};var V,z,y;l.parameters={...l.parameters,docs:{...(V=l.parameters)==null?void 0:V.docs,source:{originalSource:`{
  name: "垂直排列",
  args: {
    // themeColor: 'primary',
    dataSource: [{
...
}`,...(y=(z=l.parameters)==null?void 0:z.docs)==null?void 0:y.source}}};var D,x,O;c.parameters={...c.parameters,docs:{...(D=c.parameters)==null?void 0:D.docs,source:{originalSource:`{
  name: "水平排列",
  args: {
    // themeColor: 'primary',
    dataSource: [{
...
}`,...(_=(C=u.parameters)==null?void 0:C.docs)==null?void 0:_.source}}};const P=["RadioDefaultStory","RadioVerticalStory","RadioRowStory","RadioSizeStory"];export{d as RadioDefaultStory,c as RadioRowStory,u as RadioSizeStory,l as RadioVerticalStory,P as __namedExportsOrder,L as default};
