import{m as B,u as E,c as m,F as j,j as A,n as t,o as p,l as _,a as g,K as F,t as h}from"./vue.esm-bundler-CScppja8.js";const k=["value","name"],n={__name:"Radio",props:B({dataSource:{type:Array,required:!0},direction:{type:String,default:"row",validator:a=>["row","column"].includes(a)},size:{type:String,default:"medium",validator:a=>["small","medium","large"].includes(a)},className:{type:String,default:""}},{modelValue:{},modelModifiers:{}}),emits:["update:modelValue"],setup(a){const o=E(a,"modelValue"),e=a;return(r,S)=>(p(),m("div",{class:t({"ded-radio-container":!0,[`ded-radio-container-${e.direction}`]:e.direction,[e.className]:!!e.className})},[(p(!0),m(j,null,A(e.dataSource,(s,w)=>(p(),m("label",{key:w,class:t(["ded-radio",{"ded-radio-input-disabled":s.isDisabled,[`ded-text-${e.size}`]:e.size}])},[_(g("input",{class:"ded-radio-input",type:"radio",value:s.value,name:s.name,"onUpdate:modelValue":S[0]||(S[0]=C=>o.value=C)},null,8,k),[[F,o.value]]),g("div",{class:t({"ded-radio-icon":!0,[`ded-icon-${e.size}`]:e.size,"ded-radio-icon-disabled":s.isDisabled,"ded-radio-checked":o.value===s.value,"ded-radio-unchecked":o.value!==s.value})},null,2),g("span",{class:t(["ded-radio-text",s.isDisabled?"ded-radio-text-disabled":""])},h(s.label),3)],2))),128))],2))}};n.__docgenInfo={exportName:"default",displayName:"Radio",description:"",tags:{},props:[{name:"dataSource",type:{name:"array"},required:!0},{name:"direction",type:{name:"string"},defaultValue:{func:!1,value:'"row"'},values:["row","column"]},{name:"size",type:{name:"string"},defaultValue:{func:!1,value:'"medium"'},values:["small","medium","large"]},{name:"className",type:{name:"string"},defaultValue:{func:!1,value:'""'}}],sourceFiles:["D:/98_測試/up/DED-WDS_VUE/libs/src/ui/element/Radio/Radio.vue"]};function u(a){return`[
    ${a.map(o=>`{
        label: '${o.label}',
        value: '${o.value}',
...
}`,...($=(N=l.parameters)==null?void 0:N.docs)==null?void 0:$.source}}};var V,z,y;d.parameters={...d.parameters,docs:{...(V=d.parameters)==null?void 0:V.docs,source:{originalSource:`{
  name: "水平排列",
  args: {
    // themeColor: 'primary',
    dataSource: [{
...
}`,...(O=(x=c.parameters)==null?void 0:x.docs)==null?void 0:O.source}}};const U=["RadioDefaultStory","RadioVerticalStory","RadioRowStory","RadioSizeStory"];export{i as RadioDefaultStory,d as RadioRowStory,c as RadioSizeStory,l as RadioVerticalStory,U as __namedExportsOrder,q as default};
