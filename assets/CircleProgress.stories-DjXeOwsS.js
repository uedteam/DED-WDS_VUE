...
`).trim()}}}}},m={name:"顯示標籤",args:{themeColor:"primary",label:"測試",percent:66,size:120,strokeWidth:10,className:""},render:s=>({components:{CircleProgress:o},setup(){return{args:s}},template:`
...
`).trim()}}}}},d={name:"主題色彩",args:{label:"測試",size:120,strokeWidth:10,className:""},render:s=>({components:{CircleProgress:o},setup(){return{args:s}},template:`
