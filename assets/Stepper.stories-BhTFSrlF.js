import{c as P,a as o,e as a,F as k,B as _,t as u,n as v,o as p,d as x}from"./vue.esm-bundler-BQySH7jJ.js";import{_ as A}from"./Button-CQMIYjcW.js";import"./Icon-f9eBqVFj.js";import"./iframe-C0k4Wqte.js";import"../sb-preview/runtime.js";const j={class:"ded-stepper-header"},w={class:"ded-step-circle"},z={class:"ded-step-group"},E={class:"ded-step-title"},F={key:0,class:"ded-step-description"},M={key:0,class:"ded-step-connector"},V={class:"ded-stepper-content"},c={__name:"Stepper",props:{steps:{type:Array,required:!0},currentStep:{type:Number,required:!0},direction:{type:String,default:"horizontal",validator:t=>["horizontal","vertical"].includes(t)},className:{type:String,default:""}},setup(t){const e=t,n=P(()=>s=>s===e.currentStep?"ded-step-active":s<e.currentStep?"ded-step-completed":"");return(s,r)=>{var f;return p(),o("div",{class:v({"ded-stepper":!0,[`ded-stepper-${e.direction}`]:e.direction,[e.className]:!!e.className})},[a("div",j,[(p(!0),o(k,null,_(e.steps,(g,i)=>(p(),o("div",{key:i,class:v(["ded-step",n.value(i)])},[a("div",w,u(i+1),1),a("div",z,[a("div",E,u(g.title),1),g.desc?(p(),o("div",F,u(g.desc),1)):x("",!0)]),t.direction==="vertical"&&i!==t.steps.length-1?(p(),o("div",M)):x("",!0)],2))),128))]),a("div",V,u(((f=t.steps[t.currentStep])==null?void 0:f.content)||"No content available for this step."),1)],2)}}};c.__docgenInfo={exportName:"default",displayName:"Stepper",description:"",tags:{},props:[{name:"steps",type:{name:"array"},required:!0},{name:"currentStep",type:{name:"number"},required:!0},{name:"direction",type:{name:"string"},defaultValue:{func:!1,value:'"horizontal"'},values:["horizontal","vertical"]},{name:"className",type:{name:"string"},defaultValue:{func:!1,value:'""'}}],sourceFiles:["/Users/auouser/Desktop/Work_Space/DED-WDS_VUE/libs/src/ui/element/Stepper/Stepper.vue"]};function m(t){return`[
        ${t.map(e=>`{
            title: "${e.title}",
            desc: "${e.desc}",
            content: "${e.content}",
...
}`,...(b=($=S.parameters)==null?void 0:$.docs)==null?void 0:b.source}}};const L=["StepperDefault","StepperHorizontal","StepperVertical"];export{l as StepperDefault,d as StepperHorizontal,S as StepperVertical,L as __namedExportsOrder,I as default};
