import{m as g,u as b,k as v,c as o,l as D,a as n,J as y,t as m,F as V,h,n as c,b as x,o as i}from"./vue.esm-bundler-CeRU4-k3.js";import{_ as $}from"./Icon-BO2J-day.js";const N=["disabled"],_={value:"",disabled:"",selected:""},O=["value"],d={__name:"Select",props:g({dataSource:{type:Array,required:!0},placeholder:{type:String,default:"Select"},suffix:{type:String},isDisabled:{type:Boolean,default:!1},className:{type:String,default:""}},{modelValue:{},modelModifiers:{}}),emits:["update:modelValue"],setup(a){const s=b(a,"modelValue"),e=a,l=v(s);return(E,u)=>(i(),o("div",{class:c({"ded-select-container":!0,[e.className]:!!e.className})},[D(n("select",{class:c(["ded-select",{"ded-select-disabled":e.isDisabled}]),"onUpdate:modelValue":u[0]||(u[0]=t=>l.value=t),disabled:e.isDisabled},[n("option",_,m(e.placeholder),1),(i(!0),o(V,null,h(e.dataSource,t=>(i(),o("option",{key:t.value,value:t.value},m(t.label),9,O))),128))],10,N),[[y,l.value]]),n("div",{class:c(["ded-select-icon",{"ded-select-icon-disabled":e.isDisabled}])},[x($,{name:e.suffix,size:"18"},null,8,["name"])],2)],2))}};d.__docgenInfo={exportName:"default",displayName:"Select",description:"",tags:{},props:[{name:"dataSource",type:{name:"array"},required:!0},{name:"placeholder",type:{name:"string"},defaultValue:{func:!1,value:'"Select"'}},{name:"suffix",type:{name:"string"}},{name:"isDisabled",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"className",type:{name:"string"},defaultValue:{func:!1,value:'""'}}],sourceFiles:["/home/runner/work/DED-WDS_VUE/DED-WDS_VUE/libs/src/ui/element/Select/Select.vue"]};function A(a){return`[
    ${a.map(s=>`{
        label: '${s.label}',
        value: '${s.value}',
    }`).join(`,
