import{_ as u}from"./Avatar-BwbeW5rF.js";import"./vue.esm-bundler-ChZ6yN_a.js";import"./Image-B3FwuHHx.js";import"./index-Bb4qSo10.js";import"./Icon-CVgxzrKG.js";import"./iframe-D0L_qX37.js";import"../sb-preview/runtime.js";const f={title:"Design System/Avatar",component:u,tags:["autodocs"],argTypes:{shape:{description:"形狀",control:{type:"select"},options:["circle","square"],table:{type:{summary:"circle | square"}}},size:{description:"尺寸",control:{type:"select"},options:["xsmall","small","medium","large"],table:{type:{summary:"xsmall | small | medium | large"}}},status:{description:"狀態",control:{type:"select"},options:["none","online","idle","busy","offline"],table:{type:{summary:"none | online | idle | busy | offline"}}},userName:{description:"使用者名稱",control:{type:"text"}},src:{description:"圖片連結",control:{type:"text"}},alt:{description:"圖片描述",control:{type:"text"}},limit:{description:"在 AvatarGroup 中控制顯示的 Avatar 數量上限",control:{type:"number",min:0,max:5,step:1}},className:{description:"客製化樣式",control:{type:"text"}}},parameters:{docs:{title:"Avatar頭像",description:{component:"Avatar 組件的呈現及說明。"}}}},r={name:"預設項目",args:{shape:"circle",size:"large",status:"none",src:"https://picsum.photos/320/240",alt:"alt text",userName:"JonyWu",className:""},render:a=>({components:{Avatar:u},setup(){return{args:a}},template:`
            <Avatar
                :shape="args.shape"
                :size="args.size"
...
`).trim()}}}}},t={name:"頭像形狀",args:{size:"large",status:"none",src:"https://picsum.photos/320/240",alt:"alt text",userName:"JonyWu",className:""},render:a=>({components:{Avatar:u},setup(){return{args:a}},template:`
...
`).trim()}}}}},n={name:"頭像狀態",args:{shape:"circle",size:"large",src:"https://picsum.photos/320/240",alt:"alt text",userName:"JonyWu",className:""},render:a=>({components:{Avatar:u},setup(){return{args:a}},template:`
            <div style="display:flex; gap: 16px">
                <Avatar
                    :shape="args.shape"
                    :size="args.size"
        ...
        `}),parameters:{controls:{exclude:["status","limit"]},docs:{source:{transform:(a,e)=>{const{args:s}=e;return["<Avatar",`  shape="${s.shape}"`,`  size="${s.size}"`,'  status="default"',`  src="${s.src}"`,`  alt="${s.alt}"`,`  userName="${s.userName}"`,`  className="${s.className}"`,"></Avatar>","<Avatar",'  shape="square"',`  size="${s.size}"`,'  status="online"',`  src="${s.src}"`,`  alt="${s.alt}"`,`  userName="${s.userName}"`,`  className="${s.className}"`,"></Avatar>","<Avatar",'  shape="square"',`  size="${s.size}"`,'  status="idle"',`  src="${s.src}"`,`  alt="${s.alt}"`,`  userName="${s.userName}"`,`  className="${s.className}"`,"></Avatar>","<Avatar",'  shape="square"',`  size="${s.size}"`,'  status="busy"',`  src="${s.src}"`,`  alt="${s.alt}"`,`  userName="${s.userName}"`,`  className="${s.className}"`,"></Avatar>","<Avatar",'  shape="square"',`  size="${s.size}"`,'  status="offline"',`  src="${s.src}"`,`  alt="${s.alt}"`,`  userName="${s.userName}"`,`  className="${s.className}"`,"></Avatar>"].join(`
...
}`,...(m=(c=r.parameters)==null?void 0:c.docs)==null?void 0:m.source}}};var o,i,g;t.parameters={...t.parameters,docs:{...(o=t.parameters)==null?void 0:o.docs,source:{originalSource:`{
  name: "頭像形狀",
  args: {
    size: "large",
    status: "none",
...
}`,...(g=(i=t.parameters)==null?void 0:i.docs)==null?void 0:g.source}}};var p,N,v;n.parameters={...n.parameters,docs:{...(p=n.parameters)==null?void 0:p.docs,source:{originalSource:`{
  name: "頭像狀態",
  args: {
    shape: "circle",
    size: "large",
