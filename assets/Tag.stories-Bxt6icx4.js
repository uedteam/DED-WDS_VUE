import{c as k,a as n,b as h,d as m,s as p,t as u,C as F,n as V,o as l,f as b}from"./vue.esm-bundler-BQySH7jJ.js";import{_ as d}from"./Icon-f9eBqVFj.js";import"./iframe-C0k4Wqte.js";import"../sb-preview/runtime.js";const j=["href"],B={key:0,class:"ded-tag-icon"},P={key:1,class:"ded-tag-text"},W={key:0,class:"ded-tag-icon"},o={__name:"Tag",props:{themeColor:{type:String,validator:r=>["primary","secondary","neutral","info","success","warning","error"].includes(r)},variable:{type:String,validator:r=>["filled","ghost"].includes(r)},label:{type:String,required:!0},href:{type:String,default:""},prefix:{type:String},closable:{type:Boolean,default:!0},isDisabled:{type:Boolean,default:!1},className:{type:String,default:""}},emits:["onClose"],setup(r,{emit:s}){const e=s,a=r,f=()=>{a.isDisabled||e("onClose")},A=k(()=>{try{return!!a.href&&new URL(a.href)}catch{return!1}});return(q,I)=>(l(),n("div",{class:V(["ded-tag",{[`ded-tag-${a.variable}`]:a.variable},{[`ded-tag-${a.variable}-${a.themeColor}`]:a.variable&&a.themeColor&&!a.isDisabled},{[`ded-tag-${a.variable}-disabled`]:a.isDisabled},{"ded-tag-closable":a.closable},a.className&&a.className.split(" ")])},[a.href&&A.value?(l(),n("a",{key:0,href:a.href,class:"ded-tag-text"},[a.prefix?(l(),n("span",B,[h(d,{name:a.prefix},null,8,["name"])])):m("",!0),p(" "+u(a.label),1)],8,j)):(l(),n("div",P,[a.prefix?(l(),n("span",W,[h(d,{name:a.prefix},null,8,["name"])])):m("",!0),p(" "+u(a.label),1)])),a.closable?(l(),F(d,{key:2,name:"close",class:"ded-tag-close",onClick:f})):m("",!0)],2))}};o.__docgenInfo={exportName:"default",displayName:"Tag",description:"",tags:{},props:[{name:"themeColor",type:{name:"string"},values:["primary","secondary","neutral","info","success","warning","error"]},{name:"variable",type:{name:"string"},values:["filled","ghost"]},{name:"label",type:{name:"string"},required:!0},{name:"href",type:{name:"string"},defaultValue:{func:!1,value:'""'}},{name:"prefix",type:{name:"string"}},{name:"closable",type:{name:"boolean"},defaultValue:{func:!1,value:"true"}},{name:"isDisabled",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"className",type:{name:"string"},defaultValue:{func:!1,value:'""'}}],events:[{name:"onClose"}],sourceFiles:["/Users/auouser/Desktop/Work_Space/DED-WDS_VUE/libs/src/ui/element/Tag/Tag.vue"]};const L={title:"Component/Tag",component:o,tags:["autodocs"],argTypes:{themeColor:{description:"主題顏色",control:{type:"select"},options:["primary","secondary","neutral","info","success","warning","error"],table:{type:{summary:"primary | secondary | neutral | info | success | warning | error "}}},variable:{description:"變數",required:!0,control:{type:"select"},options:["filled","ghost"],table:{type:{summary:"filled | ghost "}}},label:{description:"超連結",control:{type:"text"}},href:{description:"標籤文字",control:{type:"text"}},prefix:{description:"前置元素",control:{type:"select",labels:{"":"none",home:"home",folder:"folder",academy:"academy","arrow-forward":"arrow-forward","finger-print":"finger-print"}},options:["","home","folder","academy","arrow-forward","finger-print"]},closable:{description:"摸到時顯示關閉",control:{type:"boolean"}},isDisabled:{description:"是否禁用",control:{type:"boolean"}},className:{description:"客製化樣式",control:{type:"text"}},onClose:{description:"關閉事件"}},parameters:{docs:{title:"Tag",description:{component:"Tag 組件的呈現及說明。"}}}},i={name:"預設項目",args:{themeColor:"primary",variable:"filled",label:"Tag",href:"",prefix:"",closable:!0,isDisabled:!1,className:""},render:r=>({components:{Tag:o},setup(){const s=b(!0);return{args:r,showTag:s}},template:`
            <Tag 
                v-if="showTag"
        ...
        `}),parameters:{controls:{},docs:{source:{transform:(r,s)=>{const{args:e}=s;return["<Tag",'  v-if="showTag"',`  themeColor="${e.themeColor}"`,`  variable="${e.variable}"`,`  label="${e.label}"`,`  href="${e.href}"`,`  prefix="${e.prefix}"`,`  :closable="${e.closable}"`,`  :isDisabled="${e.isDisabled}"`,`  className="${e.className}"`,'  @onClose="() => showTag = false">',"</Tag>"].join(`
`).trim()}}}}},t={name:"預設項目",args:{themeColor:"primary",variable:"filled",label:"Tag",href:"",prefix:"academy",closable:!0,isDisabled:!1,className:""},render:r=>({components:{Tag:o},setup(){const s=b(!0);return{args:r,showTag:s}},template:`
            <Tag 
                v-if="showTag"
                 :themeColor="args.themeColor"
                 :variable="args.variable"
        ...
        `}),parameters:{controls:{},docs:{source:{transform:(r,s)=>{const{args:e}=s;return["<Tag",'  v-if="showTag"',`  themeColor="${e.themeColor}"`,`  variable="${e.variable}"`,`  label="${e.label}"`,`  href="${e.href}"`,`  prefix="${e.prefix}"`,`  :closable="${e.closable}"`,`  :isDisabled="${e.isDisabled}"`,`  className="${e.className}"`,'  @onClose="() => showTag = false">',"</Tag>"].join(`
`).trim()}}}}},g={name:"預設項目",args:{themeColor:"primary",variable:"",label:"Tag",href:"",prefix:"",closable:!0,isDisabled:!1,className:""},render:r=>({components:{Tag:o},setup(){const s=b(!0);return{args:r,showTag:s}},template:`
...
}`,...(D=(x=t.parameters)==null?void 0:x.docs)==null?void 0:D.source}}};var w,y,N;g.parameters={...g.parameters,docs:{...(w=g.parameters)==null?void 0:w.docs,source:{originalSource:`{
  name: "預設項目",
  args: {
    themeColor: 'primary',
    variable: "",
