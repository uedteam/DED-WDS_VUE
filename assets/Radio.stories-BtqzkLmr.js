import{m as h,u as E,c as m,F as A,h as _,n as i,o as p,l as j,N as F,a as g,t as k}from"./vue.esm-bundler-qCK_iSPY.js";const B=["value","name"],r={__name:"Radio",props:h({dataSource:{type:Array,required:!0},direction:{type:String,default:"row",validator:a=>["row","column"].includes(a)},size:{type:String,default:"medium",validator:a=>["small","medium","large"].includes(a)},className:{type:String,default:""}},{modelValue:{},modelModifiers:{}}),emits:["update:modelValue"],setup(a){const o=E(a,"modelValue"),e=a;return(s,S)=>(p(),m("div",{class:i({"ded-radio-container":!0,[`ded-radio-container-${e.direction}`]:e.direction,[e.className]:!!e.className})},[(p(!0),m(A,null,_(e.dataSource,(n,C)=>(p(),m("label",{key:C,class:i(["ded-radio",{"ded-radio-input-disabled":n.isDisabled,[`ded-text-${e.size}`]:e.size}])},[j(g("input",{class:"ded-radio-input",type:"radio",value:n.value,name:n.name,"onUpdate:modelValue":S[0]||(S[0]=w=>o.value=w)},null,8,B),[[F,o.value]]),g("div",{class:i({"ded-radio-icon":!0,[`ded-icon-${e.size}`]:e.size,"ded-radio-icon-disabled":n.isDisabled,"ded-radio-checked":o.value===n.value,"ded-radio-unchecked":o.value!==n.value})},null,2),g("span",{class:i(["ded-radio-text",n.isDisabled?"ded-radio-text-disabled":""])},k(n.label),3)],2))),128))],2))}};r.__docgenInfo={exportName:"default",displayName:"Radio",description:"",tags:{},props:[{name:"dataSource",type:{name:"array"},required:!0},{name:"direction",type:{name:"string"},defaultValue:{func:!1,value:'"row"'},values:["row","column"]},{name:"size",type:{name:"string"},defaultValue:{func:!1,value:'"medium"'},values:["small","medium","large"]},{name:"className",type:{name:"string"},defaultValue:{func:!1,value:'""'}}],sourceFiles:["/Users/auouser/Desktop/Work_Space/DED-WDS_VUE/libs/src/ui/element/Radio/Radio.vue"]};function u(a){return`[
    ${a.map(o=>`{
        label: '${o.label}',
        value: '${o.value}'
    ...
    `)}
        ...
        `}),parameters:{controls:{},docs:{source:{transform:(a,o)=>{const{args:e}=o;return["<Radio",`  :dataSource="${u(e.dataSource)}"`,`  direction="${e.direction}"`,`  size="${e.size}"`,`  className="${e.className}"`,'  v-model="modelValue"',"></Radio>"].join(`
...
`).trim()}}}}},c={name:"元件尺寸",args:{dataSource:[{label:"Option1",value:"option1",isDisabled:!1},{label:"Option2",value:"option2",isDisabled:!1},{label:"Option3",value:"option3",isDisabled:!1}],direction:"row",className:"",modelValue:"option1"},render:a=>({components:{Radio:r},setup(){return{args:a}},template:`
        ...
        `}),parameters:{controls:{expanded:!0,exclude:["size"]},docs:{source:{transform:(a,o)=>{const{args:e}=o,s=u(e.dataSource);return["<Radio",`  :dataSource="${s}"`,`  direction="${e.direction}"`,'  size="large"',`  className="${e.className}"`,'  v-model="modelValue"',"></Radio>","<Radio",`  :dataSource="${s}"`,`  direction="${e.direction}"`,'  size="medium"',`  className="${e.className}"`,'  v-model="modelValue"',"></Radio>","<Radio",`  :dataSource="${s}"`,`  direction="${e.direction}"`,'  size="small"',`  className="${e.className}"`,'  v-model="modelValue"',"></Radio>"].join(`
...
}`,...(b=(R=t.parameters)==null?void 0:R.docs)==null?void 0:b.source}}};var N,f,z;l.parameters={...l.parameters,docs:{...(N=l.parameters)==null?void 0:N.docs,source:{originalSource:`{
  name: "垂直排列",
  args: {
    // themeColor: 'primary',
    dataSource: [{
...
}`,...(z=(f=l.parameters)==null?void 0:f.docs)==null?void 0:z.source}}};var y,D,$;d.parameters={...d.parameters,docs:{...(y=d.parameters)==null?void 0:y.docs,source:{originalSource:`{
  name: "水平排列",
  args: {
    // themeColor: 'primary',
    dataSource: [{
...
}`,...($=(D=d.parameters)==null?void 0:D.docs)==null?void 0:$.source}}};var V,x,O;c.parameters={...c.parameters,docs:{...(V=c.parameters)==null?void 0:V.docs,source:{originalSource:`{
  name: "元件尺寸",
  args: {
    // themeColor: 'primary',
    dataSource: [{
