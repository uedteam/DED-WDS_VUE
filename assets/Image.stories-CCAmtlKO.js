import{_ as o}from"./Image-C96WqIEk.js";import{a as h,b as x,_ as b}from"./Column-BeQtJE1y.js";import"./vue.esm-bundler-qCK_iSPY.js";const F={title:"Component/Image",component:o,tags:["autodocs"],argTypes:{src:{description:"圖片來源",control:{type:"text"}},alt:{description:"圖片替代文字",control:{type:"text"}},ratio:{description:"圖片比例",control:{type:"select"},options:["1x1","4x3","5x4","16x9"],table:{type:{summary:"1x1 | 4x3 | 5x4 | 16x9"}}},objectFit:{description:"圖片填滿方式",control:{type:"select"},options:["none","cover","contain","fill"],table:{type:{summary:"none | cover | contain | fill"}}},className:{description:"客製化樣式",control:{type:"text"}}},parameters:{docs:{title:"圖片",description:{component:"圖片組件的呈現及說明。"}}}},e={name:"預設項目",args:{src:"https://picsum.photos/300/200?random=1",alt:"placeholder",ratio:"1x1",objectFit:"cover",className:""},render:a=>({components:{Image:o,Grid:h,Row:x,Column:b},setup(){return{args:a}},template:`
            <Grid fluid>
                <Row hasGap>
...
`).trim()}}}}},n={name:"圖片比例",args:{src:"https://picsum.photos/300/200?random=1",alt:"",objectFit:"cover",className:""},render:a=>({components:{Image:o},setup(){return{args:a}},template:`
...
}`,...(f=(u=r.parameters)==null?void 0:u.docs)==null?void 0:f.source}}};const y=["ImageDefault","ImageRatio","ImageFit"];export{e as ImageDefault,r as ImageFit,n as ImageRatio,y as __namedExportsOrder,F as default};
