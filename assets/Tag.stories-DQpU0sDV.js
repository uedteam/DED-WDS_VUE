...
`).trim()}}}}},o={name:"主題色彩",args:{prefix:"",closable:!0,isDisabled:!1,className:""},render:r=>({components:{Tag:n},setup(){const s=D([{id:1,themeColor:"primary",label:"primary"},{id:2,themeColor:"secondary",label:"secondary"},{id:3,themeColor:"tertiary",label:"tertiary"},{id:4,themeColor:"success",label:"success"},{id:5,themeColor:"warning",label:"warning"},{id:6,themeColor:"error",label:"error"},{id:7,themeColor:"info",label:"info"}]);return{args:r,tagsData:s,removeTag:a=>{s.value=s.value.filter(i=>i.id!==a)}}},template:`
            <div style="display:flex; gap: 8px; flex-wrap: wrap">
...
`).trim()}}}}};var b,u,f;l.parameters={...l.parameters,docs:{...(b=l.parameters)==null?void 0:b.docs,source:{originalSource:`{
  name: "預設項目",
  args: {
    themeColor: 'primary',
    label: 'Tag',
...
}`,...(f=(u=l.parameters)==null?void 0:u.docs)==null?void 0:f.source}}};var T,y,C;o.parameters={...o.parameters,docs:{...(T=o.parameters)==null?void 0:T.docs,source:{originalSource:`{
  name: "主題色彩",
  args: {
    // themeColor: '',
    // label:'',
...
}`,...(C=(y=o.parameters)==null?void 0:y.docs)==null?void 0:C.source}}};const V=["TagDefaultStory","TagMultiple"];export{l as TagDefaultStory,o as TagMultiple,V as __namedExportsOrder,A as default};
