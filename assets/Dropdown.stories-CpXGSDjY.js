import{m as x,u as $,e as m,a as d,t as p,f as g,b as f,n as u,j as _,g as b,E as N,o,F as V,k as z}from"./vue.esm-bundler-_3atnb9w.js";import{_ as H}from"./Icon-CAH_ZwBp.js";import{_ as k}from"./ListItem-BI-MxbsN.js";import{_ as C}from"./List-BSGJT1qL.js";import"./iframe-CeK3pwPU.js";import"../sb-preview/runtime.js";const E={class:"ded-dropdown-container"},O={key:0,class:"ded-input-label"},c={__name:"Dropdown",props:x({dataSource:{type:Array,default:()=>[]},label:{type:String,default:""},placeholder:{type:String,default:"Placeholder..."},size:{type:String,validator:a=>["small","medium","large"].includes(a),default:"medium"},maxHeight:{type:String},className:{type:String,default:""}},{modelValue:{},modelModifiers:{}}),emits:["update:modelValue"],setup(a){$(a,"modelValue");const e=a,l=m(null),t=m(!1),S=i=>{l.value=i,t.value=!t};return(i,n)=>(o(),d("div",E,[e.label?(o(),d("label",O,p(e.label),1)):g("",!0),f("div",{ref:"dropdown",class:u(["ded-dropdown",`ded-dropdown-${e.size}`]),role:"listbox",tabindex:"0",onClick:n[0]||(n[0]=r=>t.value=!t.value)},[f("span",{class:u(l.value?"ded-dropdown-selectValue-select":"ded-dropdown-selectValue-unselect")},p(l.value||e.placeholder),3),_(H,{class:u(`ded-icon-${a.size}`),style:{"margin-left":"auto"},name:"arrow_down"},null,8,["class"])],2),t.value?(o(),b(C,{key:1,className:"",isMenu:!0,maxHeight:e.maxHeight},{default:N(()=>[(o(!0),d(V,null,z(e.dataSource,(r,v)=>(o(),b(k,{key:v,label:r.label,value:r.value,href:r.href,onSelectedItem:n[1]||(n[1]=w=>S(w))},null,8,["label","value","href"]))),128))]),_:1},8,["maxHeight"])):g("",!0)]))}};c.__docgenInfo={exportName:"default",displayName:"Dropdown",description:"",tags:{},props:[{name:"dataSource",type:{name:"array"},defaultValue:{func:!1,value:"[]"}},{name:"label",type:{name:"string"},defaultValue:{func:!1,value:'""'}},{name:"placeholder",type:{name:"string"},defaultValue:{func:!1,value:'"Placeholder..."'}},{name:"size",type:{name:"string"},defaultValue:{func:!1,value:'"medium"'},values:["small","medium","large"]},{name:"maxHeight",type:{name:"string"}},{name:"className",type:{name:"string"},defaultValue:{func:!1,value:'""'}}],sourceFiles:["D:/98_測試/up/DED-WDS_VUE/libs/src/ui/element/Dropdown/Dropdown.vue"]};function j(a){return`[
    ${a.map(e=>`{
        label: '${e.label}',
        value: '${e.value}',
    }`).join(`,
...
}`,...(D=(y=s.parameters)==null?void 0:y.docs)==null?void 0:D.source}}};const T=["DropdownDefault"];export{s as DropdownDefault,T as __namedExportsOrder,I as default};
