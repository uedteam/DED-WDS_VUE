...
`).trim()}}}}},c={name:"主題色彩",args:{checkLabel:"on",unCheckLabel:"off",isDisabled:!1,className:"",modelValue:!0},render:l=>({components:{Toggle:o},setup(){return{args:l}},template:`
      <div style="display: flex; gap: 16px">
        <Toggle
          themeColor="primary"
          :checkLabel="args.checkLabel"
