import{p as h,u as A,c as S,F as B,q as j,n as i,o as f,x as F,a as v,K as k,s as U,t as I}from"./vue.esm-bundler-CC1hEtM-.js";const M=["for"],q=["id","value","name"],n=Object.assign({inheritAttrs:!1},{__name:"Radio",props:h({dataSource:{type:Array,required:!0},direction:{type:String,default:"row",validator:o=>["row","column"].includes(o)},size:{type:String,default:"medium",validator:o=>["small","medium","large"].includes(o)},className:{type:String,default:""}},{modelValue:{},modelModifiers:{}}),emits:["update:modelValue"],setup(o){const a=o,e=crypto.randomUUID(),s=p=>`${e}-radio-${p}`,t=A(o,"modelValue");return(p,R)=>(f(),S("div",{class:i(["ded-radio-container",{[`ded-radio-container-${a.direction}`]:a.direction,[a.className]:!!a.className}])},[(f(!0),S(B,null,j(a.dataSource,(r,g)=>(f(),S("label",{key:g,class:i(["ded-radio",{"ded-radio-input-disabled":r.isDisabled,[`ded-text-${a.size}`]:a.size}]),for:s(g)},[F(v("input",U({ref_for:!0},p.$attrs,{id:s(g),"onUpdate:modelValue":R[0]||(R[0]=_=>t.value=_),class:"ded-radio-input",type:"radio",value:r.value,name:r.name}),null,16,q),[[k,t.value]]),v("div",{class:i(["ded-radio-icon",{[`ded-icon-${a.size}`]:a.size,"ded-radio-icon-disabled":r.isDisabled,"ded-radio-checked":t.value===r.value,"ded-radio-unchecked":t.value!==r.value}])},null,2),v("span",{class:i(["ded-radio-text",r.isDisabled?"ded-radio-text-disabled":""])},I(r.label),3)],10,M))),128))],2))}});n.__docgenInfo={exportName:"default",displayName:"Radio",description:"",tags:{},props:[{name:"dataSource",type:{name:"array"},required:!0},{name:"direction",type:{name:"string"},defaultValue:{func:!1,value:'"row"'},values:["row","column"]},{name:"size",type:{name:"string"},defaultValue:{func:!1,value:'"medium"'},values:["small","medium","large"]},{name:"className",type:{name:"string"},defaultValue:{func:!1,value:'""'}}],sourceFiles:["/home/runner/work/DED-WDS_VUE/DED-WDS_VUE/libs/src/ui/element/Radio/Radio.vue"]};function m(o){return`    ${o.map(a=>`{
        label: "${a.label}",
        value: "${a.value}",
...
}`,...(E=(C=u.parameters)==null?void 0:C.docs)==null?void 0:E.source}}};const L=["RadioDefaultStory","RadioVerticalStory","RadioRowStory","RadioSizeStory"];export{d as RadioDefaultStory,c as RadioRowStory,u as RadioSizeStory,l as RadioVerticalStory,L as __namedExportsOrder,K as default};
