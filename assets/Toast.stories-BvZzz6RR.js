import{m as L,g as x,O as R,P as U,c,q as I,L as T,F as b,o as i,j as w,a as g,b as p,e as y,d as A,n as k,f as q,t as N,l as _,T as G,h as J}from"./vue.esm-bundler-CC1hEtM-.js";import{v as K}from"./v4-CtRu48qb.js";import{_ as f}from"./Button-BQvgxunf.js";import{_ as u}from"./Icon-DU5IBFbg.js";import{_ as S}from"./Title-D83mi5Li.js";const s=R({"top-right":[],"top-left":[],"top-center":[],"bottom-right":[],"bottom-left":[],"bottom-center":[]}),Q=x(()=>Object.keys(s)),d=new Map,r=new Map;function X(e){if(r.has(e))return r.get(e);const o=document.createElement("div");return o.id=`toast-container-${e}`,o.classList.add("ded-toast-container",`ded-toast-${e}`),document.body.appendChild(o),r.set(e,o),o}function F(e,o){if(!s[o])return;d.has(e)&&(clearTimeout(d.get(e)),d.delete(e));const t=s[o].findIndex(a=>a.id===e);if(t!==-1&&(s[o].splice(t,1),s[o].length===0&&r.has(o))){const a=r.get(o);document.body.removeChild(a),r.delete(o)}}function Y(e){const o=`toast-${K()}`,t=e.position||"top-right";Array.isArray(s[t])||(s[t]=R([])),X(t);const a={...e,id:o,action:e.action||null};if(s[t].push(a),e.duration&&e.duration>0){const m=setTimeout(()=>{F(o,t)},e.duration);d.set(o,m)}}function Z(){d.forEach(e=>clearTimeout(e)),d.clear(),Object.keys(s).forEach(e=>{if(s[e].splice(0,s[e].length),r.has(e)){const o=r.get(e);document.body.removeChild(o),r.delete(e)}})}function H(){const e=L("useToast",null);if(e)return e;const o={add:Y,remove:F,clear:Z,toasts:s,positions:Q};return U("useToast",o),o}const tt={class:"ded-toast-header"},et={key:0,class:"ded-toast-header-action"},ot={key:1},nt={class:"ded-description"},l={__name:"Toast",props:{className:{type:String,default:""}},setup(e){const o=e,{toasts:t,remove:a,positions:m}=H();return(B,st)=>(i(!0),c(b,null,I(T(m),$=>(i(),c("div",{key:$},[(i(!0),c(b,null,I(T(t)[$],n=>(i(),c("div",{key:n.id},[(i(),w(G,{to:`#toast-container-${n.position}`},[g("div",{class:k(["ded-toast",[`ded-toast-border-${n.themeColor}`,o.className]])},[p(f,{class:"ded-close-button",variant:"text","theme-color":"neutral",onClick:at=>T(a)(n.id,$)},{default:y(()=>[p(u,{name:"SvgClose",size:"20"})]),_:2},1032,["onClick"]),g("div",tt,[g("div",{class:k(["ded-toast-header-message",[`ded-toast-header-message-${n.themeColor}`]])},[p(u,{name:n.prefix,size:"20"},null,8,["name"]),p(S,{"theme-color":n.themeColor,level:5},{default:y(()=>[q(N(n.title),1)]),_:2},1032,["theme-color"])],2),n.action?(i(),c("div",et,[typeof n.action=="object"?(i(),w(_(n.action),{key:0})):typeof n.action=="function"?(i(),c("div",ot,[(i(),w(_(n.action())))])):A("",!0)])):A("",!0)]),g("p",nt,N(n.content),1)],2)],8,["to"]))]))),128))]))),128))}};l.__docgenInfo={exportName:"default",displayName:"Toast",description:"",tags:{},props:[{name:"className",type:{name:"string"},defaultValue:{func:!1,value:'""'}}],sourceFiles:["/Users/auouser/Desktop/Work_Space/DED-WDS_VUE/libs/src/ui/element/Toast/Toast.vue"]};const ut={components:{Icon:u,Toast:l},title:"Component/Toast",component:l,tags:["autodocs"],argTypes:{themeColor:{description:"主題顏色",control:{type:"select"},options:["primary","secondary","neutral","info","success","warning","error"],table:{type:{summary:"primary | secondary | neutral | info | success | warning | error"},defaultValue:{summary:"primary"},category:"PROPS"}},position:{description:"位置",control:{type:"select"},options:["top-right","top-left","top-center","bottom-right","bottom-left","bottom-center"],table:{type:{summary:"top-right | top-left | top-center | bottom-right | bottom-left | bottom-center"},defaultValue:{summary:"top-right"},category:"PROPS"}},title:{description:"內容",control:{type:"text"},table:{category:"PROPS"}},content:{description:"說明文字",control:{type:"text"},table:{defaultValue:{summary:"Content"},category:"PROPS"}},prefix:{description:"前綴元素",control:{type:"select",labels:{"":"none",SvgInfoCircle:"SvgInfoCircle",SvgSuccessCircle:"SvgSuccessCircle",SvgWarningTri:"SvgWarningTri",SvgErrorCircle:"SvgErrorCircle",SvgDisableCircle:"SvgDisableCircle"}},options:["","SvgInfoCircle","SvgSuccessCircle","SvgWarningTri","SvgErrorCircle","SvgDisableCircle"],table:{defaultValue:{summary:""},category:"PROPS"}},duration:{description:"持續時間",control:{type:"range",min:500,max:5e3,step:100},table:{defaultValue:{summary:1e3},category:"PROPS"}},action:{description:"操作",control:{type:"text"},table:{type:{summary:"Vue Component"},category:"SLOTS"}},className:{description:"客製化樣式",control:{type:"text"},table:{category:"PROPS"}}},parameters:{docs:{title:"Toast",description:{component:"通知訊息組件的呈現及說明。"}}}},v={name:"預設項目",args:{themeColor:"success",position:"top-right",title:"Notification Title",content:"Content",prefix:"SvgSuccessCircle",duration:1e3,action:'() => h ("div", {onClick: () => window.alert("action")}, "Action")',className:""},render:e=>({components:{Toast:l,Button:f,Title:S,Icon:u},setup(){const o=()=>{window.alert("Close")},t=x(()=>`ded-toast-border-${e.themeColor}`),a=x(()=>`ded-toast-header-message-${e.themeColor}`);return{args:e,onClose:o,toastBorderClass:t,toastHeaderMsgThemeClass:a,onAction:()=>{window.alert("Action")}}},template:`
...
`).trim()}}}}},h={name:"訊息類型",args:{position:"top-right",title:"Notification Title",content:"Content",duration:5e3,action:'() => h ("div", {onClick: () => window.alert("action")}, "Action")',className:""},render:e=>({components:{Toast:l,Button:f,Title:S,Icon:u},setup(){return{args:e,onClose:()=>{window.alert("Close")},onAction:()=>{window.alert("Action")}}},template:`
...
`).trim()}}}}},C={name:"互動模式",args:{themeColor:"success",position:"top-right",title:"Notification Title",content:"Content",prefix:"SvgSuccessCircle",duration:5e3,action:'() => h ("div", {onClick: () => window.alert("action")}, "Action")',className:""},render:e=>({components:{Toast:l,Button:f},setup(){const{add:o}=H();return{args:e,add:o,showToast:()=>{o({themeColor:e.themeColor,position:e.position,title:e.title,content:e.content,prefix:e.prefix,duration:e.duration,action:()=>J("div",{onClick:()=>window.alert("action")},"Action")})},onAction:()=>{window.alert("Action")}}},template:`
...
`).trim()}}}}};var z,D,E;v.parameters={...v.parameters,docs:{...(z=v.parameters)==null?void 0:z.docs,source:{originalSource:`{
  name: "預設項目",
  args: {
    themeColor: "success",
    position: "top-right",
