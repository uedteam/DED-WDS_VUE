import{m as g,u as b,s as v,c as o,v as y,a as n,J as D,t as m,F as V,p as x,n as c,b as h,o as i}from"./vue.esm-bundler-C-J3VMH8.js";import{_ as $}from"./Icon-zSSehsRW.js";const N=["disabled"],_={value:"",disabled:"",selected:""},O=["value"],u={__name:"Select",props:g({dataSource:{type:Array,required:!0},placeholder:{type:String,default:"Select"},suffix:{type:String},isDisabled:{type:Boolean,default:!1},className:{type:String,default:""}},{modelValue:{},modelModifiers:{}}),emits:["update:modelValue"],setup(s){const e=s,a=b(s,"modelValue"),r=v(a);return(w,d)=>(i(),o("div",{class:c(["ded-select-container",{[e.className]:!!e.className}])},[y(n("select",{"onUpdate:modelValue":d[0]||(d[0]=l=>r.value=l),class:c(["ded-select",{"ded-select-disabled":e.isDisabled}]),disabled:e.isDisabled},[n("option",_,m(e.placeholder),1),(i(!0),o(V,null,x(e.dataSource,l=>(i(),o("option",{key:l.value,value:l.value},m(l.label),9,O))),128))],10,N),[[D,r.value]]),n("div",{class:c(["ded-select-icon",{"ded-select-icon-disabled":e.isDisabled}])},[h($,{name:e.suffix,size:"18"},null,8,["name"])],2)],2))}};u.__docgenInfo={exportName:"default",displayName:"Select",description:"",tags:{},props:[{name:"dataSource",type:{name:"array"},required:!0},{name:"placeholder",type:{name:"string"},defaultValue:{func:!1,value:'"Select"'}},{name:"suffix",type:{name:"string"}},{name:"isDisabled",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"className",type:{name:"string"},defaultValue:{func:!1,value:'""'}}],sourceFiles:["/Users/auouser/Desktop/Work_Space/DED-WDS_VUE/libs/src/ui/element/Select/Select.vue"]};function A(s){return`    ${s.map(e=>`{
        label: "${e.label}",
        value: "${e.value}",
    }`).join(`,
    `)}`}const j={title:"Component/Select",component:u,tags:["autodocs"],argTypes:{dataSource:{description:"選項",control:{type:"object"},table:{type:{summary:"{ label: string; value: string | number; }[]"}}},placeholder:{description:"輸入提示",control:{type:"text"}},suffix:{description:"後綴圖示",control:{type:"select",labels:{"":"none",SvgAccount:"SvgAccount",SvgSearch:"SvgSearch",SvgVisibility:"SvgVisibility",SvgVisibilityOff:"SvgVisibilityOff"}},options:["","SvgAccount","SvgSearch","SvgVisibility","SvgVisibilityOff"]},isDisabled:{description:"是否禁用",control:{type:"boolean"}},className:{description:"客製化樣式",control:{type:"text"}},modelValue:{description:"值",control:{type:"select",labels:{"":"none",1:"1",2:"2",3:"3"}},options:["","1","2","3"],table:{type:{summary:"string | number"},category:"v-model"}}},parameters:{docs:{title:"Select",description:{component:"選擇組件的呈現及說明。"}}}},t={name:"預設項目",args:{dataSource:[{label:"Option 1",value:"1"},{label:"Option 2",value:"2"},{label:"Option 3",value:"3"}],placeholder:"Select",suffix:"SvgArrowDropDown",isDisabled:!1,className:"",modelValue:""},render:s=>({components:{Select:u},setup(){return{args:s}},template:`
      <Select
...
}`,...(S=(f=t.parameters)==null?void 0:f.docs)==null?void 0:S.source}}};const k=["SelectDefault"];export{t as SelectDefault,k as __namedExportsOrder,j as default};
