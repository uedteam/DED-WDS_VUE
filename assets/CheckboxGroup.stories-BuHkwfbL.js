import{_ as i}from"./Checkbox-UIa6NIzB.js";import{o as c,c as u,g as m,n as p}from"./vue.esm-bundler-qOdkfnRX.js";import"./Icon-BtJRrXYV.js";import"./iframe-Ba4IZKZl.js";import"../sb-preview/runtime.js";const s={__name:"CheckboxGroup",props:{direction:{type:String,validator:e=>["row","column"].includes(e),default:"row"},className:{type:String,default:""}},setup(e){const a=e;return(r,d)=>(c(),u("div",{class:p({"checkbox-container":!0,[`checkbox-container-${a.direction}`]:!0,[a.className]:!!a.className})},[m(r.$slots,"default")],2))}};s.__docgenInfo={exportName:"default",displayName:"CheckboxGroup",description:"",tags:{},props:[{name:"direction",type:{name:"string"},defaultValue:{func:!1,value:"'row'"},values:["row","column"]},{name:"className",type:{name:"string"},defaultValue:{func:!1,value:"''"}}],slots:[{name:"default"}],sourceFiles:["D:/98_測試/up/DED-WDS_VUE/libs/src/ui/element/Checkbox/CheckboxGroup.vue"]};const x={title:"Design System/CheckboxGroup",component:i,excludeStories:/.*Data$/,tags:["autodocs"],argTypes:{direction:{description:"方向",control:{type:"select"},options:["row","column"]},themeColor:{description:"主題顏色",control:{type:"select"},options:["primary","secondary","tertiary","success","warning","error","info"]},className:{description:"客製化樣式",control:{type:"text"}},options:{description:"選項",control:{type:"array"}}},parameters:{docs:{title:"複選框",description:{component:"複選框組件的呈現及說明。"}}}},n={name:"checkbox 複選樣式",args:{direction:"row",themeColor:"primary",options:[{label:"HTML",id:"html",value:"HTML",name:"skills"},{label:"Sass",id:"sass",value:"Sass",name:"skills"},{label:"Tailwind CSS",id:"tailwind css",value:"Tailwind CSS",name:"skills"},{label:"JavaScript",id:"javascript",value:"JavaScript",name:"skills"},{label:"TypeScript",id:"typescript",value:"TypeScript",name:"skills"},{label:"Vue",id:"vue",value:"Vue",name:"skills"},{label:"React",id:"react",value:"React",name:"skills"},{label:"Angular",id:"angular",value:"Angular",name:"skills"}]},render:e=>({components:{Checkbox:i,CheckboxGroup:s},setup(){return{args:e}},template:`
