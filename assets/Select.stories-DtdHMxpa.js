import{m as g,u as b,k as v,c as r,l as y,M as D,a as n,t as m,F as V,h as x,n as c,b as h,o as i}from"./vue.esm-bundler-qCK_iSPY.js";import{_ as N}from"./Icon-DK8hP1Y7.js";import"./iframe-BZcle8FH.js";import"../sb-preview/runtime.js";const _=["disabled"],$={value:"",disabled:"",selected:""},O=["value"],u={__name:"Select",props:g({dataSource:{type:Array,required:!0},placeholder:{type:String,default:"Select"},suffix:{type:String},isDisabled:{type:Boolean,default:!1},className:{type:String,default:""}},{modelValue:{},modelModifiers:{}}),emits:["update:modelValue"],setup(a){const s=b(a,"modelValue"),e=a,o=v(s);return(E,d)=>(i(),r("div",{class:c({"ded-select-container":!0,[e.className]:!!e.className})},[y(n("select",{class:c(["ded-select",{"ded-select-disabled":e.isDisabled}]),"onUpdate:modelValue":d[0]||(d[0]=l=>o.value=l),disabled:e.isDisabled},[n("option",$,m(e.placeholder),1),(i(!0),r(V,null,x(e.dataSource,l=>(i(),r("option",{key:l.value,value:l.value},m(l.label),9,O))),128))],10,_),[[D,o.value]]),n("div",{class:c(["ded-select-icon",{"ded-select-icon-disabled":e.isDisabled}])},[h(N,{name:e.suffix,size:"18"},null,8,["name"])],2)],2))}};u.__docgenInfo={exportName:"default",displayName:"Select",description:"",tags:{},props:[{name:"dataSource",type:{name:"array"},required:!0},{name:"placeholder",type:{name:"string"},defaultValue:{func:!1,value:'"Select"'}},{name:"suffix",type:{name:"string"}},{name:"isDisabled",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"className",type:{name:"string"},defaultValue:{func:!1,value:'""'}}],sourceFiles:["/Users/auouser/Desktop/Work_Space/DED-WDS_VUE/libs/src/ui/element/Select/Select.vue"]};function A(a){return`[
    ${a.map(s=>`{
        label: '${s.label}',
        value: '${s.value}',
    }`).join(`,
