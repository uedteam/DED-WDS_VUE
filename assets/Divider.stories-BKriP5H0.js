import{a as c,r as V,d as S,n as j,o as g}from"./vue.esm-bundler-sK8WeL-9.js";const E={key:0,class:"ded-divider-content"},a={__name:"Divider",props:{width:{type:String,default:"",validator:i=>["1px","2px","3px","4px","5px"].includes(i)},type:{type:String,default:"solid",validator:i=>["solid","dashed","dotted"].includes(i)},direction:{type:String,default:"horizontal",validator:i=>["horizontal","vertical"].includes(i)},align:{type:String,default:"center",validator:i=>["start","center","end"].includes(i)},className:{type:String,default:""}},setup(i){const r=i;return(e,_)=>(g(),c("div",{class:j(["ded-divider",`ded-divider-${r.direction}`,`ded-divider-${r.width}`,`ded-divider-${r.type}`,e.$slots.default?`ded-divider-${r.align}`:"",...r.className.split(" ")])},[e.$slots.default&&e.$slots.default().some(A=>{var o;return(o=A.children)==null?void 0:o.trim()})?(g(),c("div",E,[V(e.$slots,"default")])):S("",!0)],2))}};a.__docgenInfo={exportName:"default",displayName:"Divider",description:"",tags:{},props:[{name:"width",type:{name:"string"},defaultValue:{func:!1,value:'""'},values:["1px","2px","3px","4px","5px"]},{name:"type",type:{name:"string"},defaultValue:{func:!1,value:'"solid"'},values:["solid","dashed","dotted"]},{name:"direction",type:{name:"string"},defaultValue:{func:!1,value:'"horizontal"'},values:["horizontal","vertical"]},{name:"align",type:{name:"string"},defaultValue:{func:!1,value:'"center"'},values:["start","center","end"]},{name:"className",type:{name:"string"},defaultValue:{func:!1,value:'""'}}],slots:[{name:"default"}],sourceFiles:["/Users/auouser/Desktop/Work_Space/DED-WDS_VUE/libs/src/ui/element/Divider/Divider.vue"]};const k={title:"Component/Divider",component:a,tags:["autodocs"],argTypes:{width:{description:"線條寬度",control:{type:"select"},options:["1px","2px","3px","4px","5px"],table:{type:{summary:"1px | 2px | 3px | 4px | 5px"}}},type:{description:"線條樣式",control:{type:"select"},defaultValue:"solid",options:["solid","dashed","dotted"],table:{type:{summary:"solid | dashed | dotted"}}},direction:{description:"線條方向",control:{type:"select"},defaultValue:"horizontal",options:["horizontal","vertical"],table:{type:{summary:"horizontal | vertical"}}},align:{description:"文字位置",control:{type:"select"},options:["start","center","end"],table:{type:{summary:"start | center | end"}}},className:{description:"客製化樣式",control:{type:"text"}},default:{description:"分隔線內容",control:{type:"text"}}},parameters:{docs:{title:"Divider",description:{component:"Divider 組件的呈現及說明。"}}}},t={name:"預設項目",args:{width:"1px",type:"solid",direction:"horizontal",align:"center",default:"Divider",className:""},render:i=>({components:{Divider:a},setup(){return{args:i}},template:`
                <Divider
                    :width="args.width"
                    :type="args.type"
...
`).trim()}}}}},n={name:"文字對齊",args:{width:"1px",type:"solid",className:""},render:i=>({components:{Divider:a},setup(){return{args:i}},template:`
...
`).trim()}}}}},l={name:"線條方向",args:{themeColor:"",width:"1px",type:"solid",className:""},render:i=>({components:{Divider:a},setup(){return{args:i}},template:`
...
}`,...(b=(z=l.parameters)==null?void 0:z.docs)==null?void 0:b.source}}};const B=["DividerDefault","DividerContent","DividerWidth","DividerTypes","DividerDirection"];export{n as DividerContent,t as DividerDefault,l as DividerDirection,d as DividerTypes,s as DividerWidth,B as __namedExportsOrder,k as default};
