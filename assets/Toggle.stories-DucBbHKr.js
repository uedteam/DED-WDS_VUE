...
`).trim()}}}}},n={name:"主題色彩",args:{checkLabel:"on",unCheckLabel:"off",isChecked:!0,isDisabled:!1,className:""},render:s=>({components:{Toggle:o},setup(){return{args:s}},template:`<div style="display:flex; gap: 16px">
                <Toggle
                    themeColor="primary"
                    :checkLabel="args.checkLabel"
                    :unCheckLabel="args.unCheckLabel"
