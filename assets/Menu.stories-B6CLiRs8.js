import{_ as l}from"./Menu-DeFoD8LO.js";import"./vue.esm-bundler-BHaSr8M7.js";import"./Icon-BoC-4iYi.js";import"./iframe-gnUhrdvU.js";import"../sb-preview/runtime.js";function c(a){return`[
    ...
    `)}
        ...
        `}),parameters:{controls:{exclude:["navItemClick","expandedNav"]},docs:{source:{transform:(a,n)=>{const{args:e}=n,i=c(e.dataSource);return["<div",`  :style="${e.isCollapsed?"width:40px":"width:auto"}"`,">","  <Menu",`    :dataSource="${i}"`,`    :isCollapsed="${e.isCollapsed}"`,`    color="${e.color}"`,`    className="${e.className}"`,"  ></Menu>","</div>"].join(`
