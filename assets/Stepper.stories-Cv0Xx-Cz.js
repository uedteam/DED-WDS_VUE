import{g as A,c as a,a as s,F as w,j as _,t as u,n as v,o as c,d as x}from"./vue.esm-bundler-CScppja8.js";import{_ as P}from"./Button-CM8vu3vj.js";import"./Icon-Dil69s3n.js";const j={class:"ded-stepper-header"},k={class:"ded-step-circle"},z={class:"ded-step-group"},E={class:"ded-step-title"},F={key:0,class:"ded-step-description"},M={key:0,class:"ded-step-connector"},V={class:"ded-stepper-content"},p={__name:"Stepper",props:{dataSource:{type:Array,required:!0},currentStep:{type:Number,required:!0},direction:{type:String,default:"horizontal",validator:e=>["horizontal","vertical"].includes(e)},className:{type:String,default:""}},setup(e){const t=e,r=A(()=>o=>o===t.currentStep?"ded-step-active":o<t.currentStep?"ded-step-completed":"");return(o,n)=>{var f;return c(),a("div",{class:v({"ded-stepper":!0,[`ded-stepper-${t.direction}`]:t.direction,[t.className]:!!t.className})},[s("div",j,[(c(!0),a(w,null,_(t.dataSource,(m,i)=>(c(),a("div",{key:i,class:v(["ded-step",r.value(i)])},[s("div",k,u(i+1),1),s("div",z,[s("div",E,u(m.title),1),m.desc?(c(),a("div",F,u(m.desc),1)):x("",!0)]),e.direction==="vertical"&&i!==e.dataSource.length-1?(c(),a("div",M)):x("",!0)],2))),128))]),s("div",V,u(((f=e.dataSource[e.currentStep])==null?void 0:f.content)||"No content available for this step."),1)],2)}}};p.__docgenInfo={exportName:"default",displayName:"Stepper",description:"",tags:{},props:[{name:"dataSource",type:{name:"array"},required:!0},{name:"currentStep",type:{name:"number"},required:!0},{name:"direction",type:{name:"string"},defaultValue:{func:!1,value:'"horizontal"'},values:["horizontal","vertical"]},{name:"className",type:{name:"string"},defaultValue:{func:!1,value:'""'}}],sourceFiles:["D:/98_測試/up/DED-WDS_VUE/libs/src/ui/element/Stepper/Stepper.vue"]};function O(e){return`[
        ${e.map(t=>`{
            title: "${t.title}",
            desc: "${t.desc}",
            content: "${t.content}",
