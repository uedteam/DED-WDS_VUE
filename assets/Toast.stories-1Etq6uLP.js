import{r as E,q as W,s as V,k as M,a as c,b as m,e as f,n as T,h as j,t as $,T as H,o as F,f as q,g as x}from"./vue.esm-bundler-DYHjuIM_.js";import{_ as d}from"./Icon-DeqquNhw.js";import{_ as C}from"./Button-BOuLOqV2.js";import{_ as h}from"./Title-BJmfIanQ.js";import{_}from"./StatusIndicator-9CdJJ4eK.js";const l=E([]),a=new Map,D=e=>{a.has(e)&&(clearTimeout(a.get(e)),a.delete(e)),l.value=l.value.filter(o=>o.id!==e)},U=e=>{const o=Date.now(),t={...e,id:o};if(l.value.push(t),e.duration&&e.duration>0){const n=setTimeout(()=>{D(o)},e.duration);a.set(o,n)}},L=()=>{a.forEach(e=>clearTimeout(e)),a.clear(),l.value=[]},O=()=>({add:U,remove:D,clear:L,toasts:l}),G={class:"ded-toast-header"},J={class:"ded-toast-header-action"},K={class:"ded-description"},r={__name:"Toast",props:{themeColor:{type:String,validator:e=>["primary","secondary","neutral","info","success","warning","error"].includes(e),default:"primary"},title:{type:String,required:!0},content:{type:String,default:"Content"},prefix:{type:String,default:""},duration:{type:Number,default:1e3},className:{type:String,default:""}},emits:["onClose"],setup(e,{emit:o}){if(!document.getElementById("toast")){const i=document.createElement("div");i.id="toast",i.classList.add("ded-toast-container"),document.body.appendChild(i)}const t=o,n=e,u=()=>{t("onClose")};let s=E(null);const z=()=>{s.value&&clearTimeout(s.value),s.value=setTimeout(()=>{u()},n.duration)};return W(()=>{z()}),V(()=>{s.value&&clearTimeout(s.value)}),(i,P)=>(F(),M(H,{to:"#toast"},[c("div",{class:T(["ded-toast",[`ded-toast-border-${n.themeColor}`,n.className]])},[m(C,{class:"ded-close-button",variant:"text",themeColor:"neutral",onClick:u},{default:f(()=>[m(d,{name:"SvgClose",size:"20"})]),_:1}),c("div",G,[c("div",{class:T(["ded-toast-header-message",`ded-toast-header-message-${n.themeColor}`])},[m(d,{name:n.prefix,size:"20"},null,8,["name"]),m(h,{themeColor:n.themeColor,level:5},{default:f(()=>[q($(n.title),1)]),_:1},8,["themeColor"])],2),c("div",J,[j(i.$slots,"action")])]),c("p",K,$(n.content),1)],2)]))}};r.__docgenInfo={exportName:"default",displayName:"Toast",description:"",tags:{},props:[{name:"themeColor",type:{name:"string"},defaultValue:{func:!1,value:'"primary"'},values:["primary","secondary","neutral","info","success","warning","error"]},{name:"title",type:{name:"string"},required:!0},{name:"content",type:{name:"string"},defaultValue:{func:!1,value:'"Content"'}},{name:"prefix",type:{name:"string"},defaultValue:{func:!1,value:'""'}},{name:"duration",type:{name:"number"},defaultValue:{func:!1,value:"1000"}},{name:"className",type:{name:"string"},defaultValue:{func:!1,value:'""'}}],events:[{name:"onClose"}],slots:[{name:"action"}],sourceFiles:["/home/runner/work/DED-WDS_VUE/DED-WDS_VUE/libs/src/ui/element/Toast/Toast.vue"]};const tt={components:{Icon:d,Toast:r},title:"Component/Toast",component:r,tags:["autodocs"],argTypes:{themeColor:{description:"主題顏色",control:{type:"select"},options:["primary","secondary","neutral","info","success","warning","error"],table:{type:{summary:"primary | secondary | neutral | info | success | warning | error"}}},title:{description:"內容",control:{type:"text"}},content:{description:"說明文字",control:{type:"text"}},prefix:{description:"前綴元素",control:{type:"select",labels:{"":"none",SvgInfoCircle:"SvgInfoCircle",SvgSuccessCircle:"SvgSuccessCircle",SvgWarningTri:"SvgWarningTri",SvgErrorCircle:"SvgErrorCircle",SvgDisableCircle:"SvgDisableCircle"}},options:["","SvgInfoCircle","SvgSuccessCircle","SvgWarningTri","SvgErrorCircle","SvgDisableCircle"]},duration:{description:"持續時間",control:{type:"range",min:500,max:5e3,step:100}},className:{description:"客製化樣式",control:{type:"text"}},onClose:{description:"關閉事件",table:{category:"EVENTS",type:{summary:"emits"}}},action:{description:"操作",control:{type:"text"},table:{type:{summary:"Vue Component | HTML"}}}},parameters:{docs:{title:"Toast",description:{component:"通知訊息組件的呈現及說明。"}}}},v={name:"預設項目",args:{themeColor:"success",title:"Notification Title",content:"Content",prefix:"SvgSuccessCircle",duration:500,className:"",action:'<div @click="onAction">Action</div>'},render:e=>({components:{Toast:r,Button:C,Title:h,StatusIndicator:_,Icon:d},setup(){const o=()=>{window.alert("Close")},t=x(()=>`ded-toast-border-${e.themeColor}`),n=x(()=>`ded-toast-header-message-${e.themeColor}`);return{args:e,onClose:o,toastBorderClass:t,toastHeaderMsgThemeClass:n,onAction:()=>{window.alert("Action")}}},template:`
        ...
        `}),parameters:{controls:{},docs:{source:{transform:(e,o)=>{const{args:t}=o;return["<script setup>",'  import { Toast, Button } from "@ded-wds-vue/ui";','  import { useToast } from "@ded-wds-vue/ui";',"  const { add, toasts, remove } = useToast();","  const showToast = () => {","    add({",`      ${t.themeColor?`themeColor: "${t.themeColor}",`:""}`,`      ${t.title?`title: "${t.title}",`:""}`,`      ${t.content?`content: "${t.content}",`:""}`,`      ${t.prefix?`prefix: "${t.prefix}",`:""}`,`      ${t.duration!==void 0?`duration: ${t.duration},`:""}`,"    });","  };","<\/script>","","<template>","  <Toast",'    v-for="toast in toasts"','    :key="toast.id"','    :themeColor="toast.themeColor"','    :title="toast.title"','    :content="toast.content"','    :prefix="toast.prefix"','    :duration="toast.duration"',`    ${t.className?`className="${t.className}"`:""}`,'    @onClose="remove(toast.id)"',"  >","    <template #action>","       <div>Action</div>","    </template>","  </Toast>","  <Button",'    themeColor="primary"','    variant="filled"','    radius="4px"','    @click="showToast"',"  >","    Toast Trigger","  </Button>","</template>"].filter(Boolean).join(`
`).trim()}}}}},p={name:"訊息類型",args:{title:"Notification Title ",content:"Content",duration:5e3,className:""},render:e=>({components:{Toast:r,Button:C,Title:h,StatusIndicator:_,Icon:d},setup(){return{args:e,onClose:()=>{window.alert("Close")},onAction:()=>{window.alert("Action")}}},template:`
...
`).trim()}}}}},g={name:"互動模式",args:{themeColor:"success",title:"Notification Title ",content:"Content",prefix:"SvgSuccessCircle",duration:5e3,className:"",action:'<div @click="onAction">Action</div>'},render:e=>({components:{Toast:r,Button:C},setup(){const{add:o,toasts:t,remove:n}=O();return{args:e,toasts:t,remove:n,showToast:()=>{o({themeColor:e.themeColor,title:e.title,content:e.content})},onAction:()=>{window.alert("Action")}}},template:`
        ...
        `}),parameters:{controls:{exclude:["onClose"]},docs:{source:{transform:(e,o)=>{const{args:t}=o;return["<script setup>",'  import { Toast, Button } from "@ded-wds-vue/ui";','  import { useToast } from "@ded-wds-vue/ui";',"  const { add, toasts, remove } = useToast();","  const showToast = () => {","    add({",`      ${t.themeColor?`themeColor: "${t.themeColor}",`:""}`,`      ${t.title?`title: "${t.title}",`:""}`,`      ${t.content?`content: "${t.content}",`:""}`,`      ${t.prefix?`prefix: "${t.prefix}",`:""}`,`      ${t.duration!==void 0?`duration: ${t.duration},`:""}`,"    });","  };","<\/script>","","<template>","  <Toast",'    v-for="toast in toasts"','    :key="toast.id"','    :themeColor="toast.themeColor"','    :title="toast.title"','    :content="toast.content"','    :prefix="toast.prefix"','    :duration="toast.duration"',`    ${t.className?`className="${t.className}"`:""}`,'    @onClose="remove(toast.id)"',"  >","    <template #action>","       <div>Action</div>","    </template>","  </Toast>","  <Button",'    themeColor="primary"','    variant="filled"','    radius="4px"','    @click="showToast"',"  >","    Toast Trigger","  </Button>","</template>"].filter(Boolean).join(`
`).trim()}}}}};var A,B,w;v.parameters={...v.parameters,docs:{...(A=v.parameters)==null?void 0:A.docs,source:{originalSource:`{
  name: "預設項目",
  args: {
    themeColor: "success",
    ...
    docs: {
      source: {
        transform: (src, storyContext) => {
          ...
          return ['<script setup>', \`  import { Toast, Button } from "@ded-wds-vue/ui";\`, '  import { useToast } from "@ded-wds-vue/ui";', '  const { add, toasts, remove } = useToast();', \`  const showToast = () => {\`, \`    add({\`, \`      \${args.themeColor ? \`themeColor: "\${args.themeColor}",\` : ""}\`, \`      \${args.title ? \`title: "\${args.title}",\` : ""}\`, \`      \${args.content ? \`content: "\${args.content}",\` : ""}\`, \`      \${args.prefix ? \`prefix: "\${args.prefix}",\` : ""}\`, \`      \${args.duration !== undefined ? \`duration: \${args.duration},\` : ""}\`, \`    });\`, \`  };\`, '<\/script>', '', '<template>', \`  <Toast\`, \`    v-for="toast in toasts"\`, \`    :key="toast.id"\`, \`    :themeColor="toast.themeColor"\`, \`    :title="toast.title"\`, \`    :content="toast.content"\`, \`    :prefix="toast.prefix"\`, \`    :duration="toast.duration"\`, \`    \${args.className ? \`className="\${args.className}"\` : ""}\`, \`    @onClose="remove(toast.id)"\`, \`  >\`, \`    <template #action>\`, \`       <div>Action</div>\`, \`    </template>\`, \`  </Toast>\`, \`  <Button\`, \`    themeColor="primary"\`, \`    variant="filled"\`, \`    radius="4px"\`, \`    @click="showToast"\`, \`  >\`, \`    Toast Trigger\`, \`  </Button>\`, '</template>'].filter(Boolean).join('\\n').trim();
        }
      }
    }
  }
}`,...(w=(B=v.parameters)==null?void 0:B.docs)==null?void 0:w.source}}};var S,I,y;p.parameters={...p.parameters,docs:{...(S=p.parameters)==null?void 0:S.docs,source:{originalSource:`{
  name: "訊息類型",
  args: {
    title: "Notification Title ",
    content: "Content",
...
}`,...(y=(I=p.parameters)==null?void 0:I.docs)==null?void 0:y.source}}};var k,b,N;g.parameters={...g.parameters,docs:{...(k=g.parameters)==null?void 0:k.docs,source:{originalSource:`{
  name: "互動模式",
  args: {
    themeColor: "success",
    title: "Notification Title ",
...
}`,...(N=(b=g.parameters)==null?void 0:b.docs)==null?void 0:N.source}}};const et=["ToastDefault","ToastTotal","ToastInterAction"];export{v as ToastDefault,g as ToastInterAction,p as ToastTotal,et as __namedExportsOrder,tt as default};
