...
}`,...(V=($=c.parameters)==null?void 0:$.docs)==null?void 0:V.source}}};var v,A,M;m.parameters={...m.parameters,docs:{...(v=m.parameters)==null?void 0:v.docs,source:{originalSource:`{
  name: "顯示標籤",
  args: {
    label: "訂單備註",
    placeholder: "請輸入此筆訂單備註",
...
}`,...(M=(A=m.parameters)==null?void 0:A.docs)==null?void 0:M.source}}};var C,y,N;p.parameters={...p.parameters,docs:{...(C=p.parameters)==null?void 0:C.docs,source:{originalSource:`{
  name: "字數限制",
  args: {
    label: "訂單備註",
    placeholder: "請輸入此筆訂單備註",
