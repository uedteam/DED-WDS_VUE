import{p as g,u as b,v,c as o,x as y,a as n,J as D,t as m,F as V,q as x,n as c,b as h,o as i}from"./vue.esm-bundler-CC1hEtM-.js";import{_ as $}from"./Icon-bEM3fLxI.js";const N=["disabled"],_={value:"",disabled:"",selected:""},O=["value"],d={__name:"Select",props:g({dataSource:{type:Array,required:!0},placeholder:{type:String,default:"Select"},suffix:{type:String},isDisabled:{type:Boolean,default:!1},className:{type:String,default:""}},{modelValue:{},modelModifiers:{}}),emits:["update:modelValue"],setup(s){const e=s,a=b(s,"modelValue"),r=v(a);return(w,u)=>(i(),o("div",{class:c(["ded-select-container",{[e.className]:!!e.className}])},[y(n("select",{"onUpdate:modelValue":u[0]||(u[0]=l=>r.value=l),class:c(["ded-select",{"ded-select-disabled":e.isDisabled}]),disabled:e.isDisabled},[n("option",_,m(e.placeholder),1),(i(!0),o(V,null,x(e.dataSource,l=>(i(),o("option",{key:l.value,value:l.value},m(l.label),9,O))),128))],10,N),[[D,r.value]]),n("div",{class:c(["ded-select-icon",{"ded-select-icon-disabled":e.isDisabled}])},[h($,{name:e.suffix,size:"18"},null,8,["name"])],2)],2))}};d.__docgenInfo={exportName:"default",displayName:"Select",description:"",tags:{},props:[{name:"dataSource",type:{name:"array"},required:!0},{name:"placeholder",type:{name:"string"},defaultValue:{func:!1,value:'"Select"'}},{name:"suffix",type:{name:"string"}},{name:"isDisabled",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"className",type:{name:"string"},defaultValue:{func:!1,value:'""'}}],sourceFiles:["D:/98_測試/up/DED-WDS_VUE/libs/src/ui/element/Select/Select.vue"]};function A(s){return`    ${s.map(e=>`{
        label: "${e.label}",
        value: "${e.value}",
    }`).join(`,
