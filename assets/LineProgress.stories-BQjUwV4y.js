...
`).trim()}}}}},o={name:"顯示標籤",args:{themeColor:"primary",label:"Complete",percent:66,strokeWidth:10,className:""},render:r=>({components:{LineProgress:n},setup(){return{args:r}},template:`
            <LineProgress 
                :themeColor="args.themeColor"
                :label="args.label"
                :percent="args.percent"
