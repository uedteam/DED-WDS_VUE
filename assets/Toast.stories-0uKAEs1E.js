...
`).trim()}}}}},p={name:"訊息類型",args:{title:"Notification Title ",content:"Content",duration:5e3,className:""},render:e=>({components:{Toast:r,Button:C,Title:h,StatusIndicator:E,Icon:d},setup(){return{args:e,onClose:()=>{window.alert("Close")},onAction:()=>{window.alert("Action")}}},template:`
...
`).trim()}}}}};var A,B,S;v.parameters={...v.parameters,docs:{...(A=v.parameters)==null?void 0:A.docs,source:{originalSource:`{
  name: "預設項目",
  args: {
    themeColor: "success",
...
}`,...(S=(B=v.parameters)==null?void 0:B.docs)==null?void 0:S.source}}};var w,I,y;p.parameters={...p.parameters,docs:{...(w=p.parameters)==null?void 0:w.docs,source:{originalSource:`{
  name: "訊息類型",
  args: {
    title: "Notification Title ",
    content: "Content",
