import{m as g,u as f,c as S,b as d,e as b,o as D,f as $}from"./vue.esm-bundler-C-J3VMH8.js";import{_ as N}from"./Button-BoYaxGcZ.js";import{_ as v}from"./Input-DMqb6Dzh.js";import"./Icon-zSSehsRW.js";import"./v4-CtRu48qb.js";const z={class:"ded-search"},i={__name:"Search",props:g({size:{type:String,default:"medium",validator:a=>["small","medium","large"].includes(a)},placeholder:{type:String,default:"Type something"},isDisabled:{type:Boolean,default:!1},className:{type:String,default:""}},{modelValue:{},modelModifiers:{}}),emits:["update:modelValue"],setup(a){const s=a,e=f(a,"modelValue");return(V,l)=>(D(),S("div",z,[d(v,{modelValue:e.value,"onUpdate:modelValue":l[0]||(l[0]=h=>e.value=h),type:"text",placeholder:s.placeholder,prefix:"SvgSearch",size:s.size,"is-disabled":s.isDisabled,"class-name":"ded-search-input"},null,8,["modelValue","placeholder","size","is-disabled"]),d(N,{variant:"filled",size:s.size,width:"fit","border-width":"1px",radius:"4px","is-disabled":s.isDisabled},{default:b(()=>l[1]||(l[1]=[$(" Search ")])),_:1},8,["size","is-disabled"])]))}};i.__docgenInfo={exportName:"default",displayName:"Search",description:"",tags:{},props:[{name:"size",type:{name:"string"},defaultValue:{func:!1,value:'"medium"'},values:["small","medium","large"]},{name:"placeholder",type:{name:"string"},defaultValue:{func:!1,value:'"Type something"'}},{name:"isDisabled",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"className",type:{name:"string"},defaultValue:{func:!1,value:'""'}}],sourceFiles:["/Users/auouser/Desktop/Work_Space/DED-WDS_VUE/libs/src/ui/element/Search/Search.vue"]};const B={title:"Component/Search",component:i,tags:["autodocs"],argTypes:{size:{description:"尺寸",control:{type:"select"},options:["small","medium","large"],table:{type:{summary:"small | medium | large "}}},placeholder:{description:"輸入提示",control:{type:"text"}},isDisabled:{description:"是否禁用",control:{type:"boolean"}},className:{description:"客製化樣式",control:{type:"text"}},modelValue:{description:"輸入值",control:{type:"text"},table:{type:{summary:"string"},category:"v-model"}}},parameters:{docs:{title:"Search",description:{component:"Search 組件的呈現及說明。"}}}},r={name:"預設項目",args:{size:"medium",placeholder:"Type something",isDisabled:!1,className:"",modelValue:""},render:a=>({components:{Search:i},setup(){return{args:a}},template:`
      <Search
        :size="args.size"
