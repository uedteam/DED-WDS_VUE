...
`).trim()}}}},g={name:"三段式佈局",args:{className:""},render:t=>({components:{Layout:a,Header:s,Content:o,Side:i,Footer:r},setup(){return{args:t}},template:`
            <Layout :className="args.className">
...
`).trim()}}}}},y={name:"左側欄三段式佈局",args:{className:""},render:t=>({components:{Layout:a,Header:s,Content:o,Side:i,Footer:r},setup(){return{args:t}},template:`
            <Layout :className="args.className">
                <Header :className="args.className" >
                    <div style="
                        width: 100%;
...
`).trim()}}}}},h={name:"右側欄三段式佈局",args:{className:""},render:t=>({components:{Layout:a,Header:s,Content:o,Side:i,Footer:r},setup(){return{args:t}},template:`
            <Layout :className="args.className">
                <Header :className="args.className" >
                    <div style="
                        width: 100%;
...
`).trim()}}}}},N={name:"左側欄固定佈局",args:{className:""},render:t=>({components:{Layout:a,Header:s,Content:o,Side:i,Footer:r},setup(){return{args:t}},template:`
            <Layout :className="args.className">
                <Side :className="args.className" >
                    <div style="
                            width: 100%;
...
`).trim()}}}}},p={name:"標準左側佈局",args:{className:""},render:t=>({components:{Layout:a,Header:s,Content:o,Side:i,Footer:r},setup(){return{args:t}},template:`
            <Layout :className="args.className">
                <Header :className="args.className" >
                    <div style="
                        width: 100%;
...
`).trim()}}}}},v={name:"官網佈局",args:{className:""},render:t=>({components:{Layout:a,Header:s,Content:o,Side:i,Footer:r},setup(){return{args:t}},template:`
            <Layout :className="args.className">
                <Header :className="args.className" >
                    <div style="
                        width: 100%;
...
}`,...(k=(w=y.parameters)==null?void 0:w.docs)==null?void 0:k.source}}};var H,$,_;h.parameters={...h.parameters,docs:{...(H=h.parameters)==null?void 0:H.docs,source:{originalSource:`{
  name: '右側欄三段式佈局',
  args: {
    className: ''
  },
