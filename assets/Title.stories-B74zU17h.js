import{c as n,a as h,r as $,n as p,o as y}from"./vue.esm-bundler-Dy0-1sXb.js";const s={__name:"Title",props:{themeColor:{type:String,validator:l=>["primary","secondary","tertiary","success","warning","error","info"].includes(l)},level:{type:String,default:"0",validator:l=>["0","1","2","3","4","5","6"].includes(l)},className:{type:String,default:""}},setup(l){const a=l,e=n(()=>[`title title-level-${a.level} title-${a.themeColor}`]),C=n(()=>[e.value,a.className].filter(Boolean).join(" "));return(f,L)=>(y(),h("div",{class:p(C.value)},[$(f.$slots,"default")],2))}};s.__docgenInfo={exportName:"default",displayName:"Title",description:"",tags:{},props:[{name:"themeColor",type:{name:"string"},values:["primary","secondary","tertiary","success","warning","error","info"]},{name:"level",type:{name:"string"},defaultValue:{func:!1,value:"'0'"},values:["0","1","2","3","4","5","6"]},{name:"className",type:{name:"string"},defaultValue:{func:!1,value:"''"}}],slots:[{name:"default"}],sourceFiles:["D:/98_測試/up/DED-WDS_VUE/libs/src/ui/element/Title/Title.vue"]};const x={title:"Design System/Title",component:s,tags:["autodocs"],argTypes:{themeColor:{description:"分隔線主題顏色",control:{type:"select",labels:{"":"None",primary:"primary",secondary:"secondary",tertiary:"tertiary",success:"success",warning:"warning",error:"error",info:"info"}},options:["","primary","secondary","tertiary","success","warning","error","info"]},level:{description:"標題等級",control:{type:"select"},options:["0","1","2","3","4","5","6"]},className:{description:"客製化樣式",control:{type:"text"}}},parameters:{docs:{title:"Title",description:{component:"Title 組件的呈現及說明。"}}}},r={name:"預設項目",args:{themeColor:"",level:1,className:"",default:"標題"},render:l=>({components:{Title:s},setup(){return{args:l}},template:`
            <Title
...
`).trim()}}}}},t={name:"標題大小",args:{themeColor:"",className:"",default:"標題文字"},render:l=>({components:{Title:s},setup(){return{args:l}},template:`
            <Title 
                :themeColor="args.themeColor"
                level="1"
                :className="args.className"
...
`).trim()}}}}},o={name:"主題色彩",args:{level:1,className:"",default:"標題文字"},render:l=>({components:{Title:s},setup(){return{args:l}},template:`
            <Title
                themeColor="primary"
                :level="args.level"
                :className="args.className"
...
}`,...(i=(c=r.parameters)==null?void 0:c.docs)==null?void 0:i.source}}};var u,g,v;t.parameters={...t.parameters,docs:{...(u=t.parameters)==null?void 0:u.docs,source:{originalSource:`{
  name: "標題大小",
  args: {
    themeColor: "",
    className: "",
...
}`,...(v=(g=t.parameters)==null?void 0:g.docs)==null?void 0:v.source}}};var d,T,N;o.parameters={...o.parameters,docs:{...(d=o.parameters)==null?void 0:d.docs,source:{originalSource:`{
  name: "主題色彩",
  args: {
    level: 1,
    className: "",
...
}`,...(N=(T=o.parameters)==null?void 0:T.docs)==null?void 0:N.source}}};const A=["HeadingDefault","HeadingSizeDefault","HeadingColorDefault"];export{o as HeadingColorDefault,r as HeadingDefault,t as HeadingSizeDefault,A as __namedExportsOrder,x as default};
