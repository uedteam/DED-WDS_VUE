import{p as h,u as V,v as u,A as $,D as z,B as N,c,d as f,a as _,j as E,t as x,b as v,k,T as O,F as B,o as d}from"./vue.esm-bundler-CbCZpGld.js";import{_ as C}from"./Input-CGEMbczU.js";import{_ as L}from"./List-C-CTPOu-.js";import{g as P}from"./positionUtils-CIbX64TV.js";import"./Icon-DPZA6u3a.js";const j={key:0,class:"ded-input-label"},A=8,F="bottom",p={__name:"Dropdown",props:h({dataSource:{type:Array,required:!0},label:{type:String,default:""},placeholder:{type:String,default:"Placeholder"},size:{type:String,validator:a=>["small","medium","large"].includes(a),default:"medium"},className:{type:String,default:""}},{modelValue:{},modelModifiers:{}}),emits:["update:modelValue"],setup(a){const o=a,e=V(a,"modelValue"),t=u(!1),r=u(null),m=u({});function y(l){e.value=l,t.value=!1}function g(l){r.value&&!r.value.contains(l.target)&&(t.value=!1)}function n(){if(r.value){const l=r.value.getBoundingClientRect();m.value=P({top:l.top+window.scrollY,left:l.left+window.scrollX},{width:l.width,height:l.height},F,`${A}px`,!0)}}return $(()=>{document.addEventListener("click",g),window.addEventListener("resize",n),window.addEventListener("scroll",n),z(()=>n())}),N(()=>{document.removeEventListener("click",g),window.removeEventListener("resize",n),window.removeEventListener("scroll",n)}),(l,s)=>(d(),c(B,null,[o.label?(d(),c("label",j,x(o.label),1)):f("",!0),_("div",{ref_key:"dropdown",ref:r,class:"ded-dropdown",role:"listbox",tabindex:"0",onClick:s[1]||(s[1]=()=>{t.value=!t.value,n()})},[v(C,{modelValue:e.value,"onUpdate:modelValue":s[0]||(s[0]=S=>e.value=S),type:"text",size:o.size,placeholder:o.placeholder,"is-open":t.value,"class-name":"ded-dropdown-input"},null,8,["modelValue","size","placeholder","is-open"])],512),(d(),E(O,{to:"body"},[t.value?(d(),c("div",{key:0,class:"ded-tooltip",style:k(m.value)},[v(L,{"data-source":o.dataSource,"has-outline":!0,onOnSelect:y},null,8,["data-source"])],4)):f("",!0)]))],64))}};p.__docgenInfo={exportName:"default",displayName:"Dropdown",description:"",tags:{},props:[{name:"dataSource",type:{name:"array"},required:!0},{name:"label",type:{name:"string"},defaultValue:{func:!1,value:'""'}},{name:"placeholder",type:{name:"string"},defaultValue:{func:!1,value:'"Placeholder"'}},{name:"size",type:{name:"string"},defaultValue:{func:!1,value:'"medium"'},values:["small","medium","large"]},{name:"className",type:{name:"string"},defaultValue:{func:!1,value:'""'}}],sourceFiles:["/home/runner/work/DED-WDS_VUE/DED-WDS_VUE/libs/src/ui/element/Dropdown/Dropdown.vue"]};function T(a){return`[
    ${a.map(o=>`{
        label: '${o.label}',
        value: '${o.value}',
    }`).join(`,
    `)}
      ...
      `}),parameters:{controls:{},docs:{source:{transform:(a,o)=>{const{args:e}=o;return["<script setup>",'import { ref } from "vue";','import { Dropdown } from "@ded-wds-vue/ui";','const modelValue = ref("");',"<\/script>","","<template>","  <Dropdown",`    :dataSource="${T(e.dataSource)}"`,`    ${e.label?`label="${e.label}"`:""}`,`    ${e.placeholder?`placeholder="${e.placeholder}"`:""}`,`    ${e.size?`size="${e.size}"`:""}`,`    ${e.className?`className="${e.className}"`:""}`,'    v-model="modelValue"',"  ></Dropdown>","</template>"].filter(Boolean).join(`
...
}`,...(D=(b=i.parameters)==null?void 0:b.docs)==null?void 0:D.source}}};const X=["DropdownDefault"];export{i as DropdownDefault,X as __namedExportsOrder,I as default};
