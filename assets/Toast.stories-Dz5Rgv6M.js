import{r as A,s as z,H as C,d as c,b as a,C as x,n as v,e as u,t as T,T as _,o as i}from"./vue.esm-bundler-Bm7qTojY.js";import{_ as o}from"./Icon-0yHNpaiS.js";import{B}from"./Button-BQuyBdgb.js";import"./iframe-DS6YppJf.js";import"../sb-preview/runtime.js";import"./index-Bb4qSo10.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";const d=A([]),D=s=>{d.value=d.value.filter(t=>t.id!==s)},E=s=>{const t=Date.now(),n={...s,id:t};d.value.push(n)},S=()=>({add:E,remove:D,toasts:d}),N={class:"message"},F={class:"description"},l={__name:"Toast",props:{title:{type:String},message:{type:String},severity:{type:String,default:"success",validator:s=>["success","warning","error","info"].includes(s)},duration:{type:Number,default:3e3}},emits:["close"],setup(s,{emit:t}){const n=t,e=s,g=()=>{n("close")};let r=A(null);const k=()=>{r.value&&clearTimeout(r.value),r.value=setTimeout(()=>{g()},e.duration)};return z(()=>{k()}),C(()=>{r&&clearTimeout(r)}),($,V)=>(i(),c(_,{to:"#toast"},[a("div",{class:v(["toast",`toast-border-${e.severity}`])},[a("button",{class:"close-button",style:{cursor:"pointer"},onClick:g},[x(o,{name:"close",size:"20"})]),a("p",N,[a("span",{class:v(["icon-wrapper",`toast-${e.severity}`])},[e.severity==="success"?(i(),c(o,{key:0,name:"check",size:"14"})):u("",!0),e.severity==="error"?(i(),c(o,{key:1,name:"close",size:"14"})):u("",!0),e.severity==="warning"?(i(),c(o,{key:2,name:"exclamation",size:"14"})):u("",!0),e.severity==="info"?(i(),c(o,{key:3,name:"info",size:"16"})):u("",!0)],2),a("span",null,T(e.title),1)]),a("p",F,T(e.message),1)],2)]))}};l.__docgenInfo={exportName:"default",displayName:"Toast",description:"",tags:{},props:[{name:"title",type:{name:"string"}},{name:"message",type:{name:"string"}},{name:"severity",type:{name:"string"},defaultValue:{func:!1,value:"'success'"},values:["success","warning","error","info"]},{name:"duration",type:{name:"number"},defaultValue:{func:!1,value:"3000"}}],events:[{name:"close"}],sourceFiles:["/Users/auouser/Desktop/Work_Space/DED-WDS_VUE/libs/src/ui/element/Toast/Toast.vue"]};const G={components:{Icon:o,Toast:l},title:"Design System/Toast",component:l,tags:["autodocs"],argTypes:{title:{description:"Toast 標題",control:{type:"text"}},message:{description:"Toast 說明文字",control:{type:"text"}},severity:{description:"用於指示 Toast 信息的性質",control:{type:"select"},options:["success","warning","error","info"]},duration:{description:"Toast 顯示的持續時間（毫秒）",control:{type:"range",min:500,max:1e4,step:500}},show:{table:{disable:!0}}},parameters:{docs:{title:"Toast",description:{component:"Toast 組件的呈現及說明。"}}}},p={name:"Toast 種類樣式",args:{title:"Toast Message",message:"Hello, world! This is a toast message.",severity:"success",show:!0},render:s=>({components:{Toast:l,Icon:o},setup(){return{args:s,closeToast:()=>{s.show=!1}}},template:`
...
}`,...(I=(h=m.parameters)==null?void 0:h.docs)==null?void 0:I.source}}};const J=["ToastType","ToastDefaultNew"];export{m as ToastDefaultNew,p as ToastType,J as __namedExportsOrder,G as default};
