import{c as N,f as y,j as B,l as V,a as i,F as S,B as w,e as h,n as E,t as j,d as A,C as L,s as P,b as _,D as k,T as F,o as n}from"./vue.esm-bundler-D-gFHCZh.js";import{_ as x}from"./Avatar-Bm9fRbnT.js";import{_ as J,a as K}from"./List-hl0zIk54.js";import"./Image-CxttRmOD.js";import"./Icon-BhqjPbyE.js";import"./iframe-Bd5YQskO.js";import"../sb-preview/runtime.js";const M={class:"ded-avatar-overlay"},O={class:"ded-avatar-text"},z={__name:"AvatarGroup",props:{dataSource:{type:Array,required:!0},size:{type:String,default:"large",validator:o=>["small","medium","large"].includes(o)},limit:{type:Number,default:1},className:{type:String,default:""}},setup(o){const e=o,c=N(()=>{const a=e.dataSource.length-e.limit;return a>=99?99:a}),v=(a,s)=>{const t=a.slice(0,s),f=a.slice(s);return{currList:t,restList:f}},C=N(()=>v(e.dataSource,e.limit).currList),m=N(()=>v(e.dataSource,e.limit).restList),u=y(!1),p=y(null),g=y({top:"0px",left:"0px"}),r=()=>{var s;const a=(s=p.value)==null?void 0:s.getBoundingClientRect();a&&(g.value={top:`${a.bottom+window.scrollY+8}px`,left:`${a.left+window.scrollX}px`})},D=()=>{u.value=!u.value,u.value?(r(),window.addEventListener("resize",r),window.addEventListener("scroll",r,!0),document.addEventListener("click",l)):(window.removeEventListener("resize",r),window.removeEventListener("scroll",r,!0),document.removeEventListener("click",l))},l=a=>{var s;p.value&&!p.value.contains(a.target)&&!((s=document.querySelector(".ded-dropdown-menu"))!=null&&s.contains(a.target))&&(u.value=!1,document.removeEventListener("click",l))};return B(()=>{u.value&&(window.addEventListener("resize",r),window.addEventListener("scroll",r,!0),document.addEventListener("click",l))}),V(()=>{window.removeEventListener("resize",r),window.removeEventListener("scroll",r,!0),document.removeEventListener("click",l)}),(a,s)=>(n(),i("div",{class:E({"ded-avatar-group":!0,[e.className]:!!e.className})},[(n(!0),i(S,null,w(C.value,(t,f)=>(n(),i("div",{class:"ded-avatar-overlay",key:f},[_(x,{shape:e.shape,size:e.size,src:t.src,userName:t.userName,caption:t.caption},null,8,["shape","size","src","userName","caption"])]))),128)),m.value.length>0?(n(),i(S,{key:0},[h("div",M,[m.value.length>0?(n(),i("div",{key:0,ref_key:"restContainerRef",ref:p,class:E(["ded-avatar-container",`ded-avatar-container-${e.size}`])},[h("button",{class:"ded-avatar ded-avatar-circle",onClick:D,style:{cursor:"pointer"}},[h("span",O,j(`+${c.value}`),1)])],2)):A("",!0)]),(n(),L(F,{to:"body"},[u.value?(n(),i("div",{key:0,class:"ded-dropdown-menu",style:P({position:"absolute",top:g.value.top,left:g.value.left,"z-index":9999})},[_(J,{dataSource:m.value,hasOutline:!0},{default:k(()=>[(n(!0),i(S,null,w(m.value,t=>(n(),L(K,{key:t.userName,label:t.userName,value:t.userName,href:t.src,prefix:t.prefix},{default:k(()=>[_(x,{shape:"circle",size:"medium",userName:t.userName,caption:t.caption},null,8,["userName","caption"])]),_:2},1032,["label","value","href","prefix"]))),128))]),_:1},8,["dataSource"])],4)):A("",!0)]))],64)):A("",!0)],2))}};z.__docgenInfo={exportName:"default",displayName:"AvatarGroup",description:"",tags:{},props:[{name:"dataSource",type:{name:"array"},required:!0},{name:"size",type:{name:"string"},defaultValue:{func:!1,value:'"large"'},values:["small","medium","large"]},{name:"limit",type:{name:"number"},defaultValue:{func:!1,value:"1"}},{name:"className",type:{name:"string"},defaultValue:{func:!1,value:'""'}}],sourceFiles:["/Users/auouser/Desktop/Work_Space/DED-WDS_VUE/libs/src/ui/element/AvatarGroup/AvatarGroup.vue"]};function W(o){return`[
    ...
    `)}
            ...
            ></AvatarGroup>
        `}),parameters:{controls:{},docs:{source:{transform:(o,e)=>{const{args:c}=e;return["<AvatarGroup",`  :dataSource='${W(c.dataSource)}'`,`  size="${c.size}"`,`  :limit="${c.limit}"`,`  class="${c.className}"`,"></AvatarGroup>"].join(`
