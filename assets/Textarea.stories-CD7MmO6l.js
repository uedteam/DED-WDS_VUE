import{m as S,u as _,f as k,c as n,n as t,t as d,e as h,b as D,a as $,A as I,o,r}from"./vue.esm-bundler-BE8rPDeG.js";const L=["maxlength","placeholder"],s={__name:"Textarea",props:S({label:{type:String},placeholder:{type:String,default:"placeholder text"},limit:{type:Number,default:100},isDisabled:{type:Boolean,default:!1},hint:{type:Object,default:()=>({error:"",description:""})},className:{type:String,default:""}},{modelValue:{},modelModifiers:{}}),emits:["update:modelValue"],setup(l){const a=_(l,"modelValue"),e=l,i=k(()=>e.hint.error.length>0?"error":e.hint.description.length>0?"desc":"");return(b,u)=>(o(),n("div",{class:t({"textarea-container":!0,[e.className]:!!e.className})},[e.label?(o(),n("label",{key:0,class:t(["textarea-label",{"textarea-disable":e.isDisabled}]),for:"id"},d(e.label),3)):h("",!0),D("div",{class:t(["textarea-group",{"textarea-disable":e.isDisabled},e.hint.error.length>0&&`textarea-border-${i.value}`])},[$(D("textarea",{id:"id",class:t(["textarea",{"textarea-disable":e.isDisabled}]),maxlength:e.limit>0?e.limit:void 0,placeholder:e.placeholder,"onUpdate:modelValue":u[0]||(u[0]=g=>a.value=g),onInput:u[1]||(u[1]=(...g)=>b.handleInput&&b.handleInput(...g))},null,42,L),[[I,a.value]]),a.value.length>0&&e.limit===0?(o(),n("small",{key:0,class:t(["textarea-hint-count",{"textarea-disable":e.isDisabled}])},d(a.value.length>0?`${a.value.length}`:""),3)):(o(),n("small",{key:1,class:t(["textarea-hint-count",{"textarea-disable":e.isDisabled}])},d(a.value.length>0?`${a.value.length} / ${e.limit}`:""),3))],2),e.hint.error.length>0||e.hint.description.length>0?(o(),n("small",{key:1,class:t(["textarea-hint",{"textarea-disable":e.isDisabled},`textarea-hint-${i.value}`])},d(e.hint.error.length>0?e.hint.error:e.hint.description),3)):h("",!0)],2))}};s.__docgenInfo={exportName:"default",displayName:"Textarea",description:"",tags:{},props:[{name:"label",type:{name:"string"}},{name:"placeholder",type:{name:"string"},defaultValue:{func:!1,value:'"placeholder text"'}},{name:"limit",type:{name:"number"},defaultValue:{func:!1,value:"100"}},{name:"isDisabled",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"hint",type:{name:"object"},defaultValue:{func:!1,value:`{\r
    error: '',\r
    description: ''\r
}`}},{name:"className",type:{name:"string"},defaultValue:{func:!1,value:"''"}}],sourceFiles:["D:/98_測試/up/DED-WDS_VUE/libs/src/ui/element/Textarea/Textarea.vue"]};const W={title:"Design System/Textarea",component:s,tags:["autodocs"],argTypes:{label:{description:"標題",control:{type:"text"}},placeholder:{description:"輸入提示",control:{type:"text"}},limit:{description:"字數限制",control:{type:"number"}},isDisabled:{description:"是否禁用",control:{type:"boolean"}},hint:{description:"提示訊息",control:{type:"object"}},className:{description:"客製化樣式",control:{type:"text"}}},parameters:{docs:{title:"Textarea",description:{component:"Textarea 組件的呈現及說明。"}}}},c={name:"預設項目",args:{label:"",placeholder:"請輸入此筆訂單備註",limit:50,isDisabled:!1,hint:{error:"",description:""},className:""},render:l=>({components:{Textarea:s},setup(){const a=r("");return{args:l,textareaModelValue:a}},template:`
            <Textarea
                :label="args.label"
...
}`,...(M=(v=m.parameters)==null?void 0:v.docs)==null?void 0:M.source}}};var B,y,C;p.parameters={...p.parameters,docs:{...(B=p.parameters)==null?void 0:B.docs,source:{originalSource:`{
  name: "字數限制",
  args: {
    label: "訂單備註",
    placeholder: "請輸入此筆訂單備註",
...
}`,...(C=(y=p.parameters)==null?void 0:y.docs)==null?void 0:C.source}}};var N,F,E;x.parameters={...x.parameters,docs:{...(N=x.parameters)==null?void 0:N.docs,source:{originalSource:`{
  name: "輸入框狀態",
  args: {
    label: "訂單備註",
    placeholder: "請輸入此筆訂單備註",
...
}`,...(E=(F=x.parameters)==null?void 0:F.docs)==null?void 0:E.source}}};const w=["TextareaDefault","TextareaLabelDefault","TextareaLimit","TextareaStatus"];export{c as TextareaDefault,m as TextareaLabelDefault,p as TextareaLimit,x as TextareaStatus,w as __namedExportsOrder,W as default};
