import{_ as P}from"./Button-kBbFOux4.js";import{g as A,c as a,a as s,F as w,q as _,t as u,n as v,o as c,d as x}from"./vue.esm-bundler-CC1hEtM-.js";import"./Icon-bEM3fLxI.js";const k={class:"ded-stepper-header"},j={class:"ded-step-circle"},z={class:"ded-step-group"},E={class:"ded-step-title"},F={key:0,class:"ded-step-description"},M={key:0,class:"ded-step-connector"},V={class:"ded-stepper-content"},p={__name:"Stepper",props:{dataSource:{type:Array,required:!0},currentStep:{type:Number,required:!0},direction:{type:String,default:"horizontal",validator:e=>["horizontal","vertical"].includes(e)},className:{type:String,default:""}},setup(e){const t=e,r=A(()=>o=>o===t.currentStep?"ded-step-active":o<t.currentStep?"ded-step-completed":"");return(o,n)=>{var f;return c(),a("div",{class:v(["ded-stepper",{[`ded-stepper-${t.direction}`]:t.direction,[t.className]:!!t.className}])},[s("div",k,[(c(!0),a(w,null,_(t.dataSource,(m,i)=>(c(),a("div",{key:i,class:v(["ded-step",[r.value(i)]])},[s("div",j,u(i+1),1),s("div",z,[s("div",E,u(m.title),1),m.desc?(c(),a("div",F,u(m.desc),1)):x("",!0)]),e.direction==="vertical"&&i!==e.dataSource.length-1?(c(),a("div",M)):x("",!0)],2))),128))]),s("div",V,u(((f=e.dataSource[e.currentStep])==null?void 0:f.content)||"No content available for this step."),1)],2)}}};p.__docgenInfo={exportName:"default",displayName:"Stepper",description:"",tags:{},props:[{name:"dataSource",type:{name:"array"},required:!0},{name:"currentStep",type:{name:"number"},required:!0},{name:"direction",type:{name:"string"},defaultValue:{func:!1,value:'"horizontal"'},values:["horizontal","vertical"]},{name:"className",type:{name:"string"},defaultValue:{func:!1,value:'""'}}],sourceFiles:["D:/98_測試/up/DED-WDS_VUE/libs/src/ui/element/Stepper/Stepper.vue"]};function q(e){return`    ${e.map(t=>`{
        title: "${t.title}",
        desc: "${t.desc}",
        content: "${t.content}",
    }`).join(`,
    `)}`}const g=[{title:"Step 1",desc:"Description",content:"Content for Step 1"},{title:"Step 2",desc:"Description",content:"Content for Step 2"},{title:"Step 3",desc:"Description",content:"Content for Step 3"}],L={title:"Component/Stepper",component:p,tags:["autodocs"],argTypes:{dataSource:{description:"步驟列表",control:{type:"object"},table:{type:{summary:"{ title: string; desc?: string | undefined; content?: Vue Component; }[]"}}},currentStep:{description:"當前步驟（從 0 開始）",control:{type:"number",min:0,max:2,step:1}},direction:{description:"方向",control:{type:"select"},options:["horizontal","vertical"],table:{type:{summary:"horizontal | vertical "}}},className:{description:"客製化樣式",control:{type:"text"}}},parameters:{docs:{title:"Stepper",description:{component:"Stepper 組件的呈現及說明。"}}}},l={name:"預設項目",args:{dataSource:g,currentStep:1,direction:"horizontal",className:""},render:e=>({components:{Stepper:p},setup(){return{args:e}},template:`
      <Stepper
        :dataSource="args.dataSource"
        :currentStep="args.currentStep"
        :direction="args.direction"
        :className="args.className"
      ></Stepper>`}),parameters:{controls:{},docs:{source:{transform:(e,t)=>{const{args:r}=t;return["<script setup>",'import { Stepper } from "@ded-wds-vue/ui";',"const dataSource = [",`${q(r.dataSource)}`,"];","<\/script>","","<template>","  <Stepper",'      :dataSource="dataSource"',`      ${r.currentStep!==void 0?`:currentStep="${r.currentStep}"`:""}`,`      ${r.direction?`direction="${r.direction}"`:""}`,`      ${r.className?`className="${r.className}"`:""}`,"  ></Stepper>","</template>"].filter(Boolean).join(`
`).trim()}}}}},d={name:"橫向互動模式",args:{dataSource:g,currentStep:1,direction:"horizontal",className:""},render:e=>({components:{Stepper:p,Button:P},setup(){const t=n=>{Object.assign(e,n)};return{args:e,goToPreviousStep:()=>{const n=Math.max(0,e.currentStep-1);t({currentStep:n})},goToNextStep:()=>{const n=Math.min(e.dataSource.length-1,e.currentStep+1);t({currentStep:n})}}},template:`
      ...
      </div>`}),parameters:{controls:{},docs:{source:{transform:(e,t)=>{const{args:r}=t;return["<script setup>",'import { ref } from "vue";','import { Stepper, Button } from "@ded-wds-vue/ui";',"","const currentStep = ref(1);","const dataSource = [","  {",'    title: "Step 1",','    desc: "Description",','    content: "Content for Step 1",',"  },","  {",'    title: "Step 2",','    desc: "Description",','    content: "Content for Step 2",',"  },","  {",'    title: "Step 3",','    desc: "Description",','    content: "Content for Step 3",',"  }","];","","const goToPreviousStep = () => {","  if (currentStep.value > 0) {","    currentStep.value -= 1;","  }","};","","const goToNextStep = () => {","  if (currentStep.value < dataSource.length - 1) {","    currentStep.value += 1;","  }","};","","<\/script>","","<template>","  <Stepper","      :dataSource='dataSource'",'      :currentStep="currentStep"',`      ${r.direction?`direction="${r.direction}"`:""}`,`      ${r.className?`className="${r.className}"`:""}`,"  ></Stepper>",'  <div style="display: flex; justify-content: flex-start; gap: 8px; margin-top: 16px;">',"    <Button",'      variant="filled"','      :isDisabled="currentStep === 0"','      @click="goToPreviousStep()"',"    >","      Previous","    </Button>","  ","    <Button",'      variant="filled"','      :isDisabled="currentStep === dataSource.length - 1"','      @click="goToNextStep()"',"    >","      Next","    </Button>","  </div>","</template>"].filter(Boolean).join(`
...
`).trim()}}}}};var N,y,B;l.parameters={...l.parameters,docs:{...(N=l.parameters)==null?void 0:N.docs,source:{originalSource:`{
  name: "預設項目",
  args: {
    dataSource,
    currentStep: 1,
