import{r as F,d as B,l as b,G as C,T as k,K as _,o as g,M as c,c as x,b as e,g as d,e as H}from"./vue.esm-bundler-BE8rPDeG.js";import{_ as y}from"./Button-BeAP15VK.js";import{_ as w}from"./FakeContent-BadsJFSJ.js";import"./index-Bb4qSo10.js";import"./Icon-CMwfZrSH.js";import"./iframe-Bo1y-7U0.js";import"../sb-preview/runtime.js";const s=F(!1),f=()=>({showDialogStatus:s,showDialog:()=>{s.value=!0},closeDialog:()=>{s.value=!1}}),S={class:"dialog-wrapper"},A={class:"dialog-container"},E={class:"dialog-header"},R={class:"dialog-body"},$={class:"dialog-footer"},o={__name:"Dialog",props:{},setup(t){const a=f();return(i,r)=>(g(),B(_,{to:"#dialog"},[b(k,{name:"dialog"},{default:C(()=>[c(a).showDialogStatus.value?(g(),x("div",{key:0,class:"dialog-mask",onClick:r[0]||(r[0]=I=>c(a).closeDialog())},[e("div",S,[e("div",A,[e("div",E,[d(i.$slots,"dialogHeader")]),e("div",R,[d(i.$slots,"dialogBody")]),e("div",$,[d(i.$slots,"dialogFooter")])])])])):H("",!0)]),_:3})]))}};o.__docgenInfo={exportName:"default",displayName:"Dialog",description:"",tags:{},slots:[{name:"dialogHeader"},{name:"dialogBody"},{name:"dialogFooter"}],sourceFiles:["D:/98_測試/up/DED-WDS_VUE/libs/src/ui/element/Dialog/Dialog.vue"]};const K={components:{Dialog:o},title:"Design System/Dialog",component:o,tags:["autodocs"],argTypes:{dialogHeader:{description:"Dialog 的 header 插槽，適合顯示主題或重要信息，支持 HTML 和文字內容。",control:{type:"text"}},dialogBody:{description:"Dialog 的 body 插槽，用於顯示主要內容。可包含文字、圖片、列表或任何其他組件。",control:{type:"text"}},dialogFooter:{description:"Dialog 的 footer 插槽，通常用於顯示按鈕或其他結尾內容，如確認、取消或其他操作。",control:{type:"text"}}},parameters:{docs:{title:"Dialog",description:{component:"Dialog 組件的呈現及說明。"}}}},l={name:"Dialog 觸發樣式",args:{dialogHeader:'<div class="title title-level-2 title-undefined">Replace Image?</div>',dialogBody:'<p>A file named "example.png" already exist! Do you what to replace it?</p>',dialogFooter:'<div style="display: flex; justify-content: flex-end; gap: 16px"><button class="button button-text button-fit button-text-error" @click="dialog.closeDialog()" >Cancel</button><button class="button button-contained button-fit button-contained-error" @click="dialog.closeDialog()">Replace</button></div>'},render:t=>({components:{Dialog:o,Button:y},setup(){const a=f();return{args:t,dialog:a}},template:`
            <Dialog>
        ...
        `}),parameters:{controls:{}}},n={name:"Dialog 容器結構",args:{dialogHeader:"",dialogBody:"",dialogFooter:""},render:t=>({components:{Dialog:o,FakeContent:w,Button:y},setup(){return{args:t}},template:`
...
}`,...(h=(D=n.parameters)==null?void 0:D.docs)==null?void 0:h.source}}};const L=["DialogClick","DialogSlotStyle"];export{l as DialogClick,n as DialogSlotStyle,L as __namedExportsOrder,K as default};
