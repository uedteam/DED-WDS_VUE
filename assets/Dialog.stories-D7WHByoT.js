import{r as k,g as B,j as b,C as x,T as H,J as S,o as g,M as c,a as y,b as t,D as s,h as w,c as $,f as E}from"./vue.esm-bundler-wiEVvyCh.js";import{_ as f}from"./Button-C5i7d6Nm.js";import"./index-Bb4qSo10.js";import"./Icon-CSRllRg0.js";import"./iframe-BNXXAjtc.js";import"../sb-preview/runtime.js";const r=k(!1),F=()=>({showDialogStatus:r,showDialog:()=>{r.value=!0},closeDialog:()=>{r.value=!1}}),A={class:"dialog-wrapper"},N={class:"dialog-container"},I={class:"dialog-header"},R={class:"dialog-body"},T={class:"dialog-footer"},l={__name:"Dialog",props:{},setup(o){const e=F();return(a,n)=>(g(),B(S,{to:"#dialog"},[b(H,{name:"dialog"},{default:x(()=>[c(e).showDialogStatus.value?(g(),y("div",{key:0,class:"dialog-mask",onClick:n[0]||(n[0]=C=>c(e).closeDialog())},[t("div",A,[t("div",N,[t("div",I,[s(a.$slots,"dialogHeader")]),t("div",R,[s(a.$slots,"dialogBody")]),t("div",T,[s(a.$slots,"dialogFooter")])])])])):w("",!0)]),_:3})]))}};l.__docgenInfo={exportName:"default",displayName:"Dialog",description:"",tags:{},slots:[{name:"dialogHeader"},{name:"dialogBody"},{name:"dialogFooter"}],sourceFiles:["D:/98_測試/up/DED-WDS_VUE/libs/src/ui/element/Dialog/Dialog.vue"]};const V={class:"fakeContent",role:"presentation","aria-hidden":"true"},j={class:"fakeContent--text"},_={__name:"FakeContent",props:{height:{type:String}},setup(o){const e=o,a=$(()=>e.height?`${e.height}px`:"auto");return(n,C)=>(g(),y("div",{style:E({height:a.value})},[t("div",V,[t("p",j,[s(n.$slots,"default")])])],4))}};_.__docgenInfo={exportName:"default",displayName:"FakeContent",description:"",tags:{},props:[{name:"height",type:{name:"string"}}],slots:[{name:"default"}],sourceFiles:["D:/98_測試/up/DED-WDS_VUE/libs/src/ui/utility/FakeContent/FakeContent.vue"]};const O={components:{Dialog:l},title:"Design System/Dialog*",component:l,tags:["autodocs"],argTypes:{dialogHeader:{description:"Dialog 的 header 插槽，適合顯示主題或重要信息，支持 HTML 和文字內容。",control:{type:"text"}},dialogBody:{description:"Dialog 的 body 插槽，用於顯示主要內容。可包含文字、圖片、列表或任何其他組件。",control:{type:"text"}},dialogFooter:{description:"Dialog 的 footer 插槽，通常用於顯示按鈕或其他結尾內容，如確認、取消或其他操作。",control:{type:"text"}}},parameters:{docs:{title:"Dialog",description:{component:"Dialog 組件的呈現及說明。"}}}},i={name:"Dialog 觸發樣式",args:{dialogHeader:'<div class="title title-level-2 title-undefined">Replace Image?</div>',dialogBody:'<p>A file named "example.png" already exist! Do you what to replace it?</p>',dialogFooter:'<div style="display: flex; justify-content: flex-end; gap: 16px"><button class="button button-text button-fit button-text-error" @click="dialog.closeDialog()" >Cancel</button><button class="button button-contained button-fit button-contained-error" @click="dialog.closeDialog()">Replace</button></div>'},render:o=>({components:{Dialog:l,Button:f},setup(){const e=F();return{args:o,dialog:e}},template:`
            <Dialog>
