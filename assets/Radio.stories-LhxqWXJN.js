import{m as f,u as b,w as x,a as d,F as w,B as D,n as c,o as u,g as O,M as _,b as m,t as k,d as $}from"./vue.esm-bundler-CTfO_w4g.js";const E=["value","name","checked"],j={class:"ded-radio-text"},s={__name:"Radio",props:f({themeColor:{type:String,default:"primary",validator:o=>["primary","secondary","tertiary","success","warning","error","info"].includes(o)},dataSource:{type:Array,required:!0},initValue:{type:String,required:!0},direction:{type:String,default:"row",validator:o=>["row","column"].includes(o)},className:{type:String,default:""}},{modelValue:{},modelModifiers:{}}),emits:["update:modelValue"],setup(o){const a=b(o,"modelValue"),e=o;x(()=>e.initValue,i=>{a.value||(a.value=i)},{immediate:!0});const r=i=>a.value===i;return(i,g)=>(u(),d("div",{class:c({"ded-radio-container":!0,[`ded-radio-container-${e.direction}`]:e.direction,[e.className]:!!e.className})},[(u(!0),d(w,null,D(e.dataSource,(n,C)=>(u(),d("label",{key:C,class:c(["ded-radio",e.className||""])},[O(m("input",{class:"ded-radio-input",type:"radio",value:n.value,name:n.name,checked:r(n.value),"onUpdate:modelValue":g[0]||(g[0]=h=>a.value=h)},null,8,E),[[_,a.value]]),m("div",{class:c(["ded-radio-icon",r(n.value)?`ded-radio-checked-${e.themeColor}`:`ded-radio-unchecked-${e.themeColor}`])},null,2),m("span",j,k(n.label),1)],2))),128))],2))}};s.__docgenInfo={exportName:"default",displayName:"Radio",description:"",tags:{},props:[{name:"themeColor",type:{name:"string"},defaultValue:{func:!1,value:'"primary"'},values:["primary","secondary","tertiary","success","warning","error","info"]},{name:"dataSource",type:{name:"array"},required:!0},{name:"initValue",type:{name:"string"},required:!0},{name:"direction",type:{name:"string"},defaultValue:{func:!1,value:'"row"'},values:["row","column"]},{name:"className",type:{name:"string"},defaultValue:{func:!1,value:'""'}}],sourceFiles:["/Users/auouser/Desktop/Work_Space/DED-WDS_VUE/libs/src/ui/element/Radio/Radio.vue"]};function y(o){return`[
    ${o.map(a=>`{
        label: '${a.label}',
        value: '${a.value}'
    }`).join(`,
    `)}
  ]`}const F={title:"Component/Radio",component:s,tags:["autodocs"],argTypes:{themeColor:{description:"主題顏色",control:{type:"select"},options:["primary","secondary","tertiary","success","warning","error","info"],table:{type:{summary:"primary | secondary | tertiary | success | warning | error | info"}}},dataSource:{description:"資料來源",control:{type:"object"},table:{type:{summary:"{ label: string; value: string; }[]"}}},initValue:{description:"預設值",control:{type:"text"}},direction:{description:"排列方向",control:{type:"select"},options:["row","column"],table:{type:{summary:"row | column"}}},className:{description:"客製化樣式",control:{type:"text"}}},parameters:{docs:{title:"Radio",description:{component:"Radio 組件的呈現及說明。"}}}},t={name:"預設項目",args:{themeColor:"primary",dataSource:[{label:"Option1",value:"option1"},{label:"Option2",value:"option2"},{label:"Option3",value:"option3"}],initValue:"option1",direction:"row",className:""},render:o=>({components:{Radio:s},setup(){const a=$("");return{args:o,modelValue:a}},template:`
            <Radio  
...
}`,...(v=(N=l.parameters)==null?void 0:N.docs)==null?void 0:v.source}}};const B=["RadioDefaultStory","RadioColorDefault"];export{l as RadioColorDefault,t as RadioDefaultStory,B as __namedExportsOrder,F as default};
