...
`).trim()}}}}},t={name:"標題大小",args:{themeColor:"",className:"",default:"Title"},render:l=>({components:{Title:o},setup(){return{args:l}},template:`
            <Title 
                :themeColor="args.themeColor"
                level="1"
                :className="args.className"
...
`).trim()}}}}},r={name:"主題色彩",args:{level:3,className:"",default:"Title"},render:l=>({components:{Title:o},setup(){return{args:l}},template:`
            <Title
                themeColor="primary"
                :level="args.level"
                :className="args.className"
...
}`,...(N=(v=r.parameters)==null?void 0:v.docs)==null?void 0:N.source}}};const f=["HeadingDefault","HeadingSizeDefault","HeadingColorDefault"];export{r as HeadingColorDefault,s as HeadingDefault,t as HeadingSizeDefault,f as __namedExportsOrder,h as default};
