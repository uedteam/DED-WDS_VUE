import{m as h,u as V,r as u,q as $,z,s as N,c,t as _,e as f,a as x,b as v,k,x as E,T as O,F as C,o as d}from"./vue.esm-bundler-Suj5BAdg.js";import{_ as L}from"./List-D9AQFWoV.js";import{_ as B}from"./Input-CDH1IOlF.js";import{g as P}from"./positionUtils-CIbX64TV.js";import"./Icon-BUi6kykL.js";const j={key:0,class:"ded-input-label"},F=8,T="bottom",p={__name:"Dropdown",props:h({dataSource:{type:Array,required:!0,default:()=>[]},label:{type:String,default:""},placeholder:{type:String,default:"Placeholder"},size:{type:String,validator:a=>["small","medium","large"].includes(a),default:"medium"},className:{type:String,default:""}},{modelValue:{},modelModifiers:{}}),emits:["update:modelValue"],setup(a){const l=V(a,"modelValue"),e=a,t=u(!1),r=u(null),m=u({}),y=o=>{l.value=o,t.value=!1},g=o=>{r.value&&!r.value.contains(o.target)&&(t.value=!1)},n=()=>{if(r.value){const o=r.value.getBoundingClientRect();m.value=P({top:o.top+window.scrollY,left:o.left+window.scrollX},{width:o.width,height:o.height},T,`${F}px`,!0)}};return $(()=>{document.addEventListener("click",g),window.addEventListener("resize",n),window.addEventListener("scroll",n),z(()=>n())}),N(()=>{document.removeEventListener("click",g),window.removeEventListener("resize",n),window.removeEventListener("scroll",n)}),(o,s)=>(d(),c(C,null,[e.label?(d(),c("label",j,_(e.label),1)):f("",!0),x("div",{ref_key:"dropdown",ref:r,class:"ded-dropdown",role:"listbox",tabindex:"0",onClick:s[1]||(s[1]=()=>{t.value=!t.value,n()})},[v(B,{type:"text",size:e.size,placeholder:e.placeholder,isOpen:t.value,className:"ded-dropdown-input",modelValue:l.value,"onUpdate:modelValue":s[0]||(s[0]=S=>l.value=S)},null,8,["size","placeholder","isOpen","modelValue"])],512),(d(),k(O,{to:"body"},[t.value?(d(),c("div",{key:0,class:"ded-tooltip",style:E(m.value)},[v(L,{dataSource:e.dataSource,hasOutline:!0,onOnSelect:y},null,8,["dataSource"])],4)):f("",!0)]))],64))}};p.__docgenInfo={exportName:"default",displayName:"Dropdown",description:"",tags:{},props:[{name:"dataSource",type:{name:"array"},required:!0,defaultValue:{func:!1,value:"[]"}},{name:"label",type:{name:"string"},defaultValue:{func:!1,value:'""'}},{name:"placeholder",type:{name:"string"},defaultValue:{func:!1,value:'"Placeholder"'}},{name:"size",type:{name:"string"},defaultValue:{func:!1,value:'"medium"'},values:["small","medium","large"]},{name:"className",type:{name:"string"},defaultValue:{func:!1,value:'""'}}],sourceFiles:["/Users/auouser/Desktop/Work_Space/DED-WDS_VUE/libs/src/ui/element/Dropdown/Dropdown.vue"]};function A(a){return`[
    ...
    `)}
            ...
            `}),parameters:{controls:{},docs:{source:{transform:(a,l)=>{const{args:e}=l;return["<script setup>",'import { ref } from "vue";','import Dropdown from "@/ui/element/Dropdown/Dropdown.vue";','const modelValue = ref("");',"<\/script>","","<template>","  <Dropdown",`    :dataSource="${A(e.dataSource)}"`,`    ${e.label?`label="${e.label}"`:""}`,`    ${e.placeholder?`placeholder="${e.placeholder}"`:""}`,`    ${e.size?`size="${e.size}"`:""}`,`    ${e.className?`className="${e.className}"`:""}`,'    v-model="modelValue"',"  ></Dropdown>","</template>"].filter(Boolean).join(`
    ...
    docs: {
      source: {
        transform: (src, storyContext) => {
          ...
          return [\`<script setup>\`, 'import { ref } from "vue";', \`import Dropdown from "@/ui/element/Dropdown/Dropdown.vue";\`, 'const modelValue = ref("");', \`<\/script>\`, '', '<template>', '  <Dropdown', \`    :dataSource="\${dataSourceString}"\`, \`    \${args.label ? \`label="\${args.label}"\` : ""}\`, \`    \${args.placeholder ? \`placeholder="\${args.placeholder}"\` : ""}\`, \`    \${args.size ? \`size="\${args.size}"\` : ""}\`, \`    \${args.className ? \`className="\${args.className}"\` : ""}\`, \`    v-model="modelValue"\`, '  ></Dropdown>', '</template>'].filter(Boolean).join('\\n').trim();
        }
      }
    }
  }
