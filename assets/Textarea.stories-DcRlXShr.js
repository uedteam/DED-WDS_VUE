...
`).trim()}}}}},c={name:"顯示標籤",args:{label:"Label",placeholder:"Placeholder...",limit:50,initValue:"",hint:{error:"",description:""},isDisabled:!1,className:""},render:l=>({components:{Textarea:n},setup(){const a=s("");return{args:l,textareaModelValue:a}},template:`
            <Textarea
                :label="args.label"
                :placeholder="args.placeholder"
                :limit="args.limit"
            ...
            ></Textarea>
        `}),parameters:{controls:{exclude:["modelValue","customClass"]},docs:{source:{transform:(l,a)=>{const{args:e}=a,t=g(e.hint);return["<Textarea",`  label="${e.label}"`,`  placeholder="${e.placeholder}"`,`  :limit="${e.limit}"`,`  :initValue="${e.initValue}"`,`  :hint="${t}"`,`  :isDisabled="${e.isDisabled}"`,`  className="${e.className}"`,'  v-model="textareaModelValue"',"></Textarea>"].join(`
`).trim()}}}}},m={name:"字數限制",args:{label:"Label",placeholder:"Placeholder...",limit:50,initValue:"",hint:{error:"",description:""},isDisabled:!1,className:""},render:l=>({components:{Textarea:n},setup(){const a=s("Hello World");return{args:l,textareaModelValue:a}},template:`
            <Textarea
                :label="args.label"
                :placeholder="args.placeholder"
                :limit="args.limit"
...
}`,...(E=(B=p.parameters)==null?void 0:B.docs)==null?void 0:E.source}}};const H=["TextareaDefault","TextareaLabelDefault","TextareaLimit","TextareaStatus"];export{d as TextareaDefault,c as TextareaLabelDefault,m as TextareaLimit,p as TextareaStatus,H as __namedExportsOrder,q as default};
