import{o as a,c as s,t as E,n as k,h as b,w as P,g as y,l as q,q as z,a as i,F as S,C as B,D as _,x as F,e as I,T as V}from"./vue.esm-bundler-C8tbd0VY.js";const j=["href"],D={__name:"BreadcrumbItem",props:{label:{type:String},href:{type:String},isCurrentPage:{type:Boolean}},setup(n){const r=n;return(o,u)=>(a(),s("a",{class:k(r.isCurrentPage?"ded-breadcrumb-item-label":"ded-breadcrumb-item-link"),href:r.href},E(r.label),11,j))}};D.__docgenInfo={exportName:"default",displayName:"BreadcrumbItem",description:"",tags:{},props:[{name:"label",type:{name:"string"}},{name:"href",type:{name:"string"}},{name:"isCurrentPage",type:{name:"boolean"}}],sourceFiles:["D:/98_測試/up/DED-WDS_VUE/libs/src/ui/element/Breadcrumb/BreadcrumbItem.vue"]};const A={class:"ded-breadcrumb"},O={key:0,class:"ded-rest"},M={class:"ded-rest-dropdown-menu"},R=["href"],f={__name:"Breadcrumb",props:{dataSource:{type:Array,required:!0},className:{type:String,default:""}},setup(n){const r=n,o=b([...r.dataSource]);P(()=>r.dataSource,e=>{o.value=[...e]});const u=y(()=>{const e=o.value;return e.length>3?[e[0],{label:"...",href:"#"},...e.slice(-2)]:e}),L=y(()=>{const e=o.value;return e.length>3?e.slice(1,-2):[]}),c=b(!1),d=b({top:0,left:0}),x=e=>{if(c.value=!c.value,c.value){const t=e.target.getBoundingClientRect();d.value={top:t.bottom+window.scrollY+8,left:t.left+window.scrollX},document.addEventListener("click",m)}else document.removeEventListener("click",m)},m=e=>{const t=document.querySelector(".ded-rest"),l=document.querySelector(".ded-rest-label");t&&l&&!t.contains(e.target)&&!l.contains(e.target)&&(c.value=!1,document.removeEventListener("click",m))},g=()=>{if(c.value){const e=document.querySelector(".ded-rest-label");if(e){const t=e.getBoundingClientRect();d.value={top:t.bottom+window.scrollY+8,left:t.left+window.scrollX}}}};return q(()=>{window.addEventListener("resize",g)}),z(()=>{window.removeEventListener("resize",g),document.removeEventListener("click",m)}),(e,t)=>(a(),s("nav",{class:k({"ded-breadcrumb-container":!0,[r.className]:!!r.className})},[i("ol",A,[(a(!0),s(S,null,B(u.value,(l,h)=>(a(),s("li",{class:"ded-breadcrumb-item",key:h},[l.label==="..."?(a(),s("div",O,[i("div",{class:"ded-rest-label",onClick:x},"..."),(a(),_(V,{to:"body"},[c.value?(a(),s("div",{key:0,class:"ded-dropdown-menu",style:F({top:`${d.value.top}px`,left:`${d.value.left}px`,position:"absolute"})},[i("ul",M,[(a(!0),s(S,null,B(L.value,(v,$)=>(a(),s("li",{class:"ded-drop-item",key:$},[i("a",{class:"ded-drop-item-link",href:v.href},E(v.label),9,R)]))),128))])],4)):I("",!0)]))])):(a(),_(D,{key:1,label:l.label,href:l.href,isCurrentPage:h===u.value.length-1},null,8,["label","href","isCurrentPage"]))]))),128))])],2))}};f.__docgenInfo={exportName:"default",displayName:"Breadcrumb",description:"",tags:{},props:[{name:"dataSource",type:{name:"array"},required:!0},{name:"className",type:{name:"string"},defaultValue:{func:!1,value:'""'}}],sourceFiles:["D:/98_測試/up/DED-WDS_VUE/libs/src/ui/element/Breadcrumb/Breadcrumb.vue"]};function T(n){return`[
        ${n.map(r=>`{
            label: "${r.label}",
            href: "${r.href}",
        }`).join(`,
