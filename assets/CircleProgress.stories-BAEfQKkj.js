import{s as b,z as W,w as v,g as t,c as a,d as g,a as l,t as o,n as x,o as n}from"./vue.esm-bundler-DbMeO4i9.js";const _=["width","height"],w=["stroke-width","r","cx","cy"],D=["stroke-width","stroke-dasharray","stroke-dashoffset","r","cx","cy","transform"],V=["y"],L={key:0,class:"ded-progress-circle-label"},S={class:"ded-progress-label"},B={class:"ded-progress-percent"},d={__name:"CircleProgress",props:{label:{type:String,default:""},percent:{type:Number,default:0},size:{type:Number,default:100},strokeWidth:{type:Number,default:10},className:{type:String,default:""}},setup(r){const s=r,e=b(null),f=b(0);W(()=>{e.value&&(f.value=e.value.getComputedTextLength())}),v(()=>s.label,()=>{e.value&&(f.value=e.value.getComputedTextLength())});const u=t(()=>(s.size-s.strokeWidth)/2),p=t(()=>2*Math.PI*u.value),z=t(()=>p.value-s.percent/100*p.value),h=t(()=>Math.min(Math.max(s.percent,0),100)),m=t(()=>s.label?s.label.length*10+s.strokeWidth+30:64);return(E,A)=>(n(),a("div",{class:x({"ded-progress-circle-container":!0,[s.className]:!!s.className})},[(n(),a("svg",{class:"ded-progress",width:s.size,height:s.size},[l("circle",{class:"ded-progress-circle-track",fill:"transparent","stroke-width":s.strokeWidth,r:u.value,cx:s.size/2,cy:s.size/2},null,8,w),l("circle",{class:"ded-progress-circle-percent-form",fill:"transparent","stroke-width":s.strokeWidth,"stroke-dasharray":p.value,"stroke-dashoffset":z.value,"stroke-linecap":"round",r:u.value,cx:s.size/2,cy:s.size/2,transform:`rotate(-90 ${s.size/2} ${s.size/2})`,style:{transition:"stroke-dashoffset 0.35s"}},null,8,D),s.size>=m.value?(n(),a("text",{key:0,class:"ded-progress-label",ref_key:"textRef",ref:e,x:"50%",y:"45%","text-anchor":"middle","font-size":"1em"},o(s.label),513)):g("",!0),s.size>=m.value?(n(),a("text",{key:1,class:"ded-progress-percent-text",x:"50%",y:r.label?"60%":"50%","text-anchor":"middle",dy:".3em","font-size":"1.5em"},o(`${h.value}%`),9,V)):g("",!0)],8,_)),r.size<m.value?(n(),a("div",L,[l("span",S,o(s.label),1),l("span",B,o(`${h.value}%`),1)])):g("",!0)],2))}};d.__docgenInfo={exportName:"default",displayName:"CircleProgress",description:"",tags:{},props:[{name:"label",type:{name:"string"},defaultValue:{func:!1,value:'""'}},{name:"percent",type:{name:"number"},defaultValue:{func:!1,value:"0"}},{name:"size",type:{name:"number"},defaultValue:{func:!1,value:"100"}},{name:"strokeWidth",type:{name:"number"},defaultValue:{func:!1,value:"10"}},{name:"className",type:{name:"string"},defaultValue:{func:!1,value:'""'}}],sourceFiles:["/Users/auouser/Desktop/Work_Space/DED-WDS_VUE/libs/src/ui/element/Progress/CircleProgress/CircleProgress.vue"]};const F={title:"Component/Progress-Circle",component:d,tags:["autodocs"],argTypes:{label:{description:"進度指示標籤",control:{type:"text"}},percent:{description:"進度",required:!0,control:{type:"range",min:0,max:100,step:1},defaultValue:66},size:{description:"直徑",control:{type:"range",min:24,max:200,step:1},defaultValue:50},strokeWidth:{description:"線條寬度",control:{type:"range",min:1,max:20,step:1}},className:{description:"客製化樣式",control:{type:"text"}}},parameters:{docs:{title:"CircleProgress",description:{component:"圓形進度指示組件的呈現及說明。"}}}},c={name:"預設項目",args:{label:"Label",percent:65,size:100,strokeWidth:10,className:""},render:r=>({components:{CircleProgress:d},setup(){return{args:r}},template:`
            <CircleProgress
                :label="args.label"
