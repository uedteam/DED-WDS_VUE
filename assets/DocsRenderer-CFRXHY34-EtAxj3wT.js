const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./index-C_cEWya8.js","./index-Cnq8RY_J.js","./iframe-ospkXBJt.js","./index-DgluPGAH.js","./index-BdOSk9or.js"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from "./iframe-ospkXBJt.js";
import { r as reactExports, i as reactDomExports, H as HeadersMdx, A as AnchorMdx, k as CodeOrSourceMdx, R as React$1, D as Docs } from "./index-Cnq8RY_J.js";
...
var renderElement = async (node, el, rootOptions) => {
  ...
  return root2.render(reactExports.createElement(WithCallback, { callback: resolve }, node)), promise;
  ...
  let root2 = nodes.get(el);
  return root2 || (root2 = clientExports.createRoot(el, rootOptions), nodes.set(el, root2)), root2;
};
var defaultComponents = { code: CodeOrSourceMdx, a: AnchorMdx, ...HeadersMdx }, ErrorBoundary = class extends reactExports.Component {
  ...
  render() {
    ...
    return hasError ? null : React$1.createElement(React$1.Fragment, null, children);
  }
}, DocsRenderer = class {
  constructor() {
    this.render = async (context, docsParameter, element) => {
      ...
      return new Promise((resolve, reject) => {
        __vitePreload(async () => {
          const { MDXProvider } = await import("./index-C_cEWya8.js");
          return { MDXProvider };
        }, true ? __vite__mapDeps([0,1,2,3,4]) : void 0, import.meta.url).then(({ MDXProvider }) => renderElement(React$1.createElement(ErrorBoundary, { showException: reject, key: Math.random() }, React$1.createElement(MDXProvider, { components }, React$1.createElement(TDocs, { context, docsParameter }))), element)).then(() => resolve());
      });
