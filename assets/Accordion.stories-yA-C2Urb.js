import{f as L,w as H,j as J,l as P,o as l,a as d,e as u,n as g,b as x,r as V,c as z,F as f,B as $,C as v,D as _,G as O,d as R,s as q,t as U,x as a}from"./vue.esm-bundler-sK8WeL-9.js";import{s as C}from"./sanitizeHtml-AW0cDGJT.js";import{_ as N}from"./Icon-S8fbNVco.js";import{_ as o}from"./Title-FbeIsecJ.js";import{_ as p}from"./Button-B0fIYfRu.js";import"./iframe-B9_3B7uj.js";import"../sb-preview/runtime.js";const G=["open"],I={class:"ded-accordion-title-content"},K={class:"ded-accordion-title-icon"},X={class:"ded-accordion-detail-content"},F={__name:"AccordionItem",props:{prefix:{type:String},borderStyle:{type:String,default:"",validator:r=>["solid","highlight"].includes(r)},isSmallSize:{type:Boolean,default:!0},isOpen:{type:Boolean,default:!1},className:{type:String,default:""}},setup(r){const e=r,n=L(e.isOpen);H(()=>e.isOpen,i=>{n.value=i});const c=i=>{n.value=i.target.open},s=i=>{const t=i.querySelector(".detail-content");i.open&&t&&t.animate([{opacity:0,height:"0px"},{opacity:1,height:`${t.scrollHeight}px`}],{duration:500,easing:"ease-in-out"})};return J(()=>{document.querySelectorAll("details").forEach(t=>{t.addEventListener("toggle",()=>s(t))})}),P(()=>{document.querySelectorAll("details").forEach(t=>{t.removeEventListener("toggle",()=>{})})}),(i,t)=>(l(),d("li",{class:g(["ded-accordion-item",`ded-accordion-item-${e.borderStyle}`])},[u("details",{open:n.value,class:g({"ded-accordion-detail ":!0,[e.className]:!!e.className}),onToggle:c},[u("summary",{class:g(["ded-accordion-title",e.isSmallSize?"ded-accordion-title-small":"ded-accordion-title-default"])},[u("span",I,[u("span",K,[x(N,{name:e.prefix},null,8,["name"])]),V(i.$slots,"label")]),u("span",{class:g([n.value?"ded-accordion-item-open":"ded-accordion-item-close","ded-icon-medium"])},[x(N,{size:"24",name:"arrow_down"})],2)],2),u("div",X,[V(i.$slots,"detail")])],42,G)],2))}};F.__docgenInfo={exportName:"default",displayName:"AccordionItem",description:"",tags:{},props:[{name:"prefix",type:{name:"string"}},{name:"borderStyle",type:{name:"string"},defaultValue:{func:!1,value:'""'},values:["solid","highlight"]},{name:"isSmallSize",type:{name:"boolean"},defaultValue:{func:!1,value:"true"}},{name:"isOpen",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"className",type:{name:"string"},defaultValue:{func:!1,value:'""'}}],slots:[{name:"label"},{name:"detail"}],sourceFiles:["/Users/auouser/Desktop/Work_Space/DED-WDS_VUE/libs/src/ui/element/Accordion/AccordionItem.vue"]};const Y={class:"ded-accordion-container"},Z=["innerHTML"],ee=["innerHTML"],h={__name:"Accordion",props:{dataSource:{type:Array,required:!0},prefix:{type:String},borderStyle:{type:String,default:"highlight",validator:r=>["solid","highlight"].includes(r)},isSmallSize:{type:Boolean,default:!1},isOpenAll:{type:Boolean,default:!1},className:{type:String,default:""}},setup(r){const e=r,n=z(()=>e.isOpenAll),c=z(()=>e.dataSource.map(s=>({...s,label:typeof s.label=="function"?s.label(a):C(s.label),detail:typeof s.detail=="function"?s.detail(a):C(s.detail)})));return(s,i)=>(l(),d("div",Y,[u("ul",{class:g({"ded-accordion":!0,[e.className]:!!e.className,[`ded-accordion-${e.borderStyle}`]:e.borderStyle})},[(l(!0),d(f,null,$(c.value,t=>(l(),v(F,{key:t.id,prefix:e.prefix,borderStyle:e.borderStyle,isSmallSize:e.isSmallSize,isOpen:n.value},{label:_(()=>[t.label?(l(),d(f,{key:0},[typeof t.label=="object"?(l(),v(O(t.label),{key:0})):(l(),d("span",{key:1,innerHTML:t.label},null,8,Z))],64)):R("",!0)]),detail:_(()=>[(l(!0),d(f,null,$(t.detail,(m,M)=>(l(),d(f,{key:M},[typeof m=="object"&&m.type?(l(),v(O(m),{key:0})):typeof m=="string"?(l(),d("span",{key:1,innerHTML:m},null,8,ee)):(l(),d(f,{key:2},[q(U(m),1)],64))],64))),128))]),_:2},1032,["prefix","borderStyle","isSmallSize","isOpen"]))),128))],2)]))}};h.__docgenInfo={exportName:"default",displayName:"Accordion",description:"",tags:{},props:[{name:"dataSource",type:{name:"array"},required:!0},{name:"prefix",type:{name:"string"}},{name:"borderStyle",type:{name:"string"},defaultValue:{func:!1,value:'"highlight"'},values:["solid","highlight"]},{name:"isSmallSize",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"isOpenAll",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"className",type:{name:"string"},defaultValue:{func:!1,value:'""'}}],sourceFiles:["/Users/auouser/Desktop/Work_Space/DED-WDS_VUE/libs/src/ui/element/Accordion/Accordion.vue"]};function A(r){return`[${r.map(e=>`{
        id: "${e.id}",
