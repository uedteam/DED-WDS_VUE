import{b as r,a as s,_ as o}from"./Column-BGAwU7TE.js";import{k as h,e,L as v,o as y,b as l,a as b,x as U,h as p,d as S,f as B,t as M}from"./vue.esm-bundler-DYHjuIM_.js";import{b as W,d as O}from"./Side-BtBTOM2i.js";import{_ as z}from"./Divider-Ccu5NGc1.js";import{_ as P}from"./Title-BJmfIanQ.js";import{_ as u}from"./Button-BOuLOqV2.js";import{_ as m}from"./Checkbox-DqyRX4bc.js";import{_ as d}from"./Input-DG4exSC1.js";import"./Icon-DeqquNhw.js";const J={class:"ded-login-content"},i={__name:"AuthFlow",props:{bgColorSrc:{type:String,default:""},bgImgSrc:{type:String,default:""},title:{type:String,default:""},className:{type:String,default:""}},setup(t){const n=t;return(a,w)=>(y(),h(v(O),{class:"h-screen"},{default:e(()=>[l(v(W),null,{default:e(()=>[l(r,null,{default:e(()=>[l(s,null,{default:e(()=>[l(o,{md:"12",lg:"5"},{default:e(()=>[b("div",{class:"ded-login-bg",style:U({backgroundImage:n.bgImgSrc?`url(${n.bgImgSrc})`:"none",backgroundRepeat:"no-repeat",backgroundSize:"cover"})},null,4)]),_:1}),l(o,{md:"12",lg:"7"},{default:e(()=>[b("div",J,[l(r,{fluid:""},{default:e(()=>[l(s,{hasGap:""},{default:e(()=>[l(o,{md:"12"},{default:e(()=>[l(P,{level:1},{default:e(()=>[B(M(n.title),1)]),_:1})]),_:1})]),_:1}),a.$slots.description?(y(),h(s,{key:0,hasGap:""},{default:e(()=>[l(o,{md:"12"},{default:e(()=>[p(a.$slots,"description")]),_:3})]),_:3})):S("",!0)]),_:3}),p(a.$slots,"form"),a.$slots.externalLinks?(y(),h(z,{key:0,width:"1px",type:"solid",direction:"horizontal",align:"center",className:""},{default:e(()=>w[0]||(w[0]=[B(" Or ")])),_:1})):S("",!0),p(a.$slots,"externalLinks"),p(a.$slots,"signUp")])]),_:3})]),_:3})]),_:3})]),_:3})]),_:3}))}};i.__docgenInfo={exportName:"default",displayName:"AuthFlow",description:"",tags:{},props:[{name:"bgColorSrc",type:{name:"string"},defaultValue:{func:!1,value:'""'}},{name:"bgImgSrc",type:{name:"string"},defaultValue:{func:!1,value:'""'}},{name:"title",type:{name:"string"},defaultValue:{func:!1,value:'""'}},{name:"className",type:{name:"string"},defaultValue:{func:!1,value:'""'}}],slots:[{name:"description"},{name:"form"},{name:"externalLinks"},{name:"signUp"}],sourceFiles:["/home/runner/work/DED-WDS_VUE/DED-WDS_VUE/libs/src/ui/template/AuthFlow/AuthFlow.vue"]};const et={title:"Template/Auth-Flow",component:{},tags:["autodocs"],argTypes:{bgColorSrc:{description:"背景顏色",control:{type:"text"},table:{category:"PROPS",defaultValue:{summary:""}}},bgImgSrc:{description:"背景圖片",control:{type:"text"},table:{category:"PROPS",defaultValue:{summary:""}}},title:{description:"標題",control:{type:"text"},table:{category:"PROPS",defaultValue:{summary:""}}},className:{description:"客製化樣式",control:{type:"text"},table:{category:"PROPS",defaultValue:{summary:""}}},description:{description:"描述",control:{type:"text"},table:{category:"SLOTS",type:{summary:"Vue Component | HTML"}}},form:{description:"表單",control:{type:"text"},table:{category:"SLOTS",type:{summary:"Vue Component | HTML"}}},externalLinks:{description:"外部連結",control:{type:"text"},table:{category:"SLOTS",type:{summary:"Vue Component | HTML"}}},signUp:{description:"註冊",control:{type:"text"},table:{category:"SLOTS",type:{summary:"Vue Component | HTML"}}}},parameters:{docs:{title:"Auth-Flow",description:{component:"驗證流程的呈現及說明。"}}}},c={name:"登入",args:{bgColorSrc:"https://uedteam.github.io/DED-WDS_REACT/assets/login-bg-color-DyeTUDCt.png",bgImgSrc:"https://uedteam.github.io/DED-WDS_REACT/assets/auth-bg-CfQJDDOf.png",title:"Welcome Back",className:"",description:`<p class="text-neutral-600">Today is a new day. It's your day. You shape it. Sign in to start managing your projects.</p>`,form:`<div><Grid fluid><Row><Column md="12"><Input className="text-primary" type="text" prefix="SvgMail" initValue="" label="Email" placeholder="Email" /></Column><Column md="12"><Input className="text-primary" type="password" prefix="SvgLock" initValue="" label="Password" placeholder="Password" /></Column><Column md="12" class="flex justify-between items-center"><Button variant="text" className="text-neutral-600">Forgot Password?</Button><Checkbox :dataSource="[ { label: 'Remember me', value: '1', isDisabled: 'false' } ]" :initValue="[]" direction="row" size="medium" v-model="vModelData"></Checkbox></Column><Column md="12"><Button variant="filled" width="fluid">Login</Button></Column></Row></Grid></div>`,externalLinks:'<Grid fluid><Row justify="center"><Column md="12" className="flex gap-4 justify-center"><Button className="ded-custom-icon" variant="ghost" prefix="SvgGoogle"></Button><Button className="ded-custom-icon" variant="ghost" prefix="SvgFacebook"></Button><Button className="ded-custom-icon" variant="ghost" prefix="SvgLine"></Button></Column></Row></Grid>',signUp:`<Grid fluid><Row><Column md="12" align="center"><span class="text-neutral-300">Don't have an account?</span><Button class="text-link" variant="text">Sign up</Button></Column></Row></Grid>`},render:t=>({components:{AuthFlow:i,Grid:r,Row:s,Column:o,Checkbox:m,Button:u,Input:d},setup(){return{args:t}},template:`
        ...
        `}),parameters:{controls:{},docs:{source:{transform:(t,n)=>{const{args:a}=n;return[].join(`
...
}`,...(k=(I=g.parameters)==null?void 0:I.docs)==null?void 0:k.source}}};var V,A,$;x.parameters={...x.parameters,docs:{...(V=x.parameters)==null?void 0:V.docs,source:{originalSource:`{
  name: '忘記密碼',
  args: {
    //props
    bgColorSrc: "https://uedteam.github.io/DED-WDS_REACT/assets/login-bg-color-DyeTUDCt.png",
...
}`,...($=(A=x.parameters)==null?void 0:A.docs)==null?void 0:$.source}}};var L,T,E;f.parameters={...f.parameters,docs:{...(L=f.parameters)==null?void 0:L.docs,source:{originalSource:`{
  name: '驗證代碼',
  args: {
    //props
    bgColorSrc: "https://uedteam.github.io/DED-WDS_REACT/assets/login-bg-color-DyeTUDCt.png",
...
}`,...(E=(T=f.parameters)==null?void 0:T.docs)==null?void 0:E.source}}};var F,j,_;C.parameters={...C.parameters,docs:{...(F=C.parameters)==null?void 0:F.docs,source:{originalSource:`{
  name: '設定密碼',
  args: {
    //props
    bgColorSrc: "https://uedteam.github.io/DED-WDS_REACT/assets/login-bg-color-DyeTUDCt.png",
...
}`,...(_=(j=C.parameters)==null?void 0:j.docs)==null?void 0:_.source}}};const at=["authFlowLoginStory","authFlowSignUpStory","authFlowForgetPasswordStory","authFlowVerifyPasswordStory","authFlowSetPasswordStory"];export{at as __namedExportsOrder,x as authFlowForgetPasswordStory,c as authFlowLoginStory,C as authFlowSetPasswordStory,g as authFlowSignUpStory,f as authFlowVerifyPasswordStory,et as default};
