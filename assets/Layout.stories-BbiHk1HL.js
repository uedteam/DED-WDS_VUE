import{_ as o,a as i,b as s,c as r,d as a}from"./Side-BkaqwXDe.js";import"./vue.esm-bundler-CRlgvgXF.js";const I={components:{Layout:a,Header:r,Content:s,Side:i,Footer:o},title:"Component/Layout",tags:["autodocs"],argTypes:{className:{description:"客製化樣式",control:{type:"text"}}},parameters:{docs:{title:"Layout",description:{component:"佈局組件的呈現及說明。"}}}},d={name:"預設項目",args:{className:""},render:e=>({components:{Layout:a,Header:r,Content:s,Side:i,Footer:o},setup(){return{args:e}},template:`
