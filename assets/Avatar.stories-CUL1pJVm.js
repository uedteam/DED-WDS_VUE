import{_ as u}from"./Avatar-C5X_wXpw.js";import"./vue.esm-bundler-Dy0-1sXb.js";import"./Image-KmhcDqSN.js";import"./index-Bb4qSo10.js";import"./Icon-DCPUHzus.js";import"./iframe-RuUkdPfu.js";import"../sb-preview/runtime.js";const x={title:"Design System/Avatar",component:u,tags:["autodocs"],argTypes:{shape:{description:"形狀",control:{type:"select"},options:["circle","square"]},size:{description:"Avatar 尺寸",control:{type:"select"},options:["xsmall","small","medium","large"]},status:{description:"狀態",control:{type:"select"},options:["default","online","idle","busy","offline"]},username:{description:"使用者名稱",control:{type:"text"}},src:{description:"圖片連結",control:{type:"text"}},alt:{description:"圖片描述",control:{type:"text"}},limit:{description:"在 AvatarGroup 中控制顯示的 Avatar 數量上限",control:{type:"number",min:0,max:5,step:1}},className:{description:"客製化樣式",control:{type:"text"}}},parameters:{docs:{title:"Avatar頭像",description:{component:"Avatar 組件的呈現及說明。"}}}},r={name:"預設項目",args:{shape:"circle",size:"large",status:"default",src:"https://picsum.photos/320/240",alt:"alt text",username:"JonyWu",className:""},render:s=>({components:{Avatar:u},setup(){return{args:s}},template:`
            <Avatar
                :shape="args.shape"
                :size="args.size"
