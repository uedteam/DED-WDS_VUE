...
`).trim()}}}}},n={name:"按鈕樣式",args:{themeColor:"primary",variant:"filled",prefix:"",suffix:"",size:"medium",width:"fit",borderWidth:"1px",radius:"4px",isDisabled:!1,className:"",default:"Button"},render:r=>({components:{Button:i},setup(){return{args:r}},template:`<div style="display:flex; flex-wrap: wrap; gap: 16px">
            <Button
                :themeColor="args.themeColor"
                variant="text"
                :prefix="args.prefix"
...
`).trim()}}}}},d={name:"主題色彩",args:{variant:"filled",prefix:"folder",suffix:"",size:"medium",width:"fit",borderWidth:"1px",radius:"4px",isDisabled:!1,className:"",default:"Button"},render:r=>({components:{Button:i},setup(){return{args:r}},template:`<div style="display:flex; flex-wrap: wrap; gap: 16px">
            <Button
                themeColor="primary"
                :variant="args.variant"
                :prefix="args.prefix"
