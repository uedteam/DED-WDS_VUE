import{e as _,g as k,j as b,D as x,K as H,T as S,o as g,M as c,a as y,b as a,r as d,f as $,c as w,d as E}from"./vue.esm-bundler-ChZ6yN_a.js";import{_ as f}from"./Button-Drwd9J9p.js";import"./index-Bb4qSo10.js";import"./Icon-Bq9qvX2Z.js";import"./iframe-BEa0nEL_.js";import"../sb-preview/runtime.js";const s=_(!1),F=()=>({showDialogStatus:s,showDialog:()=>{s.value=!0},closeDialog:()=>{s.value=!1}}),I={class:"dialog-wrapper"},R={class:"dialog-container"},j={class:"dialog-header"},A={class:"dialog-body"},N={class:"dialog-footer"},l={__name:"Dialog",props:{},setup(o){const t=F();return(e,n)=>(g(),k(S,{to:"#dialog"},[b(H,{name:"dialog"},{default:x(()=>[c(t).showDialogStatus.value?(g(),y("div",{key:0,class:"dialog-mask",onClick:n[0]||(n[0]=C=>c(t).closeDialog())},[a("div",I,[a("div",R,[a("div",j,[d(e.$slots,"dialogHeader")]),a("div",A,[d(e.$slots,"dialogBody")]),a("div",N,[d(e.$slots,"dialogFooter")])])])])):$("",!0)]),_:3})]))}};l.__docgenInfo={exportName:"default",displayName:"Dialog",description:"",tags:{},slots:[{name:"dialogHeader"},{name:"dialogBody"},{name:"dialogFooter"}],sourceFiles:["D:/98_測試/up/DED-WDS_VUE/libs/src/ui/element/Dialog/Dialog.vue"]};const z={class:"fakeContent",role:"presentation","aria-hidden":"true"},T={class:"fakeContent--text"},B={__name:"FakeContent",props:{height:{type:String}},setup(o){const t=o,e=w(()=>t.height?`${t.height}px`:"auto");return(n,C)=>(g(),y("div",{style:E({height:e.value})},[a("div",z,[a("p",T,[d(n.$slots,"default")])])],4))}};B.__docgenInfo={exportName:"default",displayName:"FakeContent",description:"",tags:{},props:[{name:"height",type:{name:"string"}}],slots:[{name:"default"}],sourceFiles:["D:/98_測試/up/DED-WDS_VUE/libs/src/ui/utility/FakeContent/FakeContent.vue"]};const O={components:{Dialog:l},title:"Design System/Dialog*",component:l,tags:["autodocs"],argTypes:{dialogHeader:{description:"Dialog 的 header 插槽，適合顯示主題或重要信息，支持 HTML 和文字內容。",control:{type:"text"}},dialogBody:{description:"Dialog 的 body 插槽，用於顯示主要內容。可包含文字、圖片、列表或任何其他組件。",control:{type:"text"}},dialogFooter:{description:"Dialog 的 footer 插槽，通常用於顯示按鈕或其他結尾內容，如確認、取消或其他操作。",control:{type:"text"}}},parameters:{docs:{title:"Dialog",description:{component:"Dialog 組件的呈現及說明。"}}}},i={name:"預設項目",args:{dialogHeader:'<div class="title title-level-2 title-undefined">Replace Image?</div>',dialogBody:'<p>A file named "example.png" already exist! Do you what to replace it?</p>',dialogFooter:`<div style="display: flex; justify-content: flex-end; gap: 16px">
