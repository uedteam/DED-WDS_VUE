import{e as h,w as x,a as o,b as n,F as A,k as D,n as C,o as t,t as g}from"./vue.esm-bundler-ChZ6yN_a.js";const v={"aria-label":"Accordion",class:"accordion__list"},w=["onClick"],k={class:"accordion-header"},$={key:0,style:{width:"24px",height:"24px"}},b={key:1,style:{width:"24px",height:"24px"}},i={__name:"Accordion",props:{dataSource:{type:Array,default:()=>[]},className:{type:String,default:""}},setup(a){const e=a,u=h([...e.dataSource]);x(()=>e.dataSource,s=>{u.value=s.map(r=>({...r,expanded:!1}))});const F=s=>{u.value[s].expanded=!u.value[s].expanded};return(s,r)=>(t(),o("div",{class:C({accordion__container:!0,[e.className]:!!e.className})},[n("ul",v,[(t(!0),o(A,null,D(u.value,(c,m)=>(t(),o("li",{key:m,class:"accordion__item",onClick:p=>F(m)},[n("button",k,[n("span",null,g(c.title),1),c.expanded?(t(),o("div",$,r[0]||(r[0]=[n("svg",{xmlns:"http://www.w3.org/2000/svg",height:"100%",viewBox:"0 -960 960 960",width:"100%",fill:"currentColor"},[n("path",{d:"M480-528 296-344l-56-56 240-240 240 240-56 56-184-184Z"})],-1)]))):(t(),o("div",b,r[1]||(r[1]=[n("svg",{xmlns:"http://www.w3.org/2000/svg",height:"100%",viewBox:"0 -960 960 960",width:"100%",fill:"currentColor"},[n("path",{d:"M480-344 240-584l56-56 184 184 184-184 56 56-240 240Z"})],-1)])))]),n("div",{class:C(["accordion-content",{expanded:c.expanded}])},[(t(!0),o(A,null,D(c.contents,(p,_)=>(t(),o("p",{key:_},g(p),1))),128))],2)],8,w))),128))])],2))}};i.__docgenInfo={exportName:"default",displayName:"Accordion",description:"",tags:{},props:[{name:"dataSource",type:{name:"array"},defaultValue:{func:!1,value:"[]"}},{name:"className",type:{name:"string"},defaultValue:{func:!1,value:'""'}}],sourceFiles:["/Users/auouser/Desktop/Work_Space/DED-WDS_VUE/libs/src/ui/element/Accordion/Accordion.vue"]};const O={title:"Design System/Accordion*",component:i,tags:["autodocs"],argTypes:{dataSource:{description:"資料來源",control:{type:"object"},table:{type:{summary:"{ title: string; content: string[]; }[]"}}},className:{description:"客製化樣式",control:{type:"text"}}},parameters:{docs:{title:"Accordion",description:{component:"Accordion 組件的呈現及說明。"}}}},l={name:"預設項目",args:{dataSource:[{title:"這個產品跟我的設備能兼容嗎？",contents:["使用前先確保這個產品和你的設備是能搭配的，特別是在連接和設置上。","例如，如果你是用舊款設備，建議查看一下產品手冊，確保一切正常！"]}],className:""},render:a=>({components:{Accordion:i},setup(){return{args:a}},template:`
            <Accordion
