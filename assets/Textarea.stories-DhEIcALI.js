import{p as w,u as A,g as L,c as s,d as b,a as f,n as o,t as c,x as F,G as z,s as M,F as u,j as D,l as T,f as v,o as l,h as N}from"./vue.esm-bundler-CC1hEtM-.js";import{v as O}from"./v4-CtRu48qb.js";import{_ as U}from"./Icon-DU5IBFbg.js";import{_ as $}from"./StatusIndicator-Dcvr2h0Y.js";const W=["maxlength","placeholder"],m=Object.assign({inheritAttrs:!1},{__name:"Textarea",props:w({label:{type:String},placeholder:{type:String,default:"Placeholder"},limit:{type:Number,default:30},hint:{type:Object,default:()=>({error:"",description:""})},isDisabled:{type:Boolean,default:!1},className:{type:String,default:""}},{modelValue:{},modelModifiers:{}}),emits:["update:modelValue"],setup(r){const a=r,n=`${O()}-textarea`,t=A(r,"modelValue"),i=L(()=>a.hint.error?"error":a.hint.description?"desc":"");return(B,x)=>(l(),s("div",{class:o(["ded-textarea-container",{[a.className]:!!a.className}])},[a.label?(l(),s("label",{key:0,class:o(["ded-textarea-label",[{"ded-textarea-disable":a.isDisabled}]]),for:n},c(a.label),3)):b("",!0),f("div",{class:o(["ded-textarea-group",[{"ded-textarea-disable":a.isDisabled},i.value?`ded-textarea-border-${i.value}`:""]])},[F(f("textarea",M({id:n,"onUpdate:modelValue":x[0]||(x[0]=j=>t.value=j),class:["ded-textarea",[{"ded-textarea-disable":a.isDisabled}]],maxlength:a.limit>0?a.limit:void 0,placeholder:a.placeholder},B.$attrs),null,16,W),[[z,t.value]]),t.value.length>0&&a.limit!==0?(l(),s("small",{key:0,class:o(["ded-textarea-hint-count",[{"ded-textarea-disable":a.isDisabled}]])},c(t.value.length>0?`${t.value.length} / ${a.limit}`:""),3)):b("",!0)],2),f("small",{class:o(["ded-textarea-hint",[{"ded-textarea-disable":a.isDisabled},`ded-textarea-hint-${i.value}`]])},[a.hint.error?(l(),s(u,{key:0},[typeof a.hint.error=="function"?(l(),D(T(a.hint.error),{key:0})):(l(),s(u,{key:1},[v(c(a.hint.error),1)],64))],64)):a.hint.description?(l(),s(u,{key:1},[typeof a.hint.description=="function"?(l(),D(T(a.hint.description),{key:0})):(l(),s(u,{key:1},[v(c(a.hint.description),1)],64))],64)):b("",!0)],2)],2))}});m.__docgenInfo={exportName:"default",displayName:"Textarea",description:"",tags:{},props:[{name:"label",type:{name:"string"}},{name:"placeholder",type:{name:"string"},defaultValue:{func:!1,value:'"Placeholder"'}},{name:"limit",type:{name:"number"},defaultValue:{func:!1,value:"30"}},{name:"hint",type:{name:"object"},defaultValue:{func:!1,value:`{
  error: "",
  description: ""
}`}},{name:"isDisabled",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"className",type:{name:"string"},defaultValue:{func:!1,value:'""'}}],sourceFiles:["/Users/auouser/Desktop/Work_Space/DED-WDS_VUE/libs/src/ui/element/Textarea/Textarea.vue"]};function d(r){return`{
      error: ${typeof r.error=="function"?`${r.error}`:'""'},
      description: ${typeof r.description=="function"?`${r.description}`:'""'}
}`}const K={title:"Component/Textarea",component:m,tags:["autodocs"],argTypes:{label:{description:"標題",control:{type:"text"}},placeholder:{description:"輸入提示",control:{type:"text"}},limit:{description:"字數限制",control:{type:"number"}},hint:{description:"提示訊息",control:{type:"object"},table:{type:{summary:"{ error: string | VNode; description: string | VNode; }"}}},isDisabled:{description:"是否禁用",control:{type:"boolean"}},className:{description:"客製化樣式",control:{type:"text"}},modelValue:{description:"輸入值",control:{type:"text"},table:{type:{summary:"string"},category:"v-model"}}},parameters:{docs:{title:"Textarea",description:{component:"Textarea 組件的呈現及說明。"}}}},p={name:"預設項目",args:{label:"Label",placeholder:"Placeholder",limit:0,hint:{error:"",description:""},isDisabled:!1,className:"",modelValue:"Type something"},render:r=>({components:{Textarea:m},setup(){return{args:r}},template:`
      <Textarea
        :label="args.label"
...
`).trim()}}}}},g={name:"字數限制",args:{label:"Label",placeholder:"Placeholder",limit:30,hint:{error:"",description:""},isDisabled:!1,className:"",modelValue:"Type something"},render:r=>({components:{Textarea:m},setup(){return{args:r}},template:`
      <Textarea
        :label="args.label"
        :placeholder="args.placeholder"
        :limit="args.limit"
        ...
        v-model="args.modelValue"
      ></Textarea>`}),parameters:{controls:{},docs:{source:{transform:(r,a)=>{const{args:e}=a;return["<script setup>",'import { ref, h } from "vue";','import { Textarea } from "@ded-wds-vue/ui";',`const hint = ${d(e.hint)};`,`const modelValue = ref("${e.modelValue}");`,"<\/script>","","<template>","  <Textarea",`    ${e.label?`label="${e.label}"`:""}`,`    ${e.placeholder?`placeholder="${e.placeholder}"`:""}`,`    ${e.limit!==void 0?`:limit="${e.limit}"`:""}`,'    :hint="hint"',`    ${e.isDisabled!==void 0?`:isDisabled="${e.isDisabled}"`:""}`,`    ${e.className?`className="${e.className}"`:""}`,'    v-model="modelValue"',"  ></Textarea>","</template>"].filter(Boolean).join(`
`).trim()}}}}},h={name:"輸入框狀態",args:{label:"Label",placeholder:"Placeholder",limit:30,hintPrompt:{error:"",description:()=>N($,{themeColor:"neutral",variant:"text",size:"medium",isShowDot:!1},"Prompt message")},hintError:{error:()=>N($,{themeColor:"error",variant:"text",size:"medium",prefix:"SvgErrorCircle",isShowDot:!1},"Error message"),description:""},hint:{error:"",description:""},isDisabled:!1,className:"",modelValue:"Type something"},render:r=>({components:{Textarea:m},setup(){return{args:r,StatusIndicator:$,Icon:U}},template:`
...
`).trim()}}}}};var S,y,V;p.parameters={...p.parameters,docs:{...(S=p.parameters)==null?void 0:S.docs,source:{originalSource:`{
  name: "預設項目",
  args: {
    label: "Label",
...
}`,...(V=(y=p.parameters)==null?void 0:y.docs)==null?void 0:V.source}}};var E,P,C;g.parameters={...g.parameters,docs:{...(E=g.parameters)==null?void 0:E.docs,source:{originalSource:`{
  name: "字數限制",
  args: {
    label: "Label",
    placeholder: "Placeholder",
