import{m as x,u as $,e as m,a as u,t as p,j as g,b as f,n as c,k as _,h as b,C as N,o as r,F as z,f as H}from"./vue.esm-bundler-C7FxdvdM.js";import{_ as V}from"./Icon-B_G9slvJ.js";import{_ as C}from"./ListItem-Bjcgrov6.js";import{_ as E}from"./List-B1_AppfZ.js";import"./iframe-Bn-91BlT.js";import"../sb-preview/runtime.js";const k={class:"dropdown-container"},A={key:0,class:"input-label"},d={__name:"Dropdown",props:x({dataSource:{type:Array,default:()=>[]},label:{type:String},placeholder:{type:String},size:{type:String,validator:a=>["small","medium","large"].includes(a),default:"medium"},maxHeight:{type:String},className:{type:String,default:""}},{modelValue:{},modelModifiers:{}}),emits:["update:modelValue"],setup(a){$(a,"modelValue");const e=a,t=m(null),o=m(!1),y=i=>{t.value=i,o.value=!o};return(i,n)=>(r(),u("div",k,[e.label?(r(),u("label",A,p(e.label),1)):g("",!0),f("div",{ref:"dropdown",class:c(["dropdown",`dropdown-${e.size}`]),role:"listbox",tabindex:"0",onClick:n[0]||(n[0]=l=>o.value=!o.value)},[f("span",{class:c(t.value?"dropdown-selectValue-select":"dropdown-selectValue-unselect")},p(t.value||e.placeholder),3),_(V,{class:c(`icon-${a.size}`),style:{"margin-left":"auto"},name:"arrow_down"},null,8,["class"])],2),o.value?(r(),b(E,{key:1,className:"",isMenu:!0,maxHeight:e.maxHeight},{default:N(()=>[(r(!0),u(z,null,H(e.dataSource,(l,w)=>(r(),b(C,{key:w,label:l.label,value:l.value,href:l.href,onSelectedItem:n[1]||(n[1]=v=>y(v))},null,8,["label","value","href"]))),128))]),_:1},8,["maxHeight"])):g("",!0)]))}};d.__docgenInfo={exportName:"default",displayName:"Dropdown",description:"",tags:{},props:[{name:"dataSource",type:{name:"array"},defaultValue:{func:!1,value:"[]"}},{name:"label",type:{name:"string"}},{name:"placeholder",type:{name:"string"}},{name:"size",type:{name:"string"},defaultValue:{func:!1,value:"'medium'"},values:["small","medium","large"]},{name:"maxHeight",type:{name:"string"}},{name:"className",type:{name:"string"},defaultValue:{func:!1,value:"''"}}],sourceFiles:["D:/98_測試/up/DED-WDS_VUE/libs/src/ui/element/Dropdown/Dropdown.vue"]};function j(a){return`[
    ${a.map(e=>`{
        label: '${e.label}',
        value: '${e.value}',
    }`).join(`,
