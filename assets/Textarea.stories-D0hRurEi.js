import{m as B,u as j,g as z,c as s,d as h,a as g,n as i,t as o,v as A,G as L,q as F,F as d,h as $,k as D,f as T,o as l,y as v}from"./vue.esm-bundler-C-J3VMH8.js";import{v as M}from"./v4-CtRu48qb.js";import{_ as O}from"./Icon-zSSehsRW.js";import{_ as b}from"./StatusIndicator-Cm8hCOBb.js";const U=["maxlength","placeholder"],n=Object.assign({inheritAttrs:!1},{__name:"Textarea",props:B({label:{type:String},placeholder:{type:String,default:"Placeholder"},limit:{type:Number,default:30},hint:{type:Object,default:()=>({error:"",description:""})},isDisabled:{type:Boolean,default:!1},className:{type:String,default:""}},{modelValue:{},modelModifiers:{}}),emits:["update:modelValue"],setup(r){const a=r,f=`${M()}-textarea`,t=j(r,"modelValue"),p=z(()=>a.hint.error?"error":a.hint.description?"desc":"");return(w,x)=>(l(),s("div",{class:i(["ded-textarea-container",{[a.className]:!!a.className}])},[a.label?(l(),s("label",{key:0,class:i(["ded-textarea-label",[{"ded-textarea-disable":a.isDisabled}]]),for:f},o(a.label),3)):h("",!0),g("div",{class:i(["ded-textarea-group",[{"ded-textarea-disable":a.isDisabled},p.value?`ded-textarea-border-${p.value}`:""]])},[A(g("textarea",F({id:f,"onUpdate:modelValue":x[0]||(x[0]=k=>t.value=k),class:["ded-textarea",[{"ded-textarea-disable":a.isDisabled}]],maxlength:a.limit>0?a.limit:void 0,placeholder:a.placeholder},w.$attrs),null,16,U),[[L,t.value]]),t.value.length>0&&a.limit!==0?(l(),s("small",{key:0,class:i(["ded-textarea-hint-count",[{"ded-textarea-disable":a.isDisabled}]])},o(t.value.length>0?`${t.value.length} / ${a.limit}`:""),3)):h("",!0)],2),g("small",{class:i(["ded-textarea-hint",[{"ded-textarea-disable":a.isDisabled},`ded-textarea-hint-${p.value}`]])},[a.hint.error?(l(),s(d,{key:0},[typeof a.hint.error=="function"?(l(),$(D(a.hint.error),{key:0})):(l(),s(d,{key:1},[T(o(a.hint.error),1)],64))],64)):a.hint.description?(l(),s(d,{key:1},[typeof a.hint.description=="function"?(l(),$(D(a.hint.description),{key:0})):(l(),s(d,{key:1},[T(o(a.hint.description),1)],64))],64)):h("",!0)],2)],2))}});n.__docgenInfo={exportName:"default",displayName:"Textarea",description:"",tags:{},props:[{name:"label",type:{name:"string"}},{name:"placeholder",type:{name:"string"},defaultValue:{func:!1,value:'"Placeholder"'}},{name:"limit",type:{name:"number"},defaultValue:{func:!1,value:"30"}},{name:"hint",type:{name:"object"},defaultValue:{func:!1,value:`{
  error: "",
  description: ""
}`}},{name:"isDisabled",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"className",type:{name:"string"},defaultValue:{func:!1,value:'""'}}],sourceFiles:["/Users/auouser/Desktop/Work_Space/DED-WDS_VUE/libs/src/ui/element/Textarea/Textarea.vue"]};const J={title:"Component/Textarea",component:n,tags:["autodocs"],argTypes:{label:{description:"標題",control:{type:"text"}},placeholder:{description:"輸入提示",control:{type:"text"}},limit:{description:"字數限制",control:{type:"number"}},hint:{description:"提示訊息",control:{type:"object"},table:{type:{summary:"{ error: string | VNode; description: string | VNode; }"}}},isDisabled:{description:"是否禁用",control:{type:"boolean"}},className:{description:"客製化樣式",control:{type:"text"}},modelValue:{description:"輸入值",control:{type:"text"},table:{type:{summary:"string"},category:"v-model"}}},parameters:{docs:{title:"Textarea",description:{component:"Textarea 組件的呈現及說明。"}}}},m={name:"預設項目",args:{label:"Label",placeholder:"Placeholder",limit:0,hint:{error:"",description:""},isDisabled:!1,className:"",modelValue:"Type something"},render:r=>({components:{Textarea:n},setup(){return{args:r}},template:`
      <Textarea
        :label="args.label"
...
`).trim()}}}}};var N,y,V;m.parameters={...m.parameters,docs:{...(N=m.parameters)==null?void 0:N.docs,source:{originalSource:`{
  name: "預設項目",
  args: {
    label: "Label",
...
}`,...(V=(y=m.parameters)==null?void 0:y.docs)==null?void 0:V.source}}};var S,C,E;c.parameters={...c.parameters,docs:{...(S=c.parameters)==null?void 0:S.docs,source:{originalSource:`{
  name: "字數限制",
  args: {
    label: "Label",
    placeholder: "Placeholder",
