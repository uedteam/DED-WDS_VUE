import{e as h,q as v,G as C,l as w,b as a,g as u,n as d,t as p,T as _,o as N}from"./vue.esm-bundler-BHaSr8M7.js";import{_ as m}from"./Icon-Cf7dsu_F.js";import{_ as $}from"./Button-BnPpbfUm.js";import"./iframe-D3eZBiwH.js";import"../sb-preview/runtime.js";import"./index-Bb4qSo10.js";const i=h([]),k=e=>{i.value=i.value.filter(o=>o.id!==e)},B=e=>{const o=Date.now(),t={...e,id:o};i.value.push(t)},x=()=>({add:B,remove:k,toasts:i}),b={class:"ded-message"},D={class:"ded-description"};function S(e){switch(e){case"success":return"check";case"error":return"close";case"warning":return"exclamation";case"info":return"info";default:return""}}const l={__name:"Toast",props:{themeColor:{type:String,default:"success",validator:e=>["success","warning","error","info"].includes(e)},title:{type:String},message:{type:String},duration:{type:Number,default:3e3},icon:{type:String,default:""},className:{type:String,default:""}},emits:["close"],setup(e,{emit:o}){const t=o,s=e,c=()=>{t("close")};let n=h(null);const y=()=>{n.value&&clearTimeout(n.value),n.value=setTimeout(()=>{c()},s.duration)};return v(()=>{y()}),C(()=>{n.value&&clearTimeout(n.value)}),(V,E)=>(N(),w(_,{to:"#toast"},[a("div",{class:d(["ded-toast",[`ded-toast-border-${s.themeColor}`,s.className]])},[a("button",{class:"ded-close-button",style:{cursor:"pointer"},onClick:c},[u(m,{name:"close",size:"20"})]),a("p",b,[a("span",{class:d(["ded-icon-wrapper",`ded-toast-${s.themeColor}`])},[u(m,{name:s.icon||S(s.themeColor),size:"14"},null,8,["name"])],2),a("span",null,p(s.title),1)]),a("p",D,p(s.message),1)],2)]))}};l.__docgenInfo={exportName:"default",displayName:"Toast",description:"",tags:{},props:[{name:"themeColor",type:{name:"string"},defaultValue:{func:!1,value:'"success"'},values:["success","warning","error","info"]},{name:"title",type:{name:"string"}},{name:"message",type:{name:"string"}},{name:"duration",type:{name:"number"},defaultValue:{func:!1,value:"3000"}},{name:"icon",type:{name:"string"},defaultValue:{func:!1,value:'""'}},{name:"className",type:{name:"string"},defaultValue:{func:!1,value:'""'}}],events:[{name:"close"}],sourceFiles:["/Users/auouser/Desktop/Work_Space/DED-WDS_VUE/libs/src/ui/element/Toast/Toast.vue"]};const q={components:{Icon:m,Toast:l},title:"Component/Toast",component:l,tags:["autodocs"],argTypes:{themeColor:{description:"主題顏色",control:{type:"select"},options:["success","warning","error","info"],table:{type:{summary:"success | warning | error | info"}}},title:{description:"標題",control:{type:"text"}},message:{description:"說明文字",control:{type:"text"}},duration:{description:"顯示的持續時間（毫秒）",control:{type:"range",min:500,max:1e4,step:500}},icon:{description:"icon",control:{type:"select",labels:{"":"None",home:"home",folder:"folder",academy:"academy","arrow-forward":"arrow-forward","finger-print":"finger-print"}},options:["","home","folder","academy","arrow-forward","finger-print"]},className:{description:"客製化樣式",control:{type:"text"}}},parameters:{docs:{title:"Toast",description:{component:"Toast 組件的呈現及說明。"}}}},r={name:"預設項目",args:{themeColor:"success",title:"Toast Title",message:"Hello, world! This is a toast message.",duration:5e3,icon:"",className:""},render:e=>({components:{Toast:l,Button:$},setup(){const{add:o,toasts:t,remove:s}=x();return{args:e,toasts:t,remove:s,showToast:()=>{o({title:e.title,message:e.message,themeColor:e.themeColor})}}},template:`
            <Toast
...
`).trim()}}}}};var g,T,f;r.parameters={...r.parameters,docs:{...(g=r.parameters)==null?void 0:g.docs,source:{originalSource:`{
  name: "預設項目",
  args: {
    themeColor: "success",
    title: "Toast Title",
...
}`,...(f=(T=r.parameters)==null?void 0:T.docs)==null?void 0:f.source}}};const A=["ToastDefaultNew"];export{r as ToastDefaultNew,A as __namedExportsOrder,q as default};
