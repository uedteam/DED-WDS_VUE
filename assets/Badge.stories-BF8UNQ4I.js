import{_ as n}from"./Badge-BPItHE78.js";import{_ as o}from"./Icon-BUi6kykL.js";import"./vue.esm-bundler-Suj5BAdg.js";const D={title:"Component/Badge",component:n,components:{Icon:o},tags:["autodocs"],argTypes:{themeColor:{description:"主題顏色",control:{type:"select"},options:["primary","secondary","neutral","info","success","warning","error"],table:{type:{summary:"primary | secondary | neutral | info | success | warning | error"}}},isShowDot:{description:"是否顯示圓點",control:{type:"boolean"}},value:{description:"數值",control:{type:"number"}},limit:{description:"數值顯示上限",control:{type:"number"}},className:{description:"客製化樣式",control:{type:"text"}},default:{description:"圖標插槽",control:{type:"text"},table:{type:{summary:"Vue Component | HTML"}}}},parameters:{docs:{title:"Badge",description:{component:"徽章組件的呈現及說明。"}}}},i={name:"預設項目",args:{themeColor:"error",isShowDot:!1,value:100,limit:99,className:"",default:'<Icon name="SvgNotification" size="26"></Icon>'},render:a=>({components:{Badge:n,Icon:o},setup(){return{args:a}},template:`
        ...
        `}),parameters:{controls:{},docs:{source:{transform:(a,s)=>{const{args:e}=s;return["<script setup>",'import Badge from "@/ui/element/Badge/Badge.vue";','import Icon from "@/ui/element/Icon/Icon.vue";',"<\/script>","","<template>","  <Badge",`    ${e.themeColor?`themeColor="${e.themeColor}"`:""}`,`    ${e.isShowDot!==void 0?`:isShowDot="${e.isShowDot}"`:""}`,`    ${e.value!==void 0?`:value="${e.value}"`:""}`,`    ${e.limit!==void 0?`:limit="${e.limit}"`:""}`,`    ${e.className?`className="${e.className}"`:""}`,"  >",'    <Icon name="SvgNotification" size="26"></Icon>',"  </Badge>","</template>"].join(`
`).trim()}}}}},t={name:"外觀類型",args:{themeColor:"error",value:999,limit:99,className:"",default:'<Icon name="SvgNotification" size="26"></Icon>'},render:a=>({components:{Badge:n,Icon:o},setup(){return{args:a}},template:`
        ...
        `}),parameters:{controls:{exclude:["isShowDot"]},docs:{source:{transform:(a,s)=>{const{args:e}=s;return["<script setup>",'import Badge from "@/ui/element/Badge/Badge.vue";','import Icon from "@/ui/element/Icon/Icon.vue";',"<\/script>","","<template>","  <Badge",`    ${e.themeColor?`themeColor="${e.themeColor}"`:""}`,'    :isShowDot="true"',`    ${e.value!==void 0?`:value="${e.value}"`:""}`,`    ${e.limit!==void 0?`:limit="${e.limit}"`:""}`,`    ${e.className?`className="${e.className}"`:""}`,"  >",'    <Icon name="SvgNotification" size="26"></Icon>',"  </Badge>","  <Badge",`    ${e.themeColor?`themeColor="${e.themeColor}"`:""}`,'    :isShowDot="false"',`    ${e.value!==void 0?`:value="${e.value}"`:""}`,`    ${e.limit!==void 0?`:limit="${e.limit}"`:""}`,`    ${e.className?`className="${e.className}"`:""}`,"  >",'    <Icon name="SvgNotification" size="26"></Icon>',"  </Badge>","</template>"].join(`
`).trim()}}}}},l={name:"數值顯示上限",args:{themeColor:"error",isShowDot:!1,value:999,limit:99,className:"",default:'<Icon name="SvgNotification" size="26"></Icon>'},render:a=>({components:{Badge:n,Icon:o},setup(){return{args:a}},template:`
        ...
        `}),parameters:{controls:{},docs:{source:{transform:(a,s)=>{const{args:e}=s;return["<script setup>",'import Badge from "@/ui/element/Badge/Badge.vue";','import Icon from "@/ui/element/Icon/Icon.vue";',"<\/script>","","<template>","  <Badge",`    ${e.themeColor?`themeColor="${e.themeColor}"`:""}`,"    :isShowDot= false",'    :value="98"','    :limit="99"',`    ${e.className?`className="${e.className}"`:""}`,"  >",'    <Icon name="SvgNotification" size="26"></Icon>',"  </Badge>","  <Badge",`    ${e.themeColor?`themeColor="${e.themeColor}"`:""}`,"    :isShowDot= false",'    :value="100"','    :limit="99"',`    ${e.className?`className="${e.className}"`:""}`,"  >",'    <Icon name="SvgNotification" size="26"></Icon>',"  </Badge>","</template>"].join(`
    ...
    docs: {
      source: {
        transform: (src, storyContext) => {
          ...
          return [\`<script setup>\`, \`import Badge from "@/ui/element/Badge/Badge.vue";\`, \`import Icon from "@/ui/element/Icon/Icon.vue";\`, \`<\/script>\`, '', '<template>', '  <Badge', \`    \${args.themeColor ? \`themeColor="\${args.themeColor}"\` : ""}\`, \`    \${args.isShowDot !== undefined ? \`:isShowDot="\${args.isShowDot}"\` : ""}\`, \`    \${args.value !== undefined ? \`:value="\${args.value}"\` : ""}\`, \`    \${args.limit !== undefined ? \`:limit="\${args.limit}"\` : ""}\`, \`    \${args.className ? \`className="\${args.className}"\` : ""}\`, '  >', '    <Icon name="SvgNotification" size="26"></Icon>', '  </Badge>', '</template>'].join('\\n').trim();
        }
      }
    }
  }
    ...
    docs: {
      source: {
        transform: (src, storyContext) => {
          ...
          return [\`<script setup>\`, \`import Badge from "@/ui/element/Badge/Badge.vue";\`, \`import Icon from "@/ui/element/Icon/Icon.vue";\`, \`<\/script>\`, '', '<template>', '  <Badge', \`    \${args.themeColor ? \`themeColor="\${args.themeColor}"\` : ""}\`, \`    :isShowDot="true"\`, \`    \${args.value !== undefined ? \`:value="\${args.value}"\` : ""}\`, \`    \${args.limit !== undefined ? \`:limit="\${args.limit}"\` : ""}\`, \`    \${args.className ? \`className="\${args.className}"\` : ""}\`, '  >', '    <Icon name="SvgNotification" size="26"></Icon>', '  </Badge>', '  <Badge', \`    \${args.themeColor ? \`themeColor="\${args.themeColor}"\` : ""}\`, \`    :isShowDot="false"\`, \`    \${args.value !== undefined ? \`:value="\${args.value}"\` : ""}\`, \`    \${args.limit !== undefined ? \`:limit="\${args.limit}"\` : ""}\`, \`    \${args.className ? \`className="\${args.className}"\` : ""}\`, '  >', '    <Icon name="SvgNotification" size="26"></Icon>', '  </Badge>', '</template>'].join('\\n').trim();
        }
      }
    }
  }
