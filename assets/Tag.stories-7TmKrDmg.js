...
`).trim()}}}}},o={name:"主題色彩",args:{prefix:"",closable:!0,isDisabled:!1,className:""},render:r=>({components:{Tag:n},setup(){const s=C([{id:1,themeColor:"primary",label:"primary"},{id:2,themeColor:"secondary",label:"secondary"},{id:3,themeColor:"tertiary",label:"tertiary"},{id:4,themeColor:"success",label:"success"},{id:5,themeColor:"warning",label:"warning"},{id:6,themeColor:"error",label:"error"},{id:7,themeColor:"info",label:"info"}]);return{args:r,tagsData:s,removeTag:a=>{s.value=s.value.filter(i=>i.id!==a)}}},template:`
            <div style="display:flex; gap: 8px; flex-wrap: wrap">
...
}`,...(u=(b=l.parameters)==null?void 0:b.docs)==null?void 0:u.source}}};var f,T,y;o.parameters={...o.parameters,docs:{...(f=o.parameters)==null?void 0:f.docs,source:{originalSource:`{
  name: "主題色彩",
  args: {
    // themeColor: '',
    // label:'',
...
}`,...(y=(T=o.parameters)==null?void 0:T.docs)==null?void 0:y.source}}};const z=["TagDefaultStory","TagMultiple"];export{l as TagDefaultStory,o as TagMultiple,z as __namedExportsOrder,q as default};
