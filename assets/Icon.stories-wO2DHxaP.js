...
`).trim()}}}}},n={name:"圖標列表",args:{size:"48",color:"#0D64FB"},render:s=>({components:{Icon:_},setup(){return{args:s,icons:a,hoveredIcon:Ns,copiedIcon:c,copyToClipboard:ws}},template:`
...
}`,...(b=(v=n.parameters)==null?void 0:v.docs)==null?void 0:b.source}}};const Es=["IconDefaultStory","IconListStory"];export{e as IconDefaultStory,n as IconListStory,Es as __namedExportsOrder,$s as default};
