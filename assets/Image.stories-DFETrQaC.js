import{_ as o}from"./Image-CfyCKiLL.js";import{_ as f,a as h,b}from"./Row-BnlgQ0Oe.js";import"./vue.esm-bundler-CbCZpGld.js";const j={title:"Component/Image",component:o,tags:["autodocs"],argTypes:{src:{description:"圖片來源",control:{type:"text"}},alt:{description:"圖片替代文字",control:{type:"text"}},ratio:{description:"圖片比例",control:{type:"select"},options:["1x1","4x3","5x4","16x9"],table:{type:{summary:"1x1 | 4x3 | 5x4 | 16x9"}}},objectFit:{description:"圖片填滿方式",control:{type:"select"},options:["none","cover","contain","fill"],table:{type:{summary:"none | cover | contain | fill"}}},className:{description:"客製化樣式",control:{type:"text"}}},parameters:{docs:{title:"圖片",description:{component:"圖片組件的呈現及說明。"}}}},e={name:"預設項目",args:{src:"https://picsum.photos/300/200?random=1",alt:"placeholder",ratio:"1x1",objectFit:"cover",className:""},render:a=>({components:{Image:o,Grid:b,Row:h,Column:f},setup(){return{args:a}},template:`
      <Grid fluid>
        <Row hasGap>
