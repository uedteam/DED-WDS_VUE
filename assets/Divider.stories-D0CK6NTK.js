import{_ as a}from"./Divider-Bik1s36c.js";import"./vue.esm-bundler-CwphvVzG.js";const A={title:"Component/Divider",component:a,tags:["autodocs"],argTypes:{width:{description:"線條寬度",control:{type:"select"},options:["1px","2px","3px","4px","5px"],table:{type:{summary:"1px | 2px | 3px | 4px | 5px"}}},type:{description:"線條樣式",control:{type:"select"},defaultValue:"solid",options:["solid","dashed","dotted"],table:{type:{summary:"solid | dashed | dotted"}}},direction:{description:"線條方向",control:{type:"select"},defaultValue:"horizontal",options:["horizontal","vertical"],table:{type:{summary:"horizontal | vertical"}}},align:{description:"文字位置",control:{type:"select"},options:["start","center","end"],table:{type:{summary:"start | center | end"}}},className:{description:"客製化樣式",control:{type:"text"}},default:{description:"分隔線內容",control:{type:"text"}}},parameters:{docs:{title:"Divider",description:{component:"Divider 組件的呈現及說明。"}}}},t={name:"預設項目",args:{width:"1px",type:"solid",direction:"horizontal",align:"center",default:"Divider",className:""},render:i=>({components:{Divider:a},setup(){return{args:i}},template:`
                <Divider
                    :width="args.width"
                    :type="args.type"
...
`).trim()}}}}},o={name:"線條方向",args:{themeColor:"",width:"1px",type:"solid",className:""},render:i=>({components:{Divider:a},setup(){return{args:i}},template:`
...
`).trim()}}}}};var l,c,g;t.parameters={...t.parameters,docs:{...(l=t.parameters)==null?void 0:l.docs,source:{originalSource:`{
  name: "預設項目",
  args: {
    width: "1px",
    type: "solid",
...
}`,...(g=(c=t.parameters)==null?void 0:c.docs)==null?void 0:g.source}}};var m,p,h;n.parameters={...n.parameters,docs:{...(m=n.parameters)==null?void 0:m.docs,source:{originalSource:`{
  name: "文字對齊",
  args: {
    width: "1px",
    type: "solid",
...
}`,...(h=(p=n.parameters)==null?void 0:p.docs)==null?void 0:h.source}}};var v,u,D;s.parameters={...s.parameters,docs:{...(v=s.parameters)==null?void 0:v.docs,source:{originalSource:`{
  name: "線條粗細",
  args: {
    width: "1px",
    type: "solid",
...
}`,...(D=(u=s.parameters)==null?void 0:u.docs)==null?void 0:D.source}}};var y,N,$;d.parameters={...d.parameters,docs:{...(y=d.parameters)==null?void 0:y.docs,source:{originalSource:`{
  name: "線條類型",
  args: {
    width: "1px",
    direction: "horizontal",
...
}`,...($=(N=d.parameters)==null?void 0:N.docs)==null?void 0:$.source}}};var w,x,C;o.parameters={...o.parameters,docs:{...(w=o.parameters)==null?void 0:w.docs,source:{originalSource:`{
  name: "線條方向",
  args: {
    themeColor: "",
    width: "1px",
...
}`,...(C=(x=o.parameters)==null?void 0:x.docs)==null?void 0:C.source}}};const b=["DividerDefault","DividerContent","DividerWidth","DividerTypes","DividerDirection"];export{n as DividerContent,t as DividerDefault,o as DividerDirection,d as DividerTypes,s as DividerWidth,b as __namedExportsOrder,A as default};
