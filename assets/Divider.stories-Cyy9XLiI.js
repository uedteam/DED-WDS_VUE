import{c,r as V,b as S,n as j,o as g}from"./vue.esm-bundler-g0-RGFhA.js";const E={key:0,class:"ded-divider-content"},r={__name:"Divider",props:{width:{type:String,default:"xsmall",validator:i=>["xsmall","small","medium","large","xlarge"].includes(i)},type:{type:String,default:"solid",validator:i=>["solid","dashed","dotted"].includes(i)},direction:{type:String,default:"horizontal",validator:i=>["horizontal","vertical"].includes(i)},align:{type:String,default:"center",validator:i=>["start","center","end"].includes(i)},className:{type:String,default:""}},setup(i){const a=i;return(e,_)=>(g(),c("div",{class:j(["ded-divider",`ded-divider-${a.direction}`,`ded-divider-width-${a.width}`,`ded-divider-${a.type}`,e.$slots.default?`ded-divider-${a.align}`:"",...a.className.split(" ")])},[e.$slots.default&&e.$slots.default().some(A=>{var o;return(o=A.children)==null?void 0:o.trim()})?(g(),c("div",E,[V(e.$slots,"default")])):S("",!0)],2))}};r.__docgenInfo={exportName:"default",displayName:"Divider",description:"",tags:{},props:[{name:"width",type:{name:"string"},defaultValue:{func:!1,value:'"xsmall"'},values:["xsmall","small","medium","large","xlarge"]},{name:"type",type:{name:"string"},defaultValue:{func:!1,value:'"solid"'},values:["solid","dashed","dotted"]},{name:"direction",type:{name:"string"},defaultValue:{func:!1,value:'"horizontal"'},values:["horizontal","vertical"]},{name:"align",type:{name:"string"},defaultValue:{func:!1,value:'"center"'},values:["start","center","end"]},{name:"className",type:{name:"string"},defaultValue:{func:!1,value:'""'}}],slots:[{name:"default"}],sourceFiles:["/Users/auouser/Desktop/Work_Space/DED-WDS_VUE/libs/src/ui/element/Divider/Divider.vue"]};const k={title:"Component/Divider",component:r,tags:["autodocs"],argTypes:{width:{description:"線條寬度",control:{type:"select"},options:["xsmall","small","medium","large","xlarge"],table:{type:{summary:"xsmall | small | medium | large | xlarge"}}},type:{description:"線條樣式",control:{type:"select"},defaultValue:"solid",options:["solid","dashed","dotted"],table:{type:{summary:"solid | dashed | dotted"}}},direction:{description:"線條方向",control:{type:"select"},defaultValue:"horizontal",options:["horizontal","vertical"],table:{type:{summary:"horizontal | vertical"}}},align:{description:"文字位置",control:{type:"select"},options:["start","center","end"],table:{type:{summary:"start | center | end"}}},className:{description:"客製化樣式",control:{type:"text"}},default:{description:"分隔線內容",control:{type:"text"}}},parameters:{docs:{title:"Divider",description:{component:"Divider 組件的呈現及說明。"}}}},t={name:"預設項目",args:{width:"small",type:"solid",direction:"horizontal",align:"center",default:"Divider",className:""},render:i=>({components:{Divider:r},setup(){return{args:i}},template:`
                <Divider
                    :width="args.width"
                    :type="args.type"
