import{_ as l}from"./Avatar-DC596e6A.js";import"./vue.esm-bundler-BHaSr8M7.js";import"./Image-C6OTXaZU.js";import"./index-Bb4qSo10.js";import"./Icon-BoC-4iYi.js";import"./iframe-gnUhrdvU.js";import"../sb-preview/runtime.js";const f={title:"Component/Avatar",component:l,tags:["autodocs"],argTypes:{shape:{description:"形狀",control:{type:"select"},options:["circle","square"],table:{type:{summary:"circle | square"}}},size:{description:"尺寸",control:{type:"select"},options:["xsmall","small","medium","large"],table:{type:{summary:"xsmall | small | medium | large"}}},status:{description:"狀態",control:{type:"select"},options:["none","online","idle","busy","offline"],table:{type:{summary:"none | online | idle | busy | offline"}}},userName:{description:"使用者名稱",control:{type:"text"}},src:{description:"圖片連結",control:{type:"text"}},alt:{description:"圖片描述",control:{type:"text"}},limit:{description:"在 AvatarGroup 中控制顯示的 Avatar 數量上限",control:{type:"number",min:0,max:5,step:1}},className:{description:"客製化樣式",control:{type:"text"}}},parameters:{docs:{title:"Avatar頭像",description:{component:"Avatar 組件的呈現及說明。"}}}},r={name:"預設項目",args:{shape:"circle",size:"large",status:"none",src:"https://picsum.photos/320/240",alt:"alt text",userName:"JonyWu",className:""},render:a=>({components:{Avatar:l},setup(){return{args:a}},template:`
            <Avatar
                :shape="args.shape"
                :size="args.size"
