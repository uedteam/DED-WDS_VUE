import{p as j,u as A,g as L,c as s,d as b,a as f,n as o,t as c,x as F,G as z,s as M,F as u,j as D,l as T,f as v,o as l,h as N}from"./vue.esm-bundler-CC1hEtM-.js";import{v as O}from"./v4-CtRu48qb.js";import{_ as U}from"./Icon-C3V5hff5.js";import{_ as $}from"./StatusIndicator-DCuv6WFp.js";const W=["maxlength","placeholder"],m=Object.assign({inheritAttrs:!1},{__name:"Textarea",props:j({label:{type:String},placeholder:{type:String,default:"Placeholder"},limit:{type:Number,default:30},hint:{type:Object,default:()=>({error:"",description:""})},isDisabled:{type:Boolean,default:!1},className:{type:String,default:""}},{modelValue:{},modelModifiers:{}}),emits:["update:modelValue"],setup(r){const a=r,n=`${O()}-textarea`,t=A(r,"modelValue"),i=L(()=>a.hint.error?"error":a.hint.description?"desc":"");return(k,x)=>(l(),s("div",{class:o(["ded-textarea-container",{[a.className]:!!a.className}])},[a.label?(l(),s("label",{key:0,class:o(["ded-textarea-label",[{"ded-textarea-disable":a.isDisabled}]]),for:n},c(a.label),3)):b("",!0),f("div",{class:o(["ded-textarea-group",[{"ded-textarea-disable":a.isDisabled},i.value?`ded-textarea-border-${i.value}`:""]])},[F(f("textarea",M({id:n,"onUpdate:modelValue":x[0]||(x[0]=w=>t.value=w),class:["ded-textarea",[{"ded-textarea-disable":a.isDisabled}]],maxlength:a.limit>0?a.limit:void 0,placeholder:a.placeholder},k.$attrs),null,16,W),[[z,t.value]]),t.value.length>0&&a.limit!==0?(l(),s("small",{key:0,class:o(["ded-textarea-hint-count",[{"ded-textarea-disable":a.isDisabled}]])},c(t.value.length>0?`${t.value.length} / ${a.limit}`:""),3)):b("",!0)],2),f("small",{class:o(["ded-textarea-hint",[{"ded-textarea-disable":a.isDisabled},`ded-textarea-hint-${i.value}`]])},[a.hint.error?(l(),s(u,{key:0},[typeof a.hint.error=="function"?(l(),D(T(a.hint.error),{key:0})):(l(),s(u,{key:1},[v(c(a.hint.error),1)],64))],64)):a.hint.description?(l(),s(u,{key:1},[typeof a.hint.description=="function"?(l(),D(T(a.hint.description),{key:0})):(l(),s(u,{key:1},[v(c(a.hint.description),1)],64))],64)):b("",!0)],2)],2))}});m.__docgenInfo={exportName:"default",displayName:"Textarea",description:"",tags:{},props:[{name:"label",type:{name:"string"}},{name:"placeholder",type:{name:"string"},defaultValue:{func:!1,value:'"Placeholder"'}},{name:"limit",type:{name:"number"},defaultValue:{func:!1,value:"30"}},{name:"hint",type:{name:"object"},defaultValue:{func:!1,value:`{
  error: "",
  description: ""
}`}},{name:"isDisabled",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"className",type:{name:"string"},defaultValue:{func:!1,value:'""'}}],sourceFiles:["/home/runner/work/DED-WDS_VUE/DED-WDS_VUE/libs/src/ui/element/Textarea/Textarea.vue"]};function d(r){return`{
