import{_}from"./Button-DEgBvR4f.js";import{r as i,E as S,J as C,c as d,a as f,j as E,h as D,n as g,b as V,e as k,K as M,T as z,F as H,I as y,o as p,d as T,k as I,f as L,t as R}from"./vue.esm-bundler-DkGXwu1Q.js";import{g as F}from"./positionUtils-CIbX64TV.js";import{v as U}from"./v4-CtRu48qb.js";import"./Icon-YhCiAXtM.js";const j={class:"ded-tooltip-content"},m={__name:"Tooltip",props:{content:{type:String,default:""},placement:{type:String,default:"top",validator:n=>["top-left","top","top-right","right-top","right","right-bottom","bottom-right","bottom","bottom-left","left-top","left","left-bottom"].includes(n)},showArrow:{type:Boolean,default:!0},className:{type:String,default:""}},setup(n){const o=n,t=i(null),h=i(null),v=i({}),w=`tooltip-${U()}`,s=i(!1);function N(){s.value=!0,y(l)}function $(){s.value=!1}async function l(){if(!t.value||!h.value||!s.value)return;await y();const e=t.value.getBoundingClientRect(),r={top:e.top+window.scrollY,left:e.left+window.scrollX},a={width:e.width,height:e.height},u="6px";v.value=F(r,a,o.placement,u,!1)}function x(e,r){let a;return function(...u){a||(e.apply(this,u),a=!0,setTimeout(()=>a=!1,r))}}return S(()=>{const e=x(l,100);window.addEventListener("scroll",e),window.addEventListener("resize",e)}),C(()=>{window.removeEventListener("scroll",l),window.removeEventListener("resize",l)}),(e,r)=>(p(),d(H,null,[f("div",{ref_key:"tooltipTriggerRef",ref:t,class:g(["ded-tooltip-container",{[o.className]:!!o.className}]),"aria-describedby":w,onMouseenter:N,onMouseleave:$},[D(e.$slots,"default")],34),(p(),E(z,{to:"body"},[V(M,{name:"fade"},{default:k(()=>[s.value?(p(),d("div",{key:0,id:w,ref_key:"tooltipContentRef",ref:h,style:I(v.value),class:g(["ded-tooltip",`ded-tooltip-${o.placement}`])},[f("div",j,[L(R(o.content)+" ",1),o.showArrow?(p(),d("div",{key:0,class:g(["ded-tooltip-arrow",`ded-tooltip-arrow-${o.placement}`])},[...r[0]||(r[0]=[f("div",{class:"ded-tooltip-arrow-shape"},null,-1)])],2)):T("",!0)])],6)):T("",!0)]),_:1})]))],64))}};m.__docgenInfo={exportName:"default",displayName:"Tooltip",description:"",tags:{},props:[{name:"content",type:{name:"string"},defaultValue:{func:!1,value:'""'}},{name:"placement",type:{name:"string"},defaultValue:{func:!1,value:'"top"'},values:["top-left","top","top-right","right-top","right","right-bottom","bottom-right","bottom","bottom-left","left-top","left","left-bottom"]},{name:"showArrow",type:{name:"boolean"},defaultValue:{func:!1,value:"true"}},{name:"className",type:{name:"string"},defaultValue:{func:!1,value:'""'}}],slots:[{name:"default"}],sourceFiles:["/home/runner/work/DED-WDS_VUE/DED-WDS_VUE/libs/src/ui/element/Tooltip/Tooltip.vue"]};const Y={components:{Tooltip:m},title:"Component/Tooltip",component:m,tags:["autodocs"],argTypes:{content:{description:"提示內容",control:{type:"text"}},placement:{description:"提示框位置",control:{type:"select"},options:["top-left","top","top-right","right-top","right","right-bottom","bottom-right","bottom","bottom-left","left-bottom","left","left-top"],table:{type:{summary:"top-left | top | top-right | right-top | right | right-bottom | bottom-right | bottom | bottom-left | left-bottom | left | left-top "}}},showArrow:{description:"是否顯示箭頭",control:{type:"boolean"}},className:{description:"客製化樣式",control:{type:"text"}},default:{description:"觸發器插槽",control:{type:"text"},table:{type:{summary:"Vue Component | HTML"}}}},parameters:{docs:{title:"Tooltip",description:{component:"提示工具組件的呈現及說明。"}}}},c={name:"預設項目",args:{content:"good day",placement:"top",showArrow:!0,className:"",default:'<Button variant="contained" size="large" prefix="SvgAccount">Hover Me</Button>'},render:n=>({components:{Tooltip:m,Button:_},setup(){return{args:n}},template:`
...
}`,...(B=(A=c.parameters)==null?void 0:A.docs)==null?void 0:B.source}}};const q=["DefaultTooltip"];export{c as DefaultTooltip,q as __namedExportsOrder,Y as default};
