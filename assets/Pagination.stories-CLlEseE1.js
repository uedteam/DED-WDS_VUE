import{a as j}from"./index-B-lxVbXh.js";import{k as O,g as I,w as v,c,d as L,a as r,l as T,f as C,t as p,J as U,F as b,h as _,b as l,e as f,n as x,o as u,j as W}from"./vue.esm-bundler-CeRU4-k3.js";import{_ as h}from"./Button-DdqUyGHd.js";import{_ as $}from"./Icon-BO2J-day.js";import"./v4-CtRu48qb.js";const J={key:0,class:"ded-pagination-info"},G={class:"ded-pagination-info-text"},H={class:"ded-pagination-info-highline"},K={class:"ded-pagination-info-highline"},Q={class:"ded-pagination-info-highline"},R=["value"],X={class:"ded-pagination"},Y={class:"ded-button-content"},Z={class:"ded-pagination-number"},D=10,w={__name:"Pagination",props:{totalItems:{type:Number,required:!0},currentPage:{type:Number,default:1},itemsPerPageOptions:{type:Array,required:!0},defaultItemsPerPage:{type:Number,default:10},isShowPageInfo:{type:Boolean,default:!1},className:{type:String,default:""}},emits:["onPageChange"],setup(i,{emit:m}){const e=m,n=i,s=O(n.currentPage),g=O(n.isShowPageInfo?n.itemsPerPageOptions[0]:n.defaultItemsPerPage),P=I(()=>Math.ceil(n.totalItems/g.value)),y=I(()=>Math.max(1,s.value-Math.floor(D/2))),z=I(()=>Math.min(P.value,y.value+D-1)),M=I(()=>Array.from({length:z.value-y.value+1},(t,a)=>y.value+a)),d=t=>{t<1||t>P.value||(s.value=t,e("onPageChange",t,g.value))},q=t=>{const a=parseInt(t.target.value,10);g.value=a,s.value=1,e("onPageChange",1,a)};return v(()=>n.currentPage,t=>{t>0&&t<=P.value&&(s.value=t)}),v(()=>n.defaultItemsPerPage,t=>{t>0&&(g.value=t)}),v(()=>n.isShowPageInfo,t=>{t&&n.itemsPerPageOptions.length>0&&(g.value=n.itemsPerPageOptions[0])}),v(()=>n.itemsPerPageOptions,t=>{n.isShowPageInfo&&t.length>0&&(g.value=t[0])}),(t,a)=>(u(),c("div",{class:x(`ded-pagination-container ${i.className}`)},[n.isShowPageInfo?(u(),c("div",J,[r("div",G,[a[5]||(a[5]=C(" 共 ")),r("span",H,p(n.totalItems),1),a[6]||(a[6]=C(" 筆資料，第 ")),r("span",K,p(s.value),1),a[7]||(a[7]=C(" / ")),r("span",Q,p(P.value),1),a[8]||(a[8]=C(" 頁 每頁顯示 "))]),T(r("select",{"onUpdate:modelValue":a[0]||(a[0]=o=>g.value=o),onChange:q,class:"ded-pagination-select"},[(u(!0),c(b,null,_(n.itemsPerPageOptions,o=>(u(),c("option",{key:o,value:o},p(o),9,R))),128))],544),[[U,g.value]]),a[9]||(a[9]=r("span",null,"筆",-1))])):L("",!0),r("div",X,[l(h,{variant:"ghost","theme-color":"neutral","is-disabled":s.value===1,class:"ded-pagination-button",onClick:a[1]||(a[1]=()=>d(1))},{default:f(()=>[l($,{name:"SvgFirstLastPage",size:"18",class:"ded-pagination-button-first"})]),_:1},8,["is-disabled"]),l(h,{variant:"ghost","theme-color":"neutral","is-disabled":s.value===1,class:"ded-pagination-button",onClick:a[2]||(a[2]=()=>d(s.value-1))},{default:f(()=>[l($,{name:"SvgNavigateArrow",size:"18",class:"ded-pagination-button-first"})]),_:1},8,["is-disabled"]),(u(!0),c(b,null,_(M.value,o=>(u(),W(h,{key:o,variant:"ghost","theme-color":"neutral",class:x(["ded-pagination-button",{"ded-pagination-active":s.value===o}]),onClick:()=>d(o)},{default:f(()=>[r("div",Y,[r("div",Z,p(o),1)])]),_:2},1032,["class","onClick"]))),128)),l(h,{variant:"ghost","theme-color":"neutral","is-disabled":s.value===P.value,class:"ded-pagination-button",onClick:a[3]||(a[3]=()=>d(s.value+1))},{default:f(()=>[l($,{name:"SvgNavigateArrow",size:"18"})]),_:1},8,["is-disabled"]),l(h,{variant:"ghost","theme-color":"neutral","is-disabled":s.value===P.value,class:"ded-pagination-button",onClick:a[4]||(a[4]=()=>d(P.value))},{default:f(()=>[l($,{name:"SvgFirstLastPage",size:"18"})]),_:1},8,["is-disabled"])])],2))}};w.__docgenInfo={exportName:"default",displayName:"Pagination",description:"",tags:{},props:[{name:"totalItems",type:{name:"number"},required:!0},{name:"currentPage",type:{name:"number"},defaultValue:{func:!1,value:"1"}},{name:"itemsPerPageOptions",type:{name:"array"},required:!0},{name:"defaultItemsPerPage",type:{name:"number"},defaultValue:{func:!1,value:"10"}},{name:"isShowPageInfo",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"className",type:{name:"string"},defaultValue:{func:!1,value:'""'}}],events:[{name:"onPageChange"}],sourceFiles:["/home/runner/work/DED-WDS_VUE/DED-WDS_VUE/libs/src/ui/element/Pagination/Pagination.vue"]};const oe={title:"Component/Pagination",component:w,tags:["autodocs"],argTypes:{totalItems:{description:"總筆數",control:{type:"number"}},currentPage:{description:"目前頁數",control:{type:"number"}},itemsPerPageOptions:{description:"每頁顯示筆數選項",control:{type:"object"},table:{type:{summary:"number[]"}}},defaultItemsPerPage:{description:"預設每頁顯示筆數",control:{type:"number"}},isShowPageInfo:{description:"是否顯示頁數資訊",control:{type:"boolean"}},className:{description:"客製化樣式",control:{type:"text"}},onPageChange:{description:"頁碼變更事件",control:!1,table:{category:"EVENTS",type:{summary:"emits"}}}},parameters:{docs:{title:"Pagination",description:{component:"頁碼組件的呈現及說明。"}}}},N={name:"預設項目",args:{totalItems:100,currentPage:1,itemsPerPageOptions:[10,20,50],defaultItemsPerPage:5,isShowPageInfo:!1,className:""},render:i=>({components:{Pagination:w},setup(){return{args:i,handlePageChange:j("onPageChange")}},template:`
...
}`,...(E=(A=N.parameters)==null?void 0:A.docs)==null?void 0:E.source}}};var B,F,V;S.parameters={...S.parameters,docs:{...(B=S.parameters)==null?void 0:B.docs,source:{originalSource:`{
  name: "顯示資訊",
  args: {
    totalItems: 100,
    currentPage: 1,
