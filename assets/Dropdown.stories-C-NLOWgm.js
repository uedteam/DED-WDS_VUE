import{m as h,u as V,s as u,A as $,D as z,B as N,c,d as f,a as _,h as x,t as k,b as v,j as E,T as O,F as B,o as d}from"./vue.esm-bundler-C-J3VMH8.js";import{_ as C}from"./Input-DMqb6Dzh.js";import{_ as L}from"./List-D_vn39uJ.js";import{g as P}from"./positionUtils-CIbX64TV.js";import"./Icon-zSSehsRW.js";import"./v4-CtRu48qb.js";const j={key:0,class:"ded-input-label"},A=8,F="bottom",p={__name:"Dropdown",props:h({dataSource:{type:Array,required:!0},label:{type:String,default:""},placeholder:{type:String,default:"Placeholder"},size:{type:String,validator:o=>["small","medium","large"].includes(o),default:"medium"},className:{type:String,default:""}},{modelValue:{},modelModifiers:{}}),emits:["update:modelValue"],setup(o){const a=o,e=V(o,"modelValue"),l=u(!1),r=u(null),m=u({});function y(t){e.value=t,l.value=!1}function g(t){r.value&&!r.value.contains(t.target)&&(l.value=!1)}function n(){if(r.value){const t=r.value.getBoundingClientRect();m.value=P({top:t.top+window.scrollY,left:t.left+window.scrollX},{width:t.width,height:t.height},F,`${A}px`,!0)}}return $(()=>{document.addEventListener("click",g),window.addEventListener("resize",n),window.addEventListener("scroll",n),z(()=>n())}),N(()=>{document.removeEventListener("click",g),window.removeEventListener("resize",n),window.removeEventListener("scroll",n)}),(t,s)=>(d(),c(B,null,[a.label?(d(),c("label",j,k(a.label),1)):f("",!0),_("div",{ref_key:"dropdown",ref:r,class:"ded-dropdown",role:"listbox",tabindex:"0",onClick:s[1]||(s[1]=()=>{l.value=!l.value,n()})},[v(C,{modelValue:e.value,"onUpdate:modelValue":s[0]||(s[0]=D=>e.value=D),type:"text",size:a.size,placeholder:a.placeholder,"is-open":l.value,"class-name":"ded-dropdown-input"},null,8,["modelValue","size","placeholder","is-open"])],512),(d(),x(O,{to:"body"},[l.value?(d(),c("div",{key:0,class:"ded-tooltip",style:E(m.value)},[v(L,{"data-source":a.dataSource,"has-outline":!0,onOnSelect:y},null,8,["data-source"])],4)):f("",!0)]))],64))}};p.__docgenInfo={exportName:"default",displayName:"Dropdown",description:"",tags:{},props:[{name:"dataSource",type:{name:"array"},required:!0},{name:"label",type:{name:"string"},defaultValue:{func:!1,value:'""'}},{name:"placeholder",type:{name:"string"},defaultValue:{func:!1,value:'"Placeholder"'}},{name:"size",type:{name:"string"},defaultValue:{func:!1,value:'"medium"'},values:["small","medium","large"]},{name:"className",type:{name:"string"},defaultValue:{func:!1,value:'""'}}],sourceFiles:["/Users/auouser/Desktop/Work_Space/DED-WDS_VUE/libs/src/ui/element/Dropdown/Dropdown.vue"]};function T(o){return`    ${o.map(a=>`{
        label: "${a.label}",
        value: "${a.value}",
    }`).join(`,
...
}`,...(S=(b=i.parameters)==null?void 0:b.docs)==null?void 0:S.source}}};const Y=["DropdownDefault"];export{i as DropdownDefault,Y as __namedExportsOrder,X as default};
