...
`).trim()}}}}};var N,C,w;p.parameters={...p.parameters,docs:{...(N=p.parameters)==null?void 0:N.docs,source:{originalSource:`{
  name: "預設項目",
  args: {
    dataSource: [{
      label: "Home",
...
}`,...(w=(C=p.parameters)==null?void 0:C.docs)==null?void 0:w.source}}};const G=["BreadcrumbMany"];export{p as BreadcrumbMany,G as __namedExportsOrder,Y as default};
