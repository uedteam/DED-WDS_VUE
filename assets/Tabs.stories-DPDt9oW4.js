...
`).trim()}}}}},o={name:"卡片式頁籤",args:{themeColor:"primary",dataSource:[{title:"Tab 1",content:"Content 1"},{title:"Tab 2",content:"Content 2"},{title:"Tab 3",content:"Content 3"}],activeIndex:0,type:"card",isDisabled:!1,className:""},render:a=>({components:{Tabs:i},setup(){return{args:a}},template:`
            <Tabs
                :themeColor="args.themeColor"
                :dataSource="args.dataSource"
                :activeIndex="args.activeIndex"
...
}`,...(D=(C=o.parameters)==null?void 0:C.docs)==null?void 0:D.source}}};const B=["DefaultTabs","CardTabs"];export{o as CardTabs,r as DefaultTabs,B as __namedExportsOrder,w as default};
