...
`).trim()}}}}},o={name:"隔線系統-4欄",args:{fluid:!1,className:"",g:"3",gx:"",gy:"0",align:"stretch",justify:"start",col:"12",sm:"6",md:"4",lg:"3",xl:"",xxl:""},render:n=>({components:{Grid:t,Row:i,Column:d},setup(){return{args:n}},template:`
                <Grid :fluid="args.fluid" :className="args.className">
                    <Row :g="args.g" :gx="args.gx" :gy="args.gy" :justify="args.start" :align="args.align">
                        <Column v-for="(index) in 12" :key="index" 
                            :col="args.col" :sm="args.sm" :md="args.md" :lg="args.lg" :xl="args.xl" :xxl="args.xxl">
            ...
            `}),parameters:{controls:{include:["fluid","className","justify","align","g","gx","gy","col","sm","md","lg","xl","xxl"]},docs:{source:{transform:(n,e)=>{const{args:l}=e;return["<Grid",`  :fluid="${l.fluid}"`,`  className="${l.className}"`,">","  <Row",`    g="${l.g}"`,`    gx="${l.gx}"`,`    gy="${l.gy}"`,`    justify="${l.start}"`,`    align="${l.align}"`,"  >",'    <Column v-for="(index) in 12" :key="index"',`      col="${l.col}"`,`      sm="${l.sm}"`,`      md="${l.md}"`,`      lg="${l.lg}"`,`      xl="${l.xl}"`,`      xxl="${l.xxl}"`,"    >",'      <div class="diagonal-background" style="border:1px solid #ccc; padding:8px 16px;">',"        Column {{index}}","      </div>","    </Column>","  </Row>","</Grid>"].join(`
`).trim()}}}}},c={name:"隔線系統-3欄",args:{fluid:!1,className:"",g:"3",gx:"",gy:"0",align:"stretch",justify:"start",col:"12",sm:"6",md:"4",lg:"",xl:"",xxl:""},render:n=>({components:{Grid:t,Row:i,Column:d},setup(){return{args:n}},template:`
                <Grid :fluid="args.fluid" :className="args.className">
                    <Row :g="args.g" :gx="args.gx" :gy="args.gy" :justify="args.start" :align="args.align">
                        <Column v-for="(index) in 12" :key="index" 
                            :col="args.col" :sm="args.sm" :md="args.md" :lg="args.lg" :xl="args.xl" :xxl="args.xxl">
            ...
            `}),parameters:{controls:{include:["fluid","className","justify","align","g","gx","gy","col","sm","md","lg","xl","xxl"]},docs:{source:{transform:(n,e)=>{const{args:l}=e;return["<Grid",`  :fluid="${l.fluid}"`,`  className="${l.className}"`,">","  <Row",`    g="${l.g}"`,`    gx="${l.gx}"`,`    gy="${l.gy}"`,`    justify="${l.start}"`,`    align="${l.align}"`,"  >",'    <Column v-for="(index) in 12" :key="index"',`      col="${l.col}"`,`      sm="${l.sm}"`,`      md="${l.md}"`,`      lg="${l.lg}"`,`      xl="${l.xl}"`,`      xxl="${l.xxl}"`,"    >",'      <div class="diagonal-background" style="border:1px solid #ccc; padding:8px 16px;">',"        Column {{index}}","      </div>","    </Column>","  </Row>","</Grid>"].join(`
`).trim()}}}}},m={name:"隔線系統-2欄",args:{fluid:!1,className:"",g:"3",gx:"",gy:"0",align:"stretch",justify:"start",col:"12",sm:"6",md:"",lg:"",xl:"",xxl:""},render:n=>({components:{Grid:t,Row:i,Column:d},setup(){return{args:n}},template:`
                <Grid :fluid="args.fluid" :className="args.className">
                    <Row :g="args.g" :gx="args.gx" :gy="args.gy" :justify="args.start" :align="args.align">
                        <Column v-for="(index) in 12" :key="index" 
                            :col="args.col" :sm="args.sm" :md="args.md" :lg="args.lg" :xl="args.xl" :xxl="args.xxl">
            ...
            `}),parameters:{controls:{include:["fluid","className","justify","align","g","gx","gy","col","sm","md","lg","xl","xxl"]},docs:{source:{transform:(n,e)=>{const{args:l}=e;return["<Grid",`  :fluid="${l.fluid}"`,`  className="${l.className}"`,">","  <Row",`    g="${l.g}"`,`    gx="${l.gx}"`,`    gy="${l.gy}"`,`    justify="${l.start}"`,`    align="${l.align}"`,"  >",'    <Column v-for="(index) in 12" :key="index"',`      col="${l.col}"`,`      sm="${l.sm}"`,`      md="${l.md}"`,`      lg="${l.lg}"`,`      xl="${l.xl}"`,`      xxl="${l.xxl}"`,"    >",'      <div class="diagonal-background" style="border:1px solid #ccc; padding:8px 16px;">',"        Column {{index}}","      </div>","    </Column>","  </Row>","</Grid>"].join(`
`).trim()}}}}},f={name:"隔線系統-1欄",args:{fluid:!1,className:"",g:"3",gx:"",gy:"0",align:"stretch",justify:"start",col:"12",sm:"",md:"",lg:"",xl:"",xxl:""},render:n=>({components:{Grid:t,Row:i,Column:d},setup(){return{args:n}},template:`
                <Grid :fluid="args.fluid" :className="args.className">
                    <Row :g="args.g" :gx="args.gx" :gy="args.gy" :justify="args.start" :align="args.align">
                        <Column v-for="(index) in 12" :key="index" 
                            :col="args.col" :sm="args.sm" :md="args.md" :lg="args.lg" :xl="args.xl" :xxl="args.xxl">
