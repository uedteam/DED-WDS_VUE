import{e as k,q as D,w as L,c as a,a as t,b as i,n as P,t as c,f as C,o as l}from"./vue.esm-bundler-ChZ6yN_a.js";const V=["width","height"],S=["stroke-width","r","cx","cy"],E=["stroke-width","stroke-dasharray","stroke-dashoffset","r","cx","cy","transform"],A=["y"],j={key:0,class:"progress-circle-label"},o={__name:"CircleProgress",props:{themeColor:{type:String,default:"primary",validator:s=>["primary","secondary","tertiary","success","warning","error","info"].includes(s)},label:{type:String,default:"Label"},percent:{type:Number,default:0},size:{type:Number,default:100},strokeWidth:{type:Number,default:10},className:{type:String,default:""}},setup(s){const r=s,e=k(null),n=k(0);D(()=>{e.value&&(n.value=e.value.getComputedTextLength())}),L(()=>r.label,()=>{e.value&&(n.value=e.value.getComputedTextLength())});const h=a(()=>(r.size-r.strokeWidth)/2),p=a(()=>2*Math.PI*h.value),_=a(()=>p.value-r.percent/100*p.value),b=a(()=>Math.min(Math.max(r.percent,0),100)),u=a(()=>n.value?n.value+r.strokeWidth+30:64);return(F,B)=>(l(),t("div",{class:P({"progress-circle-container":!0,[r.className]:!!r.className})},[(l(),t("svg",{class:"progress",width:r.size,height:r.size},[i("circle",{class:"progress-circle-track",fill:"transparent","stroke-width":r.strokeWidth,r:h.value,cx:r.size/2,cy:r.size/2},null,8,S),i("circle",{class:P(`progress-circle-percent-${r.themeColor}`),fill:"transparent","stroke-width":r.strokeWidth,"stroke-dasharray":p.value,"stroke-dashoffset":_.value,"stroke-linecap":"round",r:h.value,cx:r.size/2,cy:r.size/2,transform:`rotate(-90 ${r.size/2} ${r.size/2})`,style:{transition:"stroke-dashoffset 0.35s"}},null,10,E),r.size>=u.value?(l(),t("text",{key:0,ref_key:"textRef",ref:e,x:"50%",y:"45%","text-anchor":"middle","font-size":"1em",fill:"black"},c(r.label),513)):C("",!0),r.size>=u.value?(l(),t("text",{key:1,x:"50%",y:s.label?"60%":"50%","text-anchor":"middle",dy:".3em","font-size":"1.5em",fill:"black"},c(`${b.value}%`),9,A)):C("",!0)],8,V)),s.size<u.value?(l(),t("div",j,[i("span",null,c(r.label),1),i("span",null,c(`${b.value}%`),1)])):C("",!0)],2))}};o.__docgenInfo={exportName:"default",displayName:"CircleProgress",description:"",tags:{},props:[{name:"themeColor",type:{name:"string"},defaultValue:{func:!1,value:'"primary"'},values:["primary","secondary","tertiary","success","warning","error","info"]},{name:"label",type:{name:"string"},defaultValue:{func:!1,value:'"Label"'}},{name:"percent",type:{name:"number"},defaultValue:{func:!1,value:"0"}},{name:"size",type:{name:"number"},defaultValue:{func:!1,value:"100"}},{name:"strokeWidth",type:{name:"number"},defaultValue:{func:!1,value:"10"}},{name:"className",type:{name:"string"},defaultValue:{func:!1,value:'""'}}],sourceFiles:["D:/98_測試/up/DED-WDS_VUE/libs/src/ui/element/Progress/CircleProgress/CircleProgress.vue"]};const T={title:"Design System/Progress-Circle",component:o,tags:["autodocs"],argTypes:{themeColor:{description:"主題顏色",control:{type:"select"},options:["primary","secondary","tertiary","success","warning","error","info"],table:{type:{summary:"primary | secondary | tertiary | success | warning | error | info"}}},label:{description:"進度指示標籤",control:{type:"text"}},percent:{description:"進度",required:!0,control:{type:"range",min:0,max:100,step:1},defaultValue:66},size:{description:"直徑",control:{type:"range",min:24,max:200,step:1},defaultValue:50},strokeWidth:{description:"線條寬度",control:{type:"range",min:1,max:20,step:1}},className:{description:"客製化樣式",control:{type:"text"}}},parameters:{docs:{title:"CircleProgress",description:{component:"CircleProgress 組件的呈現及說明。"}}}},g={name:"預設項目",args:{themeColor:"primary",label:"Label",percent:65,size:100,strokeWidth:10,className:""},render:s=>({components:{CircleProgress:o},setup(){return{args:s}},template:`
            <CircleProgress 
