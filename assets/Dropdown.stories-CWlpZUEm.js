import{m as $,u as N,r as i,h as V,j as k,G as C,a as u,t as E,d as h,b,e as m,n as L,B as w,p as O,D as H,T as P,o as r,F as j,A as B}from"./vue.esm-bundler-7m8tONXv.js";import{_ as F}from"./Icon-Brgto6mM.js";import{_ as A,L as T}from"./List-3jIaY4y3.js";import{g as M}from"./positionUtils-CIbX64TV.js";import{_ as U}from"./Input-C5HfblrM.js";import"./iframe-VDKxfFGG.js";import"../sb-preview/runtime.js";const I={class:"ded-dropdown-container"},q={key:0,class:"ded-input-label"},R={class:"ded-dropdown-input"},W=8,G="bottom",J=!0,g={__name:"Dropdown",props:$({dataSource:{type:Array,required:!0,default:()=>[]},label:{type:String,default:""},placeholder:{type:String,default:"Placeholder..."},size:{type:String,validator:a=>["small","medium","large"].includes(a),default:"medium"},className:{type:String,default:""}},{modelValue:{},modelModifiers:{}}),emits:["update:modelValue"],setup(a){N(a,"modelValue");const e=a,o=i(""),n=i(!1),s=i(null),f=i({}),_=t=>{o.value=t,n.value=!1},v=t=>{s.value&&!s.value.contains(t.target)&&(n.value=!1)},p=()=>{if(s.value){const t=s.value.getBoundingClientRect(),l={width:t.width,height:t.height};f.value=M({top:t.top,left:t.left},l,G,`${W}px`,J)}};return V(()=>{document.addEventListener("click",v),window.addEventListener("resize",p),k(()=>p())}),C(()=>{document.removeEventListener("click",v),window.removeEventListener("resize",p)}),(t,l)=>(r(),u("div",I,[e.label?(r(),u("label",q,E(e.label),1)):h("",!0),b("div",{ref_key:"dropdown",ref:s,class:"ded-dropdown",role:"listbox",tabindex:"0",onClick:l[0]||(l[0]=d=>n.value=!n.value)},[b("div",R,[m(U,{type:"text",size:e.size,placeholder:e.placeholder,initValue:o.value},null,8,["size","placeholder","initValue"])]),m(F,{class:L(["ded-icon-small","ded-dropdown-close"]),name:n.value?"chevronUp":"chevronDown"},null,8,["name"])],512),(r(),w(P,{to:"body"},[n.value?(r(),u("div",{key:0,class:"ded-tooltip",style:O(f.value)},[m(A,{hasOutline:!0},{default:H(()=>[(r(!0),u(j,null,B(e.dataSource,(d,x)=>(r(),w(T,{key:x,label:d.label,value:d.value,href:d.href,onSelectedItem:l[1]||(l[1]=z=>_(z))},null,8,["label","value","href"]))),128))]),_:1})],4)):h("",!0)]))]))}};g.__docgenInfo={exportName:"default",displayName:"Dropdown",description:"",tags:{},props:[{name:"dataSource",type:{name:"array"},required:!0,defaultValue:{func:!1,value:"[]"}},{name:"label",type:{name:"string"},defaultValue:{func:!1,value:'""'}},{name:"placeholder",type:{name:"string"},defaultValue:{func:!1,value:'"Placeholder..."'}},{name:"size",type:{name:"string"},defaultValue:{func:!1,value:'"medium"'},values:["small","medium","large"]},{name:"className",type:{name:"string"},defaultValue:{func:!1,value:'""'}}],sourceFiles:["/Users/auouser/Desktop/Work_Space/DED-WDS_VUE/libs/src/ui/element/Dropdown/Dropdown.vue"]};function K(a){return`[
    ${a.map(e=>`{
        label: '${e.label}',
        value: '${e.value}',
    }`).join(`,
