import{_ as i}from"./Slider-Bzt4uA0L.js";import{f as t}from"./vue.esm-bundler-D-gFHCZh.js";const C={title:"Component/Slider",component:i,tags:["autodocs"],argTypes:{min:{description:"最小值",control:{type:"number"}},max:{description:"最大值",control:{type:"number"}},step:{description:"步進值",control:{type:"number"}},initValue:{description:"初始值",control:{type:"number"}},label:{description:"單位",control:{type:"text"}},isShowRange:{description:"是否顯示範圍",control:{type:"boolean"}},isShowCurrValue:{description:"是否顯示目前值",control:{type:"boolean"}},isDisabled:{description:"是否禁用",control:{type:"boolean"}},className:{description:"客製化樣式",control:{type:"text"}},updateWidth:{table:{disable:!0}}},parameters:{docs:{title:"Slider",description:{component:"Slider組件的呈現及說明。"}}}},r={name:"預設項目",args:{min:-100,max:100,step:1,initValue:0,label:"℃",isShowRange:!0,isShowCurrValue:!0,isDisabled:!1,className:""},render:s=>({components:{Slider:i},setup(){const a=t(s.initValue||0);return{args:s,sliderValue:a}},template:`
            <slider
...
`).trim()}}}}},n={name:"顯示目前值",args:{min:-100,max:100,step:1,initValue:0,label:"℃",isShowRange:!1,isDisabled:!1,className:""},render:s=>({components:{Slider:i},setup(){const a=t(s.initValue||0);return{args:s,sliderValue:a}},template:`
            <slider
                :themeColor="args.themeColor"
                :min="args.min"
                :max="args.max"
...
`).trim()}}}}},l={name:"顯示範圍",args:{min:-100,max:100,step:1,initValue:0,label:"℃",isShowCurrValue:!1,isDisabled:!1,className:""},render:s=>({components:{Slider:i},setup(){const a=t(s.initValue||0);return{args:s,sliderValue:a}},template:`
            <slider
                :themeColor="args.themeColor"
                :min="args.min"
                :max="args.max"
...
}`,...(g=(c=n.parameters)==null?void 0:c.docs)==null?void 0:g.source}}};var p,V,b;l.parameters={...l.parameters,docs:{...(p=l.parameters)==null?void 0:p.docs,source:{originalSource:`{
  name: "顯示範圍",
  args: {
    min: -100,
    max: 100,
...
}`,...(b=(V=l.parameters)==null?void 0:V.docs)==null?void 0:b.source}}};const w=["SliderDefault","SliderCurrent","SliderAround"];export{l as SliderAround,n as SliderCurrent,r as SliderDefault,w as __namedExportsOrder,C as default};
