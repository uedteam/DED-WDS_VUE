import{g as B,N as R,c as r,p as A,K as $,F as I,o as a,h as T,a as m,b as p,e as b,d as y,n as k,f as U,t as N,k as _,T as L,O as K}from"./vue.esm-bundler-DbMeO4i9.js";import{_ as l}from"./Icon-Dql-1jGW.js";import{_ as C}from"./Button-CcR0g5mh.js";import{_ as x}from"./Title-SHktGRJv.js";const s=R({"top-right":[],"top-left":[],"top-center":[],"bottom-right":[],"bottom-left":[],"bottom-center":[]}),q=B(()=>Object.keys(s)),c=new Map,w=new Map,G=e=>{if(w.has(e))return w.get(e);const o=document.createElement("div");return o.id=`toast-container-${e}`,o.classList.add("ded-toast-container",`ded-toast-${e}`),document.body.appendChild(o),w.set(e,o),o},F=(e,o)=>{if(!s[o])return;c.has(e)&&(clearTimeout(c.get(e)),c.delete(e));const t=s[o].findIndex(i=>i.id===e);t!==-1&&s[o].splice(t,1)},J=e=>{const o=`toast-${crypto.randomUUID()}`,t=e.position||"top-right";Array.isArray(s[t])||(s[t]=R([])),G(t);const i={...e,id:o,action:e.action||null};if(s[t].push(i),e.duration&&e.duration>0){const u=setTimeout(()=>{F(o,t)},e.duration);c.set(o,u)}},Q=()=>{c.forEach(e=>clearTimeout(e)),c.clear(),Object.keys(s).forEach(e=>{s[e].splice(0,s[e].length)})},H=()=>({add:J,remove:F,clear:Q,toasts:s,positions:q}),X={class:"ded-toast-header"},Y={key:0,class:"ded-toast-header-action"},Z={key:1},tt={class:"ded-description"},d={__name:"Toast",props:{className:{type:String,default:""}},setup(e){const{toasts:o,remove:t,positions:i}=H(),u=e;return(S,et)=>(a(!0),r(I,null,A($(i),f=>(a(),r("div",{key:f},[(a(!0),r(I,null,A($(o)[f],n=>(a(),r("div",{key:n.id},[(a(),T(L,{to:`#toast-container-${n.position}`},[m("div",{class:k(["ded-toast",[`ded-toast-border-${n.themeColor}`,u.className]])},[p(C,{class:"ded-close-button",variant:"text",themeColor:"neutral",onClick:ot=>$(t)(n.id,f)},{default:b(()=>[p(l,{name:"SvgClose",size:"20"})]),_:2},1032,["onClick"]),m("div",X,[m("div",{class:k(["ded-toast-header-message",`ded-toast-header-message-${n.themeColor}`])},[p(l,{name:n.prefix,size:"20"},null,8,["name"]),p(x,{themeColor:n.themeColor,level:5},{default:b(()=>[U(N(n.title),1)]),_:2},1032,["themeColor"])],2),n.action?(a(),r("div",Y,[typeof n.action=="object"?(a(),T(_(n.action),{key:0})):typeof n.action=="function"?(a(),r("div",Z,[(a(),T(_(n.action())))])):y("",!0)])):y("",!0)]),m("p",tt,N(n.content),1)],2)],8,["to"]))]))),128))]))),128))}};d.__docgenInfo={exportName:"default",displayName:"Toast",description:"",tags:{},props:[{name:"className",type:{name:"string"},defaultValue:{func:!1,value:'""'}}],sourceFiles:["/Users/auouser/Desktop/Work_Space/DED-WDS_VUE/libs/src/ui/element/Toast/Toast.vue"]};const rt={components:{Icon:l,Toast:d},title:"Component/Toast",component:d,tags:["autodocs"],argTypes:{themeColor:{description:"主題顏色",control:{type:"select"},options:["primary","secondary","neutral","info","success","warning","error"],table:{type:{summary:"primary | secondary | neutral | info | success | warning | error"},defaultValue:{summary:"primary"},category:"PROPS"}},position:{description:"位置",control:{type:"select"},options:["top-right","top-left","top-center","bottom-right","bottom-left","bottom-center"],table:{type:{summary:"top-right | top-left | top-center | bottom-right | bottom-left | bottom-center"},defaultValue:{summary:"top-right"},category:"PROPS"}},title:{description:"內容",control:{type:"text"},table:{category:"PROPS"}},content:{description:"說明文字",control:{type:"text"},table:{defaultValue:{summary:"Content"},category:"PROPS"}},prefix:{description:"前綴元素",control:{type:"select",labels:{"":"none",SvgInfoCircle:"SvgInfoCircle",SvgSuccessCircle:"SvgSuccessCircle",SvgWarningTri:"SvgWarningTri",SvgErrorCircle:"SvgErrorCircle",SvgDisableCircle:"SvgDisableCircle"}},options:["","SvgInfoCircle","SvgSuccessCircle","SvgWarningTri","SvgErrorCircle","SvgDisableCircle"],table:{defaultValue:{summary:""},category:"PROPS"}},duration:{description:"持續時間",control:{type:"range",min:500,max:5e3,step:100},table:{defaultValue:{summary:1e3},category:"PROPS"}},action:{description:"操作",control:{type:"text"},table:{type:{summary:"Vue Component"},category:"SLOTS"}},className:{description:"客製化樣式",control:{type:"text"},table:{category:"PROPS"}}},parameters:{docs:{title:"Toast",description:{component:"通知訊息組件的呈現及說明。"}}}},g={name:"預設項目",args:{themeColor:"success",position:"top-right",title:"Notification Title",content:"Content",prefix:"SvgSuccessCircle",duration:1e3,action:'() => h ("div", {onClick: () => window.alert("action")}, "Action"),',className:""},render:e=>({components:{Toast:d,Button:C,Title:x,Icon:l},setup(){const o=()=>{window.alert("Close")},t=B(()=>`ded-toast-border-${e.themeColor}`),i=B(()=>`ded-toast-header-message-${e.themeColor}`);return{args:e,onClose:o,toastBorderClass:t,toastHeaderMsgThemeClass:i,onAction:()=>{window.alert("Action")}}},template:`
...
`).trim()}}}}},v={name:"訊息類型",args:{position:"top-right",title:"Notification Title",content:"Content",duration:5e3,action:'() => h ("div", {onClick: () => window.alert("action")}, "Action"),',className:""},render:e=>({components:{Toast:d,Button:C,Title:x,Icon:l},setup(){return{args:e,onClose:()=>{window.alert("Close")},onAction:()=>{window.alert("Action")}}},template:`
