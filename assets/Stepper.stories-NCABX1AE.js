import{g as _,c as s,a as o,F as j,h as w,t as p,n as x,o as c,e as N}from"./vue.esm-bundler-qCK_iSPY.js";import{_ as k}from"./Button-BCEQhSzR.js";import"./Icon-CVEqTX2T.js";import"./iframe-ChCRMyiJ.js";import"../sb-preview/runtime.js";const C={class:"ded-stepper-header"},z={class:"ded-step-circle"},E={class:"ded-step-group"},F={class:"ded-step-title"},V={key:0,class:"ded-step-description"},M={key:0,class:"ded-step-connector"},O={class:"ded-stepper-content"},i={__name:"Stepper",props:{dataSource:{type:Array,required:!0},currentStep:{type:Number,required:!0},direction:{type:String,default:"horizontal",validator:e=>["horizontal","vertical"].includes(e)},className:{type:String,default:""}},setup(e){const t=e,r=_(()=>a=>a===t.currentStep?"ded-step-active":a<t.currentStep?"ded-step-completed":"");return(a,n)=>{var f;return c(),s("div",{class:x({"ded-stepper":!0,[`ded-stepper-${t.direction}`]:t.direction,[t.className]:!!t.className})},[o("div",C,[(c(!0),s(j,null,w(t.dataSource,(g,u)=>(c(),s("div",{key:u,class:x(["ded-step",r.value(u)])},[o("div",z,p(u+1),1),o("div",E,[o("div",F,p(g.title),1),g.desc?(c(),s("div",V,p(g.desc),1)):N("",!0)]),e.direction==="vertical"&&u!==e.dataSource.length-1?(c(),s("div",M)):N("",!0)],2))),128))]),o("div",O,p(((f=e.dataSource[e.currentStep])==null?void 0:f.content)||"No content available for this step."),1)],2)}}};i.__docgenInfo={exportName:"default",displayName:"Stepper",description:"",tags:{},props:[{name:"dataSource",type:{name:"array"},required:!0},{name:"currentStep",type:{name:"number"},required:!0},{name:"direction",type:{name:"string"},defaultValue:{func:!1,value:'"horizontal"'},values:["horizontal","vertical"]},{name:"className",type:{name:"string"},defaultValue:{func:!1,value:'""'}}],sourceFiles:["/home/runner/work/DED-WDS_VUE/DED-WDS_VUE/libs/src/ui/element/Stepper/Stepper.vue"]};function m(e){return`[
        ${e.map(t=>`{
            title: "${t.title}",
            desc: "${t.desc}",
            content: "${t.content}",
...
`).trim()}}}}};var y,h,D;d.parameters={...d.parameters,docs:{...(y=d.parameters)==null?void 0:y.docs,source:{originalSource:`{
  name: "預設項目",
  args: {
...
}`,...(D=(h=d.parameters)==null?void 0:h.docs)==null?void 0:D.source}}};var B,T,$;S.parameters={...S.parameters,docs:{...(B=S.parameters)==null?void 0:B.docs,source:{originalSource:`{
  name: "橫向互動模式",
  args: {
    dataSource: dataSource,
    currentStep: 1,
